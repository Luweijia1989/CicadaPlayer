...
char _EGL_ANDROID_create_native_client_buffer = 0;
char _EGL_ANDROID_framebuffer_target = 0;
char _EGL_ANDROID_front_buffer_auto_refresh = 0;
char _EGL_ANDROID_image_native_buffer = 0;
char _EGL_ANDROID_native_fence_sync = 0;
char _EGL_ANDROID_presentation_time = 0;
...
char _EGL_EXT_gl_colorspace_bt2020_linear = 0;
char _EGL_EXT_gl_colorspace_bt2020_pq = 0;
char _EGL_EXT_gl_colorspace_display_p3 = 0;
char _EGL_EXT_gl_colorspace_display_p3_linear = 0;
char _EGL_EXT_gl_colorspace_scrgb = 0;
char _EGL_EXT_gl_colorspace_scrgb_linear = 0;
char _EGL_EXT_image_dma_buf_import = 0;
char _EGL_EXT_image_dma_buf_import_modifiers = 0;
char _EGL_EXT_image_implicit_sync_control = 0;
char _EGL_EXT_multiview_window = 0;
char _EGL_EXT_output_base = 0;
char _EGL_EXT_pixel_format_float = 0;
char _EGL_EXT_platform_base = 0;
char _EGL_EXT_platform_device = 0;
char _EGL_EXT_platform_wayland = 0;
char _EGL_EXT_platform_x11 = 0;
char _EGL_EXT_protected_content = 0;
char _EGL_EXT_protected_surface = 0;
char _EGL_EXT_stream_consumer_egloutput = 0;
char _EGL_EXT_surface_CTA861_3_metadata = 0;
char _EGL_EXT_surface_SMPTE2086_metadata = 0;
...
char _EGL_KHR_mutable_render_buffer = 0;
char _EGL_KHR_no_config_context = 0;
...
char _EGL_MESA_platform_surfaceless = 0;
...
char _EGL_NV_stream_consumer_gltexture_yuv = 0;
char _EGL_NV_stream_cross_display = 0;
char _EGL_NV_stream_cross_object = 0;
char _EGL_NV_stream_cross_partition = 0;
char _EGL_NV_stream_cross_process = 0;
char _EGL_NV_stream_cross_system = 0;
char _EGL_NV_stream_fifo_next = 0;
char _EGL_NV_stream_fifo_synchronous = 0;
char _EGL_NV_stream_frame_limits = 0;
char _EGL_NV_stream_metadata = 0;
char _EGL_NV_stream_remote = 0;
char _EGL_NV_stream_reset = 0;
char _EGL_NV_stream_socket = 0;
char _EGL_NV_stream_socket_inet = 0;
char _EGL_NV_stream_socket_unix = 0;
...
static char GLLOADER_APIENTRY _glloader_EGL_ANDROID_create_native_client_buffer()
{
	return _EGL_ANDROID_create_native_client_buffer;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_ANDROID_create_native_client_buffer()
{
	glloader_init();
	return glloader_EGL_ANDROID_create_native_client_buffer();
}
glloader_EGL_ANDROID_create_native_client_bufferFUNC glloader_EGL_ANDROID_create_native_client_buffer = self_init_glloader_EGL_ANDROID_create_native_client_buffer;

#ifdef EGL_ANDROID_create_native_client_buffer

static EGLClientBuffer GLLOADER_APIENTRY self_init_eglCreateNativeClientBufferANDROID(const EGLint* attrib_list)
{
	glloader_init();
	return eglCreateNativeClientBufferANDROID(attrib_list);
}

eglCreateNativeClientBufferANDROIDFUNC eglCreateNativeClientBufferANDROID = self_init_eglCreateNativeClientBufferANDROID;
...
static char GLLOADER_APIENTRY _glloader_EGL_ANDROID_front_buffer_auto_refresh()
{
	return _EGL_ANDROID_front_buffer_auto_refresh;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_ANDROID_front_buffer_auto_refresh()
{
	glloader_init();
	return glloader_EGL_ANDROID_front_buffer_auto_refresh();
}
glloader_EGL_ANDROID_front_buffer_auto_refreshFUNC glloader_EGL_ANDROID_front_buffer_auto_refresh = self_init_glloader_EGL_ANDROID_front_buffer_auto_refresh;
...
static char GLLOADER_APIENTRY _glloader_EGL_ANDROID_presentation_time()
{
	return _EGL_ANDROID_presentation_time;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_ANDROID_presentation_time()
{
	glloader_init();
	return glloader_EGL_ANDROID_presentation_time();
}
glloader_EGL_ANDROID_presentation_timeFUNC glloader_EGL_ANDROID_presentation_time = self_init_glloader_EGL_ANDROID_presentation_time;

#ifdef EGL_ANDROID_presentation_time

static EGLBoolean GLLOADER_APIENTRY self_init_eglPresentationTimeANDROID(EGLDisplay dpy, EGLSurface surface, EGLnsecsANDROID time)
{
	glloader_init();
	return eglPresentationTimeANDROID(dpy, surface, time);
}

eglPresentationTimeANDROIDFUNC eglPresentationTimeANDROID = self_init_eglPresentationTimeANDROID;
...
static char GLLOADER_APIENTRY _glloader_EGL_ARM_implicit_external_sync()
{
	return _EGL_ARM_implicit_external_sync;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_ARM_implicit_external_sync()
{
	glloader_init();
	return glloader_EGL_ARM_implicit_external_sync();
}
glloader_EGL_ARM_implicit_external_syncFUNC glloader_EGL_ARM_implicit_external_sync = self_init_glloader_EGL_ARM_implicit_external_sync;
...
static char GLLOADER_APIENTRY _glloader_EGL_EXT_bind_to_front()
{
	return _EGL_EXT_bind_to_front;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_EXT_bind_to_front()
{
	glloader_init();
	return glloader_EGL_EXT_bind_to_front();
}
glloader_EGL_EXT_bind_to_frontFUNC glloader_EGL_EXT_bind_to_front = self_init_glloader_EGL_EXT_bind_to_front;
...
static char GLLOADER_APIENTRY _glloader_EGL_EXT_compositor()
{
	return _EGL_EXT_compositor;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_EXT_compositor()
{
	glloader_init();
	return glloader_EGL_EXT_compositor();
}
glloader_EGL_EXT_compositorFUNC glloader_EGL_EXT_compositor = self_init_glloader_EGL_EXT_compositor;

#ifdef EGL_EXT_compositor

static EGLBoolean GLLOADER_APIENTRY self_init_eglCompositorSetContextListEXT(const EGLint* external_ref_ids, EGLint num_entries)
{
	glloader_init();
	return eglCompositorSetContextListEXT(external_ref_ids, num_entries);
}
static EGLBoolean GLLOADER_APIENTRY self_init_eglCompositorSetContextAttributesEXT(EGLint external_ref_id, const EGLint* context_attributes, EGLint num_entries)
{
	glloader_init();
	return eglCompositorSetContextAttributesEXT(external_ref_id, context_attributes, num_entries);
}
static EGLBoolean GLLOADER_APIENTRY self_init_eglCompositorSetWindowListEXT(EGLint external_ref_id, const EGLint* external_ref_ids, EGLint num_entries)
{
	glloader_init();
	return eglCompositorSetWindowListEXT(external_ref_id, external_ref_ids, num_entries);
}
static EGLBoolean GLLOADER_APIENTRY self_init_eglCompositorSetWindowAttributesEXT(EGLint external_win_id, const EGLint* window_attributes, EGLint num_entries)
{
	glloader_init();
	return eglCompositorSetWindowAttributesEXT(external_win_id, window_attributes, num_entries);
}
static EGLBoolean GLLOADER_APIENTRY self_init_eglCompositorBindTexWindowEXT(EGLint external_win_id)
{
	glloader_init();
	return eglCompositorBindTexWindowEXT(external_win_id);
}
static EGLBoolean GLLOADER_APIENTRY self_init_eglCompositorSetSizeEXT(EGLint external_win_id, EGLint width, EGLint height)
{
	glloader_init();
	return eglCompositorSetSizeEXT(external_win_id, width, height);
}
static EGLBoolean GLLOADER_APIENTRY self_init_eglCompositorSwapPolicyEXT(EGLint external_win_id, EGLint policy)
{
	glloader_init();
	return eglCompositorSwapPolicyEXT(external_win_id, policy);
}

eglCompositorSetContextListEXTFUNC eglCompositorSetContextListEXT = self_init_eglCompositorSetContextListEXT;
eglCompositorSetContextAttributesEXTFUNC eglCompositorSetContextAttributesEXT = self_init_eglCompositorSetContextAttributesEXT;
eglCompositorSetWindowListEXTFUNC eglCompositorSetWindowListEXT = self_init_eglCompositorSetWindowListEXT;
eglCompositorSetWindowAttributesEXTFUNC eglCompositorSetWindowAttributesEXT = self_init_eglCompositorSetWindowAttributesEXT;
eglCompositorBindTexWindowEXTFUNC eglCompositorBindTexWindowEXT = self_init_eglCompositorBindTexWindowEXT;
eglCompositorSetSizeEXTFUNC eglCompositorSetSizeEXT = self_init_eglCompositorSetSizeEXT;
eglCompositorSwapPolicyEXTFUNC eglCompositorSwapPolicyEXT = self_init_eglCompositorSwapPolicyEXT;
...
static char GLLOADER_APIENTRY _glloader_EGL_EXT_gl_colorspace_bt2020_linear()
{
	return _EGL_EXT_gl_colorspace_bt2020_linear;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_EXT_gl_colorspace_bt2020_linear()
{
	glloader_init();
	return glloader_EGL_EXT_gl_colorspace_bt2020_linear();
}
glloader_EGL_EXT_gl_colorspace_bt2020_linearFUNC glloader_EGL_EXT_gl_colorspace_bt2020_linear = self_init_glloader_EGL_EXT_gl_colorspace_bt2020_linear;

static char GLLOADER_APIENTRY _glloader_EGL_EXT_gl_colorspace_bt2020_pq()
{
	return _EGL_EXT_gl_colorspace_bt2020_pq;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_EXT_gl_colorspace_bt2020_pq()
{
	glloader_init();
	return glloader_EGL_EXT_gl_colorspace_bt2020_pq();
}
glloader_EGL_EXT_gl_colorspace_bt2020_pqFUNC glloader_EGL_EXT_gl_colorspace_bt2020_pq = self_init_glloader_EGL_EXT_gl_colorspace_bt2020_pq;

static char GLLOADER_APIENTRY _glloader_EGL_EXT_gl_colorspace_display_p3()
{
	return _EGL_EXT_gl_colorspace_display_p3;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_EXT_gl_colorspace_display_p3()
{
	glloader_init();
	return glloader_EGL_EXT_gl_colorspace_display_p3();
}
glloader_EGL_EXT_gl_colorspace_display_p3FUNC glloader_EGL_EXT_gl_colorspace_display_p3 = self_init_glloader_EGL_EXT_gl_colorspace_display_p3;

static char GLLOADER_APIENTRY _glloader_EGL_EXT_gl_colorspace_display_p3_linear()
{
	return _EGL_EXT_gl_colorspace_display_p3_linear;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_EXT_gl_colorspace_display_p3_linear()
{
	glloader_init();
	return glloader_EGL_EXT_gl_colorspace_display_p3_linear();
}
glloader_EGL_EXT_gl_colorspace_display_p3_linearFUNC glloader_EGL_EXT_gl_colorspace_display_p3_linear = self_init_glloader_EGL_EXT_gl_colorspace_display_p3_linear;

static char GLLOADER_APIENTRY _glloader_EGL_EXT_gl_colorspace_scrgb()
{
	return _EGL_EXT_gl_colorspace_scrgb;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_EXT_gl_colorspace_scrgb()
{
	glloader_init();
	return glloader_EGL_EXT_gl_colorspace_scrgb();
}
glloader_EGL_EXT_gl_colorspace_scrgbFUNC glloader_EGL_EXT_gl_colorspace_scrgb = self_init_glloader_EGL_EXT_gl_colorspace_scrgb;

static char GLLOADER_APIENTRY _glloader_EGL_EXT_gl_colorspace_scrgb_linear()
{
	return _EGL_EXT_gl_colorspace_scrgb_linear;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_EXT_gl_colorspace_scrgb_linear()
{
	glloader_init();
	return glloader_EGL_EXT_gl_colorspace_scrgb_linear();
}
glloader_EGL_EXT_gl_colorspace_scrgb_linearFUNC glloader_EGL_EXT_gl_colorspace_scrgb_linear = self_init_glloader_EGL_EXT_gl_colorspace_scrgb_linear;
...
static char GLLOADER_APIENTRY _glloader_EGL_EXT_image_dma_buf_import_modifiers()
{
	return _EGL_EXT_image_dma_buf_import_modifiers;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_EXT_image_dma_buf_import_modifiers()
{
	glloader_init();
	return glloader_EGL_EXT_image_dma_buf_import_modifiers();
}
glloader_EGL_EXT_image_dma_buf_import_modifiersFUNC glloader_EGL_EXT_image_dma_buf_import_modifiers = self_init_glloader_EGL_EXT_image_dma_buf_import_modifiers;

#ifdef EGL_EXT_image_dma_buf_import_modifiers

static EGLBoolean GLLOADER_APIENTRY self_init_eglQueryDmaBufFormatsEXT(EGLDisplay dpy, EGLint max_formats, EGLint* formats, EGLint* num_formats)
{
	glloader_init();
	return eglQueryDmaBufFormatsEXT(dpy, max_formats, formats, num_formats);
}
static EGLBoolean GLLOADER_APIENTRY self_init_eglQueryDmaBufModifiersEXT(EGLDisplay dpy, EGLint format, EGLint max_modifiers, EGLuint64KHR* modifiers, EGLBoolean* external_only, EGLint* num_modifiers)
{
	glloader_init();
	return eglQueryDmaBufModifiersEXT(dpy, format, max_modifiers, modifiers, external_only, num_modifiers);
}

eglQueryDmaBufFormatsEXTFUNC eglQueryDmaBufFormatsEXT = self_init_eglQueryDmaBufFormatsEXT;
eglQueryDmaBufModifiersEXTFUNC eglQueryDmaBufModifiersEXT = self_init_eglQueryDmaBufModifiersEXT;

#endif

static char GLLOADER_APIENTRY _glloader_EGL_EXT_image_implicit_sync_control()
{
	return _EGL_EXT_image_implicit_sync_control;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_EXT_image_implicit_sync_control()
{
	glloader_init();
	return glloader_EGL_EXT_image_implicit_sync_control();
}
glloader_EGL_EXT_image_implicit_sync_controlFUNC glloader_EGL_EXT_image_implicit_sync_control = self_init_glloader_EGL_EXT_image_implicit_sync_control;
...
static char GLLOADER_APIENTRY _glloader_EGL_EXT_pixel_format_float()
{
	return _EGL_EXT_pixel_format_float;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_EXT_pixel_format_float()
{
	glloader_init();
	return glloader_EGL_EXT_pixel_format_float();
}
glloader_EGL_EXT_pixel_format_floatFUNC glloader_EGL_EXT_pixel_format_float = self_init_glloader_EGL_EXT_pixel_format_float;
...
static char GLLOADER_APIENTRY _glloader_EGL_EXT_protected_content()
{
	return _EGL_EXT_protected_content;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_EXT_protected_content()
{
	glloader_init();
	return glloader_EGL_EXT_protected_content();
}
glloader_EGL_EXT_protected_contentFUNC glloader_EGL_EXT_protected_content = self_init_glloader_EGL_EXT_protected_content;
...
static char GLLOADER_APIENTRY _glloader_EGL_EXT_surface_CTA861_3_metadata()
{
	return _EGL_EXT_surface_CTA861_3_metadata;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_EXT_surface_CTA861_3_metadata()
{
	glloader_init();
	return glloader_EGL_EXT_surface_CTA861_3_metadata();
}
glloader_EGL_EXT_surface_CTA861_3_metadataFUNC glloader_EGL_EXT_surface_CTA861_3_metadata = self_init_glloader_EGL_EXT_surface_CTA861_3_metadata;

static char GLLOADER_APIENTRY _glloader_EGL_EXT_surface_SMPTE2086_metadata()
{
	return _EGL_EXT_surface_SMPTE2086_metadata;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_EXT_surface_SMPTE2086_metadata()
{
	glloader_init();
	return glloader_EGL_EXT_surface_SMPTE2086_metadata();
}
glloader_EGL_EXT_surface_SMPTE2086_metadataFUNC glloader_EGL_EXT_surface_SMPTE2086_metadata = self_init_glloader_EGL_EXT_surface_SMPTE2086_metadata;
...
static char GLLOADER_APIENTRY _glloader_EGL_IMG_image_plane_attribs()
{
	return _EGL_IMG_image_plane_attribs;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_IMG_image_plane_attribs()
{
	glloader_init();
	return glloader_EGL_IMG_image_plane_attribs();
}
glloader_EGL_IMG_image_plane_attribsFUNC glloader_EGL_IMG_image_plane_attribs = self_init_glloader_EGL_IMG_image_plane_attribs;
...
static char GLLOADER_APIENTRY _glloader_EGL_KHR_context_flush_control()
{
	return _EGL_KHR_context_flush_control;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_KHR_context_flush_control()
{
	glloader_init();
	return glloader_EGL_KHR_context_flush_control();
}
glloader_EGL_KHR_context_flush_controlFUNC glloader_EGL_KHR_context_flush_control = self_init_glloader_EGL_KHR_context_flush_control;
...
static char GLLOADER_APIENTRY _glloader_EGL_KHR_debug()
{
	return _EGL_KHR_debug;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_KHR_debug()
{
	glloader_init();
	return glloader_EGL_KHR_debug();
}
glloader_EGL_KHR_debugFUNC glloader_EGL_KHR_debug = self_init_glloader_EGL_KHR_debug;

#ifdef EGL_KHR_debug

static EGLint GLLOADER_APIENTRY self_init_eglDebugMessageControlKHR(EGLDEBUGPROC callback, const EGLAttrib* attrib_list)
{
	glloader_init();
	return eglDebugMessageControlKHR(callback, attrib_list);
}
static EGLBoolean GLLOADER_APIENTRY self_init_eglQueryDebugKHR(EGLint attribute, EGLAttrib* value)
{
	glloader_init();
	return eglQueryDebugKHR(attribute, value);
}
static EGLint GLLOADER_APIENTRY self_init_eglLabelObjectKHR(EGLDisplay display, EGLenum objectType, EGLObjectKHR object, EGLLabelKHR label)
{
	glloader_init();
	return eglLabelObjectKHR(display, objectType, object, label);
}

eglDebugMessageControlKHRFUNC eglDebugMessageControlKHR = self_init_eglDebugMessageControlKHR;
eglQueryDebugKHRFUNC eglQueryDebugKHR = self_init_eglQueryDebugKHR;
eglLabelObjectKHRFUNC eglLabelObjectKHR = self_init_eglLabelObjectKHR;
...
static char GLLOADER_APIENTRY _glloader_EGL_KHR_mutable_render_buffer()
{
	return _EGL_KHR_mutable_render_buffer;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_KHR_mutable_render_buffer()
{
	glloader_init();
	return glloader_EGL_KHR_mutable_render_buffer();
}
glloader_EGL_KHR_mutable_render_bufferFUNC glloader_EGL_KHR_mutable_render_buffer = self_init_glloader_EGL_KHR_mutable_render_buffer;

static char GLLOADER_APIENTRY _glloader_EGL_KHR_no_config_context()
{
	return _EGL_KHR_no_config_context;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_KHR_no_config_context()
{
	glloader_init();
	return glloader_EGL_KHR_no_config_context();
}
glloader_EGL_KHR_no_config_contextFUNC glloader_EGL_KHR_no_config_context = self_init_glloader_EGL_KHR_no_config_context;
...
static char GLLOADER_APIENTRY _glloader_EGL_MESA_platform_surfaceless()
{
	return _EGL_MESA_platform_surfaceless;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_MESA_platform_surfaceless()
{
	glloader_init();
	return glloader_EGL_MESA_platform_surfaceless();
}
glloader_EGL_MESA_platform_surfacelessFUNC glloader_EGL_MESA_platform_surfaceless = self_init_glloader_EGL_MESA_platform_surfaceless;
...
static char GLLOADER_APIENTRY _glloader_EGL_NV_stream_consumer_gltexture_yuv()
{
	return _EGL_NV_stream_consumer_gltexture_yuv;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_NV_stream_consumer_gltexture_yuv()
{
	glloader_init();
	return glloader_EGL_NV_stream_consumer_gltexture_yuv();
}
glloader_EGL_NV_stream_consumer_gltexture_yuvFUNC glloader_EGL_NV_stream_consumer_gltexture_yuv = self_init_glloader_EGL_NV_stream_consumer_gltexture_yuv;

#ifdef EGL_NV_stream_consumer_gltexture_yuv

static EGLBoolean GLLOADER_APIENTRY self_init_eglStreamConsumerGLTextureExternalAttribsNV(EGLDisplay dpy, EGLStreamKHR stream, EGLAttrib* attrib_list)
{
	glloader_init();
	return eglStreamConsumerGLTextureExternalAttribsNV(dpy, stream, attrib_list);
}

eglStreamConsumerGLTextureExternalAttribsNVFUNC eglStreamConsumerGLTextureExternalAttribsNV = self_init_eglStreamConsumerGLTextureExternalAttribsNV;

#endif

static char GLLOADER_APIENTRY _glloader_EGL_NV_stream_cross_display()
{
	return _EGL_NV_stream_cross_display;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_NV_stream_cross_display()
{
	glloader_init();
	return glloader_EGL_NV_stream_cross_display();
}
glloader_EGL_NV_stream_cross_displayFUNC glloader_EGL_NV_stream_cross_display = self_init_glloader_EGL_NV_stream_cross_display;

static char GLLOADER_APIENTRY _glloader_EGL_NV_stream_cross_object()
{
	return _EGL_NV_stream_cross_object;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_NV_stream_cross_object()
{
	glloader_init();
	return glloader_EGL_NV_stream_cross_object();
}
glloader_EGL_NV_stream_cross_objectFUNC glloader_EGL_NV_stream_cross_object = self_init_glloader_EGL_NV_stream_cross_object;

static char GLLOADER_APIENTRY _glloader_EGL_NV_stream_cross_partition()
{
	return _EGL_NV_stream_cross_partition;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_NV_stream_cross_partition()
{
	glloader_init();
	return glloader_EGL_NV_stream_cross_partition();
}
glloader_EGL_NV_stream_cross_partitionFUNC glloader_EGL_NV_stream_cross_partition = self_init_glloader_EGL_NV_stream_cross_partition;

static char GLLOADER_APIENTRY _glloader_EGL_NV_stream_cross_process()
{
	return _EGL_NV_stream_cross_process;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_NV_stream_cross_process()
{
	glloader_init();
	return glloader_EGL_NV_stream_cross_process();
}
glloader_EGL_NV_stream_cross_processFUNC glloader_EGL_NV_stream_cross_process = self_init_glloader_EGL_NV_stream_cross_process;

static char GLLOADER_APIENTRY _glloader_EGL_NV_stream_cross_system()
{
	return _EGL_NV_stream_cross_system;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_NV_stream_cross_system()
{
	glloader_init();
	return glloader_EGL_NV_stream_cross_system();
}
glloader_EGL_NV_stream_cross_systemFUNC glloader_EGL_NV_stream_cross_system = self_init_glloader_EGL_NV_stream_cross_system;

static char GLLOADER_APIENTRY _glloader_EGL_NV_stream_fifo_next()
{
	return _EGL_NV_stream_fifo_next;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_NV_stream_fifo_next()
{
	glloader_init();
	return glloader_EGL_NV_stream_fifo_next();
}
glloader_EGL_NV_stream_fifo_nextFUNC glloader_EGL_NV_stream_fifo_next = self_init_glloader_EGL_NV_stream_fifo_next;

static char GLLOADER_APIENTRY _glloader_EGL_NV_stream_fifo_synchronous()
{
	return _EGL_NV_stream_fifo_synchronous;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_NV_stream_fifo_synchronous()
{
	glloader_init();
	return glloader_EGL_NV_stream_fifo_synchronous();
}
glloader_EGL_NV_stream_fifo_synchronousFUNC glloader_EGL_NV_stream_fifo_synchronous = self_init_glloader_EGL_NV_stream_fifo_synchronous;

static char GLLOADER_APIENTRY _glloader_EGL_NV_stream_frame_limits()
{
	return _EGL_NV_stream_frame_limits;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_NV_stream_frame_limits()
{
	glloader_init();
	return glloader_EGL_NV_stream_frame_limits();
}
glloader_EGL_NV_stream_frame_limitsFUNC glloader_EGL_NV_stream_frame_limits = self_init_glloader_EGL_NV_stream_frame_limits;

static char GLLOADER_APIENTRY _glloader_EGL_NV_stream_metadata()
{
	return _EGL_NV_stream_metadata;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_NV_stream_metadata()
{
	glloader_init();
	return glloader_EGL_NV_stream_metadata();
}
glloader_EGL_NV_stream_metadataFUNC glloader_EGL_NV_stream_metadata = self_init_glloader_EGL_NV_stream_metadata;

#ifdef EGL_NV_stream_metadata

static EGLBoolean GLLOADER_APIENTRY self_init_eglQueryDisplayAttribNV(EGLDisplay dpy, EGLint attribute, EGLAttrib* value)
{
	glloader_init();
	return eglQueryDisplayAttribNV(dpy, attribute, value);
}
static EGLBoolean GLLOADER_APIENTRY self_init_eglSetStreamMetadataNV(EGLDisplay dpy, EGLStreamKHR stream, EGLint n, EGLint offset, EGLint size, const void* data)
{
	glloader_init();
	return eglSetStreamMetadataNV(dpy, stream, n, offset, size, data);
}
static EGLBoolean GLLOADER_APIENTRY self_init_eglQueryStreamMetadataNV(EGLDisplay dpy, EGLStreamKHR stream, EGLenum name, EGLint n, EGLint offset, EGLint size, void* data)
{
	glloader_init();
	return eglQueryStreamMetadataNV(dpy, stream, name, n, offset, size, data);
}

eglQueryDisplayAttribNVFUNC eglQueryDisplayAttribNV = self_init_eglQueryDisplayAttribNV;
eglSetStreamMetadataNVFUNC eglSetStreamMetadataNV = self_init_eglSetStreamMetadataNV;
eglQueryStreamMetadataNVFUNC eglQueryStreamMetadataNV = self_init_eglQueryStreamMetadataNV;

#endif

static char GLLOADER_APIENTRY _glloader_EGL_NV_stream_remote()
{
	return _EGL_NV_stream_remote;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_NV_stream_remote()
{
	glloader_init();
	return glloader_EGL_NV_stream_remote();
}
glloader_EGL_NV_stream_remoteFUNC glloader_EGL_NV_stream_remote = self_init_glloader_EGL_NV_stream_remote;

static char GLLOADER_APIENTRY _glloader_EGL_NV_stream_reset()
{
	return _EGL_NV_stream_reset;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_NV_stream_reset()
{
	glloader_init();
	return glloader_EGL_NV_stream_reset();
}
glloader_EGL_NV_stream_resetFUNC glloader_EGL_NV_stream_reset = self_init_glloader_EGL_NV_stream_reset;

#ifdef EGL_NV_stream_reset

static EGLBoolean GLLOADER_APIENTRY self_init_eglResetStreamNV(EGLDisplay dpy, EGLStreamKHR stream)
{
	glloader_init();
	return eglResetStreamNV(dpy, stream);
}

eglResetStreamNVFUNC eglResetStreamNV = self_init_eglResetStreamNV;

#endif

static char GLLOADER_APIENTRY _glloader_EGL_NV_stream_socket()
{
	return _EGL_NV_stream_socket;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_NV_stream_socket()
{
	glloader_init();
	return glloader_EGL_NV_stream_socket();
}
glloader_EGL_NV_stream_socketFUNC glloader_EGL_NV_stream_socket = self_init_glloader_EGL_NV_stream_socket;

static char GLLOADER_APIENTRY _glloader_EGL_NV_stream_socket_inet()
{
	return _EGL_NV_stream_socket_inet;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_NV_stream_socket_inet()
{
	glloader_init();
	return glloader_EGL_NV_stream_socket_inet();
}
glloader_EGL_NV_stream_socket_inetFUNC glloader_EGL_NV_stream_socket_inet = self_init_glloader_EGL_NV_stream_socket_inet;

static char GLLOADER_APIENTRY _glloader_EGL_NV_stream_socket_unix()
{
	return _EGL_NV_stream_socket_unix;
}

static char GLLOADER_APIENTRY self_init_glloader_EGL_NV_stream_socket_unix()
{
	glloader_init();
	return glloader_EGL_NV_stream_socket_unix();
}
glloader_EGL_NV_stream_socket_unixFUNC glloader_EGL_NV_stream_socket_unix = self_init_glloader_EGL_NV_stream_socket_unix;
...
void init_EGL_ANDROID_create_native_client_buffer()
{
	glloader_EGL_ANDROID_create_native_client_buffer = _glloader_EGL_ANDROID_create_native_client_buffer;

	_EGL_ANDROID_create_native_client_buffer = 0;
	if (glloader_is_supported("EGL_ANDROID_create_native_client_buffer"))
	{
		_EGL_ANDROID_create_native_client_buffer = 1;

		LOAD_FUNC1(eglCreateNativeClientBufferANDROID);
	}
}
...
void init_EGL_ANDROID_front_buffer_auto_refresh()
{
	glloader_EGL_ANDROID_front_buffer_auto_refresh = _glloader_EGL_ANDROID_front_buffer_auto_refresh;

	_EGL_ANDROID_front_buffer_auto_refresh = 0;
	if (glloader_is_supported("EGL_ANDROID_front_buffer_auto_refresh"))
	{
		_EGL_ANDROID_front_buffer_auto_refresh = 1;
	}
}
...
void init_EGL_ANDROID_presentation_time()
{
	glloader_EGL_ANDROID_presentation_time = _glloader_EGL_ANDROID_presentation_time;

	_EGL_ANDROID_presentation_time = 0;
	if (glloader_is_supported("EGL_ANDROID_presentation_time"))
	{
		_EGL_ANDROID_presentation_time = 1;

		LOAD_FUNC1(eglPresentationTimeANDROID);
	}
}
...
void init_EGL_ARM_implicit_external_sync()
{
	glloader_EGL_ARM_implicit_external_sync = _glloader_EGL_ARM_implicit_external_sync;

	_EGL_ARM_implicit_external_sync = 0;
	if (glloader_is_supported("EGL_ARM_implicit_external_sync"))
	{
		_EGL_ARM_implicit_external_sync = 1;
	}
}
...
void init_EGL_EXT_bind_to_front()
{
	glloader_EGL_EXT_bind_to_front = _glloader_EGL_EXT_bind_to_front;

	_EGL_EXT_bind_to_front = 0;
	if (glloader_is_supported("EGL_EXT_bind_to_front"))
	{
		_EGL_EXT_bind_to_front = 1;
	}
}
...
void init_EGL_EXT_compositor()
{
	glloader_EGL_EXT_compositor = _glloader_EGL_EXT_compositor;

	_EGL_EXT_compositor = 0;
	if (glloader_is_supported("EGL_EXT_compositor"))
	{
		_EGL_EXT_compositor = 1;

		LOAD_FUNC1(eglCompositorSetContextListEXT);
		LOAD_FUNC1(eglCompositorSetContextAttributesEXT);
		LOAD_FUNC1(eglCompositorSetWindowListEXT);
		LOAD_FUNC1(eglCompositorSetWindowAttributesEXT);
		LOAD_FUNC1(eglCompositorBindTexWindowEXT);
		LOAD_FUNC1(eglCompositorSetSizeEXT);
		LOAD_FUNC1(eglCompositorSwapPolicyEXT);
	}
}
...
void init_EGL_EXT_gl_colorspace_bt2020_linear()
{
	glloader_EGL_EXT_gl_colorspace_bt2020_linear = _glloader_EGL_EXT_gl_colorspace_bt2020_linear;

	_EGL_EXT_gl_colorspace_bt2020_linear = 0;
	if (glloader_is_supported("EGL_EXT_gl_colorspace_bt2020_linear"))
	{
		_EGL_EXT_gl_colorspace_bt2020_linear = 1;
	}
}

void init_EGL_EXT_gl_colorspace_bt2020_pq()
{
	glloader_EGL_EXT_gl_colorspace_bt2020_pq = _glloader_EGL_EXT_gl_colorspace_bt2020_pq;

	_EGL_EXT_gl_colorspace_bt2020_pq = 0;
	if (glloader_is_supported("EGL_EXT_gl_colorspace_bt2020_pq"))
	{
		_EGL_EXT_gl_colorspace_bt2020_pq = 1;
	}
}

void init_EGL_EXT_gl_colorspace_display_p3()
{
	glloader_EGL_EXT_gl_colorspace_display_p3 = _glloader_EGL_EXT_gl_colorspace_display_p3;

	_EGL_EXT_gl_colorspace_display_p3 = 0;
	if (glloader_is_supported("EGL_EXT_gl_colorspace_display_p3"))
	{
		_EGL_EXT_gl_colorspace_display_p3 = 1;
	}
}

void init_EGL_EXT_gl_colorspace_display_p3_linear()
{
	glloader_EGL_EXT_gl_colorspace_display_p3_linear = _glloader_EGL_EXT_gl_colorspace_display_p3_linear;

	_EGL_EXT_gl_colorspace_display_p3_linear = 0;
	if (glloader_is_supported("EGL_EXT_gl_colorspace_display_p3_linear"))
	{
		_EGL_EXT_gl_colorspace_display_p3_linear = 1;
	}
}

void init_EGL_EXT_gl_colorspace_scrgb()
{
	glloader_EGL_EXT_gl_colorspace_scrgb = _glloader_EGL_EXT_gl_colorspace_scrgb;

	_EGL_EXT_gl_colorspace_scrgb = 0;
	if (glloader_is_supported("EGL_EXT_gl_colorspace_scrgb"))
	{
		_EGL_EXT_gl_colorspace_scrgb = 1;
	}
}

void init_EGL_EXT_gl_colorspace_scrgb_linear()
{
	glloader_EGL_EXT_gl_colorspace_scrgb_linear = _glloader_EGL_EXT_gl_colorspace_scrgb_linear;

	_EGL_EXT_gl_colorspace_scrgb_linear = 0;
	if (glloader_is_supported("EGL_EXT_gl_colorspace_scrgb_linear"))
	{
		_EGL_EXT_gl_colorspace_scrgb_linear = 1;
	}
}
...
void init_EGL_EXT_image_dma_buf_import_modifiers()
{
	glloader_EGL_EXT_image_dma_buf_import_modifiers = _glloader_EGL_EXT_image_dma_buf_import_modifiers;

	_EGL_EXT_image_dma_buf_import_modifiers = 0;
	if (glloader_is_supported("EGL_EXT_image_dma_buf_import_modifiers"))
	{
		_EGL_EXT_image_dma_buf_import_modifiers = 1;

		LOAD_FUNC1(eglQueryDmaBufFormatsEXT);
		LOAD_FUNC1(eglQueryDmaBufModifiersEXT);
	}
}

void init_EGL_EXT_image_implicit_sync_control()
{
	glloader_EGL_EXT_image_implicit_sync_control = _glloader_EGL_EXT_image_implicit_sync_control;

	_EGL_EXT_image_implicit_sync_control = 0;
	if (glloader_is_supported("EGL_EXT_image_implicit_sync_control"))
	{
		_EGL_EXT_image_implicit_sync_control = 1;
	}
}
...
void init_EGL_EXT_pixel_format_float()
{
	glloader_EGL_EXT_pixel_format_float = _glloader_EGL_EXT_pixel_format_float;

	_EGL_EXT_pixel_format_float = 0;
	if (glloader_is_supported("EGL_EXT_pixel_format_float"))
	{
		_EGL_EXT_pixel_format_float = 1;
	}
}
...
void init_EGL_EXT_protected_content()
{
	glloader_EGL_EXT_protected_content = _glloader_EGL_EXT_protected_content;

	_EGL_EXT_protected_content = 0;
	if (glloader_is_supported("EGL_EXT_protected_content"))
	{
		_EGL_EXT_protected_content = 1;
	}
}
...
void init_EGL_EXT_surface_CTA861_3_metadata()
{
	glloader_EGL_EXT_surface_CTA861_3_metadata = _glloader_EGL_EXT_surface_CTA861_3_metadata;

	_EGL_EXT_surface_CTA861_3_metadata = 0;
	if (glloader_is_supported("EGL_EXT_surface_CTA861_3_metadata"))
	{
		_EGL_EXT_surface_CTA861_3_metadata = 1;
	}
}

void init_EGL_EXT_surface_SMPTE2086_metadata()
{
	glloader_EGL_EXT_surface_SMPTE2086_metadata = _glloader_EGL_EXT_surface_SMPTE2086_metadata;

	_EGL_EXT_surface_SMPTE2086_metadata = 0;
	if (glloader_is_supported("EGL_EXT_surface_SMPTE2086_metadata"))
	{
		_EGL_EXT_surface_SMPTE2086_metadata = 1;
	}
}
...
void init_EGL_IMG_image_plane_attribs()
{
	glloader_EGL_IMG_image_plane_attribs = _glloader_EGL_IMG_image_plane_attribs;

	_EGL_IMG_image_plane_attribs = 0;
	if (glloader_is_supported("EGL_IMG_image_plane_attribs"))
	{
		_EGL_IMG_image_plane_attribs = 1;
	}
}
...
void init_EGL_KHR_context_flush_control()
{
	glloader_EGL_KHR_context_flush_control = _glloader_EGL_KHR_context_flush_control;

	_EGL_KHR_context_flush_control = 0;
	if (glloader_is_supported("EGL_KHR_context_flush_control"))
	{
		_EGL_KHR_context_flush_control = 1;
	}
}
...
void init_EGL_KHR_debug()
{
	glloader_EGL_KHR_debug = _glloader_EGL_KHR_debug;

	_EGL_KHR_debug = 0;
	if (glloader_is_supported("EGL_KHR_debug"))
	{
		_EGL_KHR_debug = 1;

		LOAD_FUNC1(eglDebugMessageControlKHR);
		LOAD_FUNC1(eglQueryDebugKHR);
		LOAD_FUNC1(eglLabelObjectKHR);
	}
}
...
void init_EGL_KHR_mutable_render_buffer()
{
	glloader_EGL_KHR_mutable_render_buffer = _glloader_EGL_KHR_mutable_render_buffer;

	_EGL_KHR_mutable_render_buffer = 0;
	if (glloader_is_supported("EGL_KHR_mutable_render_buffer"))
	{
		_EGL_KHR_mutable_render_buffer = 1;
	}
}

void init_EGL_KHR_no_config_context()
{
	glloader_EGL_KHR_no_config_context = _glloader_EGL_KHR_no_config_context;

	_EGL_KHR_no_config_context = 0;
	if (glloader_is_supported("EGL_KHR_no_config_context"))
	{
		_EGL_KHR_no_config_context = 1;
	}
}
...
void init_EGL_MESA_platform_surfaceless()
{
	glloader_EGL_MESA_platform_surfaceless = _glloader_EGL_MESA_platform_surfaceless;

	_EGL_MESA_platform_surfaceless = 0;
	if (glloader_is_supported("EGL_MESA_platform_surfaceless"))
	{
		_EGL_MESA_platform_surfaceless = 1;
	}
}
...
void init_EGL_NV_stream_consumer_gltexture_yuv()
{
	glloader_EGL_NV_stream_consumer_gltexture_yuv = _glloader_EGL_NV_stream_consumer_gltexture_yuv;

	_EGL_NV_stream_consumer_gltexture_yuv = 0;
	if (glloader_is_supported("EGL_NV_stream_consumer_gltexture_yuv"))
	{
		_EGL_NV_stream_consumer_gltexture_yuv = 1;

		LOAD_FUNC1(eglStreamConsumerGLTextureExternalAttribsNV);
	}
}

void init_EGL_NV_stream_cross_display()
{
	glloader_EGL_NV_stream_cross_display = _glloader_EGL_NV_stream_cross_display;

	_EGL_NV_stream_cross_display = 0;
	if (glloader_is_supported("EGL_NV_stream_cross_display"))
	{
		_EGL_NV_stream_cross_display = 1;
	}
}

void init_EGL_NV_stream_cross_object()
{
	glloader_EGL_NV_stream_cross_object = _glloader_EGL_NV_stream_cross_object;

	_EGL_NV_stream_cross_object = 0;
	if (glloader_is_supported("EGL_NV_stream_cross_object"))
	{
		_EGL_NV_stream_cross_object = 1;
	}
}

void init_EGL_NV_stream_cross_partition()
{
	glloader_EGL_NV_stream_cross_partition = _glloader_EGL_NV_stream_cross_partition;

	_EGL_NV_stream_cross_partition = 0;
	if (glloader_is_supported("EGL_NV_stream_cross_partition"))
	{
		_EGL_NV_stream_cross_partition = 1;
	}
}

void init_EGL_NV_stream_cross_process()
{
	glloader_EGL_NV_stream_cross_process = _glloader_EGL_NV_stream_cross_process;

	_EGL_NV_stream_cross_process = 0;
	if (glloader_is_supported("EGL_NV_stream_cross_process"))
	{
		_EGL_NV_stream_cross_process = 1;
	}
}

void init_EGL_NV_stream_cross_system()
{
	glloader_EGL_NV_stream_cross_system = _glloader_EGL_NV_stream_cross_system;

	_EGL_NV_stream_cross_system = 0;
	if (glloader_is_supported("EGL_NV_stream_cross_system"))
	{
		_EGL_NV_stream_cross_system = 1;
	}
}

void init_EGL_NV_stream_fifo_next()
{
	glloader_EGL_NV_stream_fifo_next = _glloader_EGL_NV_stream_fifo_next;

	_EGL_NV_stream_fifo_next = 0;
	if (glloader_is_supported("EGL_NV_stream_fifo_next"))
	{
		_EGL_NV_stream_fifo_next = 1;
	}
}

void init_EGL_NV_stream_fifo_synchronous()
{
	glloader_EGL_NV_stream_fifo_synchronous = _glloader_EGL_NV_stream_fifo_synchronous;

	_EGL_NV_stream_fifo_synchronous = 0;
	if (glloader_is_supported("EGL_NV_stream_fifo_synchronous"))
	{
		_EGL_NV_stream_fifo_synchronous = 1;
	}
}

void init_EGL_NV_stream_frame_limits()
{
	glloader_EGL_NV_stream_frame_limits = _glloader_EGL_NV_stream_frame_limits;

	_EGL_NV_stream_frame_limits = 0;
	if (glloader_is_supported("EGL_NV_stream_frame_limits"))
	{
		_EGL_NV_stream_frame_limits = 1;
	}
}

void init_EGL_NV_stream_metadata()
{
	glloader_EGL_NV_stream_metadata = _glloader_EGL_NV_stream_metadata;

	_EGL_NV_stream_metadata = 0;
	if (glloader_is_supported("EGL_NV_stream_metadata"))
	{
		_EGL_NV_stream_metadata = 1;

		LOAD_FUNC1(eglQueryDisplayAttribNV);
		LOAD_FUNC1(eglSetStreamMetadataNV);
		LOAD_FUNC1(eglQueryStreamMetadataNV);
	}
}

void init_EGL_NV_stream_remote()
{
	glloader_EGL_NV_stream_remote = _glloader_EGL_NV_stream_remote;

	_EGL_NV_stream_remote = 0;
	if (glloader_is_supported("EGL_NV_stream_remote"))
	{
		_EGL_NV_stream_remote = 1;
	}
}

void init_EGL_NV_stream_reset()
{
	glloader_EGL_NV_stream_reset = _glloader_EGL_NV_stream_reset;

	_EGL_NV_stream_reset = 0;
	if (glloader_is_supported("EGL_NV_stream_reset"))
	{
		_EGL_NV_stream_reset = 1;

		LOAD_FUNC1(eglResetStreamNV);
	}
}

void init_EGL_NV_stream_socket()
{
	glloader_EGL_NV_stream_socket = _glloader_EGL_NV_stream_socket;

	_EGL_NV_stream_socket = 0;
	if (glloader_is_supported("EGL_NV_stream_socket"))
	{
		_EGL_NV_stream_socket = 1;
	}
}

void init_EGL_NV_stream_socket_inet()
{
	glloader_EGL_NV_stream_socket_inet = _glloader_EGL_NV_stream_socket_inet;

	_EGL_NV_stream_socket_inet = 0;
	if (glloader_is_supported("EGL_NV_stream_socket_inet"))
	{
		_EGL_NV_stream_socket_inet = 1;
	}
}

void init_EGL_NV_stream_socket_unix()
{
	glloader_EGL_NV_stream_socket_unix = _glloader_EGL_NV_stream_socket_unix;

	_EGL_NV_stream_socket_unix = 0;
	if (glloader_is_supported("EGL_NV_stream_socket_unix"))
	{
		_EGL_NV_stream_socket_unix = 1;
	}
}
...
void egl_init()
{
	...
	init_EGL_EXT_gl_colorspace_bt2020_linear();
	init_EGL_EXT_gl_colorspace_bt2020_pq();
	init_EGL_EXT_gl_colorspace_display_p3();
	init_EGL_EXT_gl_colorspace_display_p3_linear();
	init_EGL_EXT_gl_colorspace_scrgb();
	init_EGL_EXT_gl_colorspace_scrgb_linear();
	init_EGL_EXT_image_dma_buf_import();
	init_EGL_EXT_image_dma_buf_import_modifiers();
	init_EGL_EXT_image_implicit_sync_control();
	init_EGL_EXT_multiview_window();
	init_EGL_EXT_output_base();
	init_EGL_EXT_pixel_format_float();
	...
	init_EGL_EXT_surface_CTA861_3_metadata();
	init_EGL_EXT_surface_SMPTE2086_metadata();
	...
	init_EGL_MESA_platform_surfaceless();
	...
	init_EGL_NV_stream_cross_display();
	init_EGL_NV_stream_cross_object();
	init_EGL_NV_stream_cross_partition();
	init_EGL_NV_stream_cross_process();
	init_EGL_NV_stream_cross_system();
	init_EGL_NV_stream_fifo_next();
	init_EGL_NV_stream_fifo_synchronous();
	init_EGL_NV_stream_frame_limits();
	init_EGL_NV_stream_metadata();
	init_EGL_NV_stream_remote();
	init_EGL_NV_stream_reset();
	init_EGL_NV_stream_socket();
	init_EGL_NV_stream_socket_inet();
	init_EGL_NV_stream_socket_unix();
