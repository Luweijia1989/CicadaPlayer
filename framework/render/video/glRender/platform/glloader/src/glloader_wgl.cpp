...
char _WGL_ARB_create_context_no_error = 0;
...
static char GLLOADER_APIENTRY _glloader_WGL_ARB_create_context_no_error()
{
	return _WGL_ARB_create_context_no_error;
}

static char GLLOADER_APIENTRY self_init_glloader_WGL_ARB_create_context_no_error()
{
	glloader_init();
	return glloader_WGL_ARB_create_context_no_error();
}
glloader_WGL_ARB_create_context_no_errorFUNC glloader_WGL_ARB_create_context_no_error = self_init_glloader_WGL_ARB_create_context_no_error;
...
static char GLLOADER_APIENTRY _glloader_WGL_EXT_colorspace()
{
	return _WGL_EXT_colorspace;
}

static char GLLOADER_APIENTRY self_init_glloader_WGL_EXT_colorspace()
{
	glloader_init();
	return glloader_WGL_EXT_colorspace();
}
glloader_WGL_EXT_colorspaceFUNC glloader_WGL_EXT_colorspace = self_init_glloader_WGL_EXT_colorspace;
...
void init_WGL_ARB_create_context_no_error()
{
	glloader_WGL_ARB_create_context_no_error = _glloader_WGL_ARB_create_context_no_error;

	_WGL_ARB_create_context_no_error = 0;
	if (glloader_is_supported("WGL_ARB_create_context_no_error"))
	{
		_WGL_ARB_create_context_no_error = 1;
	}
}
...
void init_WGL_EXT_colorspace()
{
	glloader_WGL_EXT_colorspace = _glloader_WGL_EXT_colorspace;

	_WGL_EXT_colorspace = 0;
	if (glloader_is_supported("WGL_EXT_colorspace"))
	{
		_WGL_EXT_colorspace = 1;
	}
}
...
void wgl_init()
{
	...
	init_WGL_ARB_create_context_no_error();
