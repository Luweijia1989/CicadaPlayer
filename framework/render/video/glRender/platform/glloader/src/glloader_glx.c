...
char _GLX_ARB_create_context_no_error = 0;
...
static char GLLOADER_APIENTRY _glloader_GLX_ARB_create_context_no_error()
{
	return _GLX_ARB_create_context_no_error;
}

static char GLLOADER_APIENTRY self_init_glloader_GLX_ARB_create_context_no_error()
{
	glloader_init();
	return glloader_GLX_ARB_create_context_no_error();
}
glloader_GLX_ARB_create_context_no_errorFUNC glloader_GLX_ARB_create_context_no_error = self_init_glloader_GLX_ARB_create_context_no_error;
...
static char GLLOADER_APIENTRY _glloader_GLX_EXT_libglvnd()
{
	return _GLX_EXT_libglvnd;
}

static char GLLOADER_APIENTRY self_init_glloader_GLX_EXT_libglvnd()
{
	glloader_init();
	return glloader_GLX_EXT_libglvnd();
}
glloader_GLX_EXT_libglvndFUNC glloader_GLX_EXT_libglvnd = self_init_glloader_GLX_EXT_libglvnd;
...
void init_GLX_ARB_create_context_no_error()
{
	glloader_GLX_ARB_create_context_no_error = _glloader_GLX_ARB_create_context_no_error;

	_GLX_ARB_create_context_no_error = 0;
	if (glloader_is_supported("GLX_ARB_create_context_no_error"))
	{
		_GLX_ARB_create_context_no_error = 1;
	}
}
...
void init_GLX_EXT_libglvnd()
{
	glloader_GLX_EXT_libglvnd = _glloader_GLX_EXT_libglvnd;

	_GLX_EXT_libglvnd = 0;
	if (glloader_is_supported("GLX_EXT_libglvnd"))
	{
		_GLX_EXT_libglvnd = 1;
	}
}
...
void glx_init()
{
	...
	init_GLX_ARB_create_context_no_error();
