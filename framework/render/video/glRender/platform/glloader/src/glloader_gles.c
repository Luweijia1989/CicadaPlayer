...
char _GLES_ANGLE_timer_query = 0;
...
char _GLES_EXT_blend_func_extended = 0;
char _GLES_EXT_blend_minmax = 0;
char _GLES_EXT_buffer_storage = 0;
char _GLES_EXT_clear_texture = 0;
char _GLES_EXT_clip_cull_distance = 0;
...
char _GLES_EXT_conservative_depth = 0;
...
char _GLES_EXT_draw_transform_feedback = 0;
char _GLES_EXT_EGL_image_array = 0;
char _GLES_EXT_external_buffer = 0;
...
char _GLES_EXT_memory_object = 0;
char _GLES_EXT_memory_object_fd = 0;
char _GLES_EXT_memory_object_win32 = 0;
char _GLES_EXT_multisampled_render_to_texture = 0;
char _GLES_EXT_multisampled_render_to_texture2 = 0;
char _GLES_EXT_multisample_compatibility = 0;
...
char _GLES_EXT_texture_compression_astc_decode_mode = 0;
char _GLES_EXT_texture_compression_bptc = 0;
char _GLES_EXT_texture_compression_dxt1 = 0;
char _GLES_EXT_texture_compression_latc = 0;
char _GLES_EXT_texture_compression_rgtc = 0;
...
char _GLES_EXT_win32_keyed_mutex = 0;
char _GLES_EXT_window_rectangles = 0;
char _GLES_EXT_YUV_target = 0;
char _GLES_FJ_shader_binary_GCCSO = 0;
char _GLES_IMG_bindless_texture = 0;
char _GLES_IMG_framebuffer_downsample = 0;
...
char _GLES_IMG_texture_filter_cubic = 0;
char _GLES_IMG_user_clip_plane = 0;
char _GLES_INTEL_conservative_rasterization = 0;
char _GLES_INTEL_framebuffer_CMAA = 0;
...
char _GLES_NV_draw_vulkan_image = 0;
...
char _GLES_NV_shader_atomic_fp16_vector = 0;
...
char _GLES_NV_texture_barrier = 0;
...
char _GLES_NV_viewport_swizzle = 0;
...
char _GLES_OES_sample_shading = 0;
char _GLES_OES_sample_variables = 0;
char _GLES_OES_shader_binary = 0;
char _GLES_OES_shader_image_atomic = 0;
char _GLES_OES_shader_io_blocks = 0;
char _GLES_OES_shader_multisample_interpolation = 0;
...
char _GLES_OES_texture_stencil8 = 0;
char _GLES_OES_texture_storage_multisample_2d_array = 0;
...
char _GLES_OES_viewport_array = 0;
char _GLES_OVR_multiview = 0;
char _GLES_OVR_multiview2 = 0;
char _GLES_OVR_multiview_multisampled_render_to_texture = 0;
...
char _GLES_QCOM_framebuffer_foveated = 0;
char _GLES_QCOM_performance_monitor_global_mode = 0;
char _GLES_QCOM_shader_framebuffer_fetch_noncoherent = 0;
...
static char GLLOADER_APIENTRY _glloader_GLES_VERSION_3_2()
{
	return _GLES_VERSION_3_2;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_VERSION_3_2()
{
	glloader_init();
	return glloader_GLES_VERSION_3_2();
}
glloader_GLES_VERSION_3_2FUNC glloader_GLES_VERSION_3_2 = self_init_glloader_GLES_VERSION_3_2;

#ifdef GLES_VERSION_3_2

static void GLLOADER_APIENTRY self_init_glBlendBarrier()
{
	LOAD_FUNC1(glBlendBarrier);
	glBlendBarrier();
}
static void GLLOADER_APIENTRY self_init_glCopyImageSubData(GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei srcWidth, GLsizei srcHeight, GLsizei srcDepth)
{
	LOAD_FUNC1(glCopyImageSubData);
...
static void GLLOADER_APIENTRY self_init_glDebugMessageCallback(GLDEBUGPROC callback, const void* userParam)
{
...
static void GLLOADER_APIENTRY self_init_glObjectPtrLabel(const void* ptr, GLsizei length, const GLchar* label)
{
	LOAD_FUNC1(glObjectPtrLabel);
	glObjectPtrLabel(ptr, length, label);
}
static void GLLOADER_APIENTRY self_init_glGetObjectPtrLabel(const void* ptr, GLsizei bufSize, GLsizei* length, GLchar* label)
{
	LOAD_FUNC1(glGetObjectPtrLabel);
	glGetObjectPtrLabel(ptr, bufSize, length, label);
}
static void GLLOADER_APIENTRY self_init_glEnablei(GLenum target, GLuint index)
{
	LOAD_FUNC1(glEnablei);
	glEnablei(target, index);
}
static void GLLOADER_APIENTRY self_init_glDisablei(GLenum target, GLuint index)
{
	LOAD_FUNC1(glDisablei);
	glDisablei(target, index);
}
static void GLLOADER_APIENTRY self_init_glBlendEquationi(GLuint buf, GLenum mode)
{
	LOAD_FUNC1(glBlendEquationi);
	glBlendEquationi(buf, mode);
}
static void GLLOADER_APIENTRY self_init_glBlendEquationSeparatei(GLuint buf, GLenum modeRGB, GLenum modeAlpha)
{
	LOAD_FUNC1(glBlendEquationSeparatei);
	glBlendEquationSeparatei(buf, modeRGB, modeAlpha);
}
static void GLLOADER_APIENTRY self_init_glBlendFunci(GLuint buf, GLenum src, GLenum dst)
{
	LOAD_FUNC1(glBlendFunci);
	glBlendFunci(buf, src, dst);
}
static void GLLOADER_APIENTRY self_init_glBlendFuncSeparatei(GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha)
{
	LOAD_FUNC1(glBlendFuncSeparatei);
	glBlendFuncSeparatei(buf, srcRGB, dstRGB, srcAlpha, dstAlpha);
}
static void GLLOADER_APIENTRY self_init_glColorMaski(GLuint index, GLboolean r, GLboolean g, GLboolean b, GLboolean a)
{
	LOAD_FUNC1(glColorMaski);
	glColorMaski(index, r, g, b, a);
}
static GLboolean GLLOADER_APIENTRY self_init_glIsEnabledi(GLenum target, GLuint index)
{
	LOAD_FUNC1(glIsEnabledi);
	return glIsEnabledi(target, index);
}
static void GLLOADER_APIENTRY self_init_glDrawElementsBaseVertex(GLenum mode, GLsizei count, GLenum type, const void* indices, GLint basevertex)
{
	LOAD_FUNC1(glDrawElementsBaseVertex);
	glDrawElementsBaseVertex(mode, count, type, indices, basevertex);
}
static void GLLOADER_APIENTRY self_init_glDrawRangeElementsBaseVertex(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void* indices, GLint basevertex)
{
	LOAD_FUNC1(glDrawRangeElementsBaseVertex);
	glDrawRangeElementsBaseVertex(mode, start, end, count, type, indices, basevertex);
}
static void GLLOADER_APIENTRY self_init_glDrawElementsInstancedBaseVertex(GLenum mode, GLsizei count, GLenum type, const void* indices, GLsizei instancecount, GLint basevertex)
{
	LOAD_FUNC1(glDrawElementsInstancedBaseVertex);
	glDrawElementsInstancedBaseVertex(mode, count, type, indices, instancecount, basevertex);
}
static void GLLOADER_APIENTRY self_init_glFramebufferTexture(GLenum target, GLenum attachment, GLuint texture, GLint level)
{
	LOAD_FUNC1(glFramebufferTexture);
	glFramebufferTexture(target, attachment, texture, level);
}
static void GLLOADER_APIENTRY self_init_glPrimitiveBoundingBox(GLfloat minX, GLfloat minY, GLfloat minZ, GLfloat minW, GLfloat maxX, GLfloat maxY, GLfloat maxZ, GLfloat maxW)
{
	LOAD_FUNC1(glPrimitiveBoundingBox);
...
static void GLLOADER_APIENTRY self_init_glReadnPixels(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLsizei bufSize, void* data)
{
...
static void GLLOADER_APIENTRY self_init_glMinSampleShading(GLfloat value)
{
	LOAD_FUNC1(glMinSampleShading);
	glMinSampleShading(value);
}
static void GLLOADER_APIENTRY self_init_glPatchParameteri(GLenum pname, GLint value)
{
	LOAD_FUNC1(glPatchParameteri);
	glPatchParameteri(pname, value);
}
static void GLLOADER_APIENTRY self_init_glTexParameterIiv(GLenum target, GLenum pname, const GLint* params)
{
	LOAD_FUNC1(glTexParameterIiv);
	glTexParameterIiv(target, pname, params);
}
static void GLLOADER_APIENTRY self_init_glTexParameterIuiv(GLenum target, GLenum pname, const GLuint* params)
{
	LOAD_FUNC1(glTexParameterIuiv);
	glTexParameterIuiv(target, pname, params);
}
static void GLLOADER_APIENTRY self_init_glGetTexParameterIiv(GLenum target, GLenum pname, GLint* params)
{
	LOAD_FUNC1(glGetTexParameterIiv);
	glGetTexParameterIiv(target, pname, params);
}
static void GLLOADER_APIENTRY self_init_glGetTexParameterIuiv(GLenum target, GLenum pname, GLuint* params)
{
	LOAD_FUNC1(glGetTexParameterIuiv);
	glGetTexParameterIuiv(target, pname, params);
}
static void GLLOADER_APIENTRY self_init_glSamplerParameterIiv(GLuint sampler, GLenum pname, const GLint* param)
{
	LOAD_FUNC1(glSamplerParameterIiv);
	glSamplerParameterIiv(sampler, pname, param);
}
static void GLLOADER_APIENTRY self_init_glSamplerParameterIuiv(GLuint sampler, GLenum pname, const GLuint* param)
{
	LOAD_FUNC1(glSamplerParameterIuiv);
	glSamplerParameterIuiv(sampler, pname, param);
}
static void GLLOADER_APIENTRY self_init_glGetSamplerParameterIiv(GLuint sampler, GLenum pname, GLint* params)
{
	LOAD_FUNC1(glGetSamplerParameterIiv);
	glGetSamplerParameterIiv(sampler, pname, params);
}
static void GLLOADER_APIENTRY self_init_glGetSamplerParameterIuiv(GLuint sampler, GLenum pname, GLuint* params)
{
	LOAD_FUNC1(glGetSamplerParameterIuiv);
	glGetSamplerParameterIuiv(sampler, pname, params);
}
static void GLLOADER_APIENTRY self_init_glTexBuffer(GLenum target, GLenum internalformat, GLuint buffer)
{
	LOAD_FUNC1(glTexBuffer);
	glTexBuffer(target, internalformat, buffer);
}
static void GLLOADER_APIENTRY self_init_glTexBufferRange(GLenum target, GLenum internalformat, GLuint buffer, GLintptr offset, GLsizeiptr size)
{
	LOAD_FUNC1(glTexBufferRange);
	glTexBufferRange(target, internalformat, buffer, offset, size);
}
static void GLLOADER_APIENTRY self_init_glTexStorage3DMultisample(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations)
{
	LOAD_FUNC1(glTexStorage3DMultisample);
	glTexStorage3DMultisample(target, samples, internalformat, width, height, depth, fixedsamplelocations);
}

glBlendBarrierFUNC glBlendBarrier = self_init_glBlendBarrier;
glCopyImageSubDataFUNC glCopyImageSubData = self_init_glCopyImageSubData;
...
glEnableiFUNC glEnablei = self_init_glEnablei;
glDisableiFUNC glDisablei = self_init_glDisablei;
glBlendEquationiFUNC glBlendEquationi = self_init_glBlendEquationi;
glBlendEquationSeparateiFUNC glBlendEquationSeparatei = self_init_glBlendEquationSeparatei;
glBlendFunciFUNC glBlendFunci = self_init_glBlendFunci;
glBlendFuncSeparateiFUNC glBlendFuncSeparatei = self_init_glBlendFuncSeparatei;
glColorMaskiFUNC glColorMaski = self_init_glColorMaski;
glIsEnablediFUNC glIsEnabledi = self_init_glIsEnabledi;
glDrawElementsBaseVertexFUNC glDrawElementsBaseVertex = self_init_glDrawElementsBaseVertex;
glDrawRangeElementsBaseVertexFUNC glDrawRangeElementsBaseVertex = self_init_glDrawRangeElementsBaseVertex;
glDrawElementsInstancedBaseVertexFUNC glDrawElementsInstancedBaseVertex = self_init_glDrawElementsInstancedBaseVertex;
glFramebufferTextureFUNC glFramebufferTexture = self_init_glFramebufferTexture;
glPrimitiveBoundingBoxFUNC glPrimitiveBoundingBox = self_init_glPrimitiveBoundingBox;
...
glMinSampleShadingFUNC glMinSampleShading = self_init_glMinSampleShading;
glPatchParameteriFUNC glPatchParameteri = self_init_glPatchParameteri;
...
glSamplerParameterIivFUNC glSamplerParameterIiv = self_init_glSamplerParameterIiv;
glSamplerParameterIuivFUNC glSamplerParameterIuiv = self_init_glSamplerParameterIuiv;
glGetSamplerParameterIivFUNC glGetSamplerParameterIiv = self_init_glGetSamplerParameterIiv;
glGetSamplerParameterIuivFUNC glGetSamplerParameterIuiv = self_init_glGetSamplerParameterIuiv;
glTexBufferFUNC glTexBuffer = self_init_glTexBuffer;
glTexBufferRangeFUNC glTexBufferRange = self_init_glTexBufferRange;
glTexStorage3DMultisampleFUNC glTexStorage3DMultisample = self_init_glTexStorage3DMultisample;
...
static char GLLOADER_APIENTRY _glloader_GLES_ANGLE_timer_query()
{
	return _GLES_ANGLE_timer_query;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_ANGLE_timer_query()
{
	glloader_init();
	return glloader_GLES_ANGLE_timer_query();
}
glloader_GLES_ANGLE_timer_queryFUNC glloader_GLES_ANGLE_timer_query = self_init_glloader_GLES_ANGLE_timer_query;

#ifdef GLES_ANGLE_timer_query
...
static char GLLOADER_APIENTRY _glloader_GLES_EXT_blend_func_extended()
{
	return _GLES_EXT_blend_func_extended;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_blend_func_extended()
{
	glloader_init();
	return glloader_GLES_EXT_blend_func_extended();
}
glloader_GLES_EXT_blend_func_extendedFUNC glloader_GLES_EXT_blend_func_extended = self_init_glloader_GLES_EXT_blend_func_extended;

#ifdef GLES_EXT_blend_func_extended

static void GLLOADER_APIENTRY self_init_glBindFragDataLocationIndexedEXT(GLuint program, GLuint colorNumber, GLuint index, const GLchar* name)
{
	glloader_init();
	glBindFragDataLocationIndexedEXT(program, colorNumber, index, name);
}
static GLint GLLOADER_APIENTRY self_init_glGetFragDataIndexEXT(GLuint program, const GLchar* name)
{
	glloader_init();
	return glGetFragDataIndexEXT(program, name);
}
static void GLLOADER_APIENTRY self_init_glBindFragDataLocationEXT(GLuint program, GLuint colorNumber, const GLchar* name)
{
	glloader_init();
	glBindFragDataLocationEXT(program, colorNumber, name);
}
static void GLLOADER_APIENTRY self_init_glGetProgramResourceLocationIndexEXT(GLuint program, GLenum programInterface, const GLchar* name)
{
	glloader_init();
	glGetProgramResourceLocationIndexEXT(program, programInterface, name);
}

glBindFragDataLocationIndexedEXTFUNC glBindFragDataLocationIndexedEXT = self_init_glBindFragDataLocationIndexedEXT;
glGetFragDataIndexEXTFUNC glGetFragDataIndexEXT = self_init_glGetFragDataIndexEXT;
glBindFragDataLocationEXTFUNC glBindFragDataLocationEXT = self_init_glBindFragDataLocationEXT;
glGetProgramResourceLocationIndexEXTFUNC glGetProgramResourceLocationIndexEXT = self_init_glGetProgramResourceLocationIndexEXT;
...
static char GLLOADER_APIENTRY _glloader_GLES_EXT_clear_texture()
{
	return _GLES_EXT_clear_texture;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_clear_texture()
{
	glloader_init();
	return glloader_GLES_EXT_clear_texture();
}
glloader_GLES_EXT_clear_textureFUNC glloader_GLES_EXT_clear_texture = self_init_glloader_GLES_EXT_clear_texture;

#ifdef GLES_EXT_clear_texture

static void GLLOADER_APIENTRY self_init_glClearTexImageEXT(GLuint texture, GLint level, GLenum format, GLenum type, const void* data)
{
	glloader_init();
	glClearTexImageEXT(texture, level, format, type, data);
}
static void GLLOADER_APIENTRY self_init_glClearTexSubImageEXT(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void* data)
{
	glloader_init();
	glClearTexSubImageEXT(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type, data);
}

glClearTexImageEXTFUNC glClearTexImageEXT = self_init_glClearTexImageEXT;
glClearTexSubImageEXTFUNC glClearTexSubImageEXT = self_init_glClearTexSubImageEXT;

#endif

static char GLLOADER_APIENTRY _glloader_GLES_EXT_clip_cull_distance()
{
	return _GLES_EXT_clip_cull_distance;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_clip_cull_distance()
{
	glloader_init();
	return glloader_GLES_EXT_clip_cull_distance();
}
glloader_GLES_EXT_clip_cull_distanceFUNC glloader_GLES_EXT_clip_cull_distance = self_init_glloader_GLES_EXT_clip_cull_distance;
...
static char GLLOADER_APIENTRY _glloader_GLES_EXT_conservative_depth()
{
	return _GLES_EXT_conservative_depth;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_conservative_depth()
{
	glloader_init();
	return glloader_GLES_EXT_conservative_depth();
}
glloader_GLES_EXT_conservative_depthFUNC glloader_GLES_EXT_conservative_depth = self_init_glloader_GLES_EXT_conservative_depth;
...
static char GLLOADER_APIENTRY _glloader_GLES_EXT_draw_transform_feedback()
{
	return _GLES_EXT_draw_transform_feedback;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_draw_transform_feedback()
{
	glloader_init();
	return glloader_GLES_EXT_draw_transform_feedback();
}
glloader_GLES_EXT_draw_transform_feedbackFUNC glloader_GLES_EXT_draw_transform_feedback = self_init_glloader_GLES_EXT_draw_transform_feedback;

#ifdef GLES_EXT_draw_transform_feedback

static void GLLOADER_APIENTRY self_init_glDrawTransformFeedbackEXT(GLenum mode, GLuint id)
{
	glloader_init();
	glDrawTransformFeedbackEXT(mode, id);
}
static void GLLOADER_APIENTRY self_init_glDrawTransformFeedbackInstancedEXT(GLenum mode, GLuint id, GLsizei instancecount)
{
	glloader_init();
	glDrawTransformFeedbackInstancedEXT(mode, id, instancecount);
}

glDrawTransformFeedbackEXTFUNC glDrawTransformFeedbackEXT = self_init_glDrawTransformFeedbackEXT;
glDrawTransformFeedbackInstancedEXTFUNC glDrawTransformFeedbackInstancedEXT = self_init_glDrawTransformFeedbackInstancedEXT;

#endif

static char GLLOADER_APIENTRY _glloader_GLES_EXT_EGL_image_array()
{
	return _GLES_EXT_EGL_image_array;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_EGL_image_array()
{
	glloader_init();
	return glloader_GLES_EXT_EGL_image_array();
}
glloader_GLES_EXT_EGL_image_arrayFUNC glloader_GLES_EXT_EGL_image_array = self_init_glloader_GLES_EXT_EGL_image_array;

static char GLLOADER_APIENTRY _glloader_GLES_EXT_external_buffer()
{
	return _GLES_EXT_external_buffer;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_external_buffer()
{
	glloader_init();
	return glloader_GLES_EXT_external_buffer();
}
glloader_GLES_EXT_external_bufferFUNC glloader_GLES_EXT_external_buffer = self_init_glloader_GLES_EXT_external_buffer;

#ifdef GLES_EXT_external_buffer

static void GLLOADER_APIENTRY self_init_glBufferStorageExternalEXT(GLenum target, GLintptr offset, GLsizeiptr size, GLeglClientBufferEXT clientBuffer, GLbitfield flags)
{
	glloader_init();
	glBufferStorageExternalEXT(target, offset, size, clientBuffer, flags);
}

glBufferStorageExternalEXTFUNC glBufferStorageExternalEXT = self_init_glBufferStorageExternalEXT;
...
static char GLLOADER_APIENTRY _glloader_GLES_EXT_memory_object()
{
	return _GLES_EXT_memory_object;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_memory_object()
{
	glloader_init();
	return glloader_GLES_EXT_memory_object();
}
glloader_GLES_EXT_memory_objectFUNC glloader_GLES_EXT_memory_object = self_init_glloader_GLES_EXT_memory_object;

#ifdef GLES_EXT_memory_object

static void GLLOADER_APIENTRY self_init_glGetUnsignedBytevEXT(GLenum pname, GLubyte* data)
{
	glloader_init();
	glGetUnsignedBytevEXT(pname, data);
}
static void GLLOADER_APIENTRY self_init_glGetUnsignedBytei_vEXT(GLenum target, GLuint index, GLubyte* data)
{
	glloader_init();
	glGetUnsignedBytei_vEXT(target, index, data);
}
static void GLLOADER_APIENTRY self_init_glDeleteMemoryObjectsEXT(GLsizei n, const GLuint* memoryObjects)
{
	glloader_init();
	glDeleteMemoryObjectsEXT(n, memoryObjects);
}
static GLboolean GLLOADER_APIENTRY self_init_IsMemoryObjectEXT(GLuint memoryObject)
{
	glloader_init();
	return IsMemoryObjectEXT(memoryObject);
}
static void GLLOADER_APIENTRY self_init_glCreateMemoryObjectsEXT(GLsizei n, GLuint* memoryObjects)
{
	glloader_init();
	glCreateMemoryObjectsEXT(n, memoryObjects);
}
static void GLLOADER_APIENTRY self_init_glMemoryObjectParameterivEXT(GLuint memoryObject, GLenum pname, const GLint* params)
{
	glloader_init();
	glMemoryObjectParameterivEXT(memoryObject, pname, params);
}
static void GLLOADER_APIENTRY self_init_glGetMemoryObjectParameterivEXT(GLuint memoryObject, GLenum pname, GLint* params)
{
	glloader_init();
	glGetMemoryObjectParameterivEXT(memoryObject, pname, params);
}
static void GLLOADER_APIENTRY self_init_glTexStorageMem2DEXT(GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height, GLuint memory, GLuint64 offset)
{
	glloader_init();
	glTexStorageMem2DEXT(target, levels, internalFormat, width, height, memory, offset);
}
static void GLLOADER_APIENTRY self_init_glTexStorageMem2DMultisampleEXT(GLenum target, GLsizei samples, GLenum internalFormat, GLsizei width, GLsizei height, GLboolean fixedSampleLocations, GLuint memory, GLuint64 offset)
{
	glloader_init();
	glTexStorageMem2DMultisampleEXT(target, samples, internalFormat, width, height, fixedSampleLocations, memory, offset);
}
static void GLLOADER_APIENTRY self_init_glTexStorageMem3DEXT(GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLuint memory, GLuint64 offset)
{
	glloader_init();
	glTexStorageMem3DEXT(target, levels, internalFormat, width, height, depth, memory, offset);
}
static void GLLOADER_APIENTRY self_init_glTexStorageMem3DMultisampleEXT(GLenum target, GLsizei samples, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedSampleLocations, GLuint memory, GLuint64 offset)
{
	glloader_init();
	glTexStorageMem3DMultisampleEXT(target, samples, internalFormat, width, height, depth, fixedSampleLocations, memory, offset);
}
static void GLLOADER_APIENTRY self_init_glBufferStorageMemEXT(GLenum target, GLsizeiptr size, GLuint memory, GLuint64 offset)
{
	glloader_init();
	glBufferStorageMemEXT(target, size, memory, offset);
}
static void GLLOADER_APIENTRY self_init_glTextureStorageMem2DEXT(GLuint texture, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height, GLuint memory, GLuint64 offset)
{
	glloader_init();
	glTextureStorageMem2DEXT(texture, levels, internalFormat, width, height, memory, offset);
}
static void GLLOADER_APIENTRY self_init_glTextureStorageMem2DMultisampleEXT(GLuint texture, GLsizei samples, GLenum internalFormat, GLsizei width, GLsizei height, GLboolean fixedSampleLocations, GLuint memory, GLuint64 offset)
{
	glloader_init();
	glTextureStorageMem2DMultisampleEXT(texture, samples, internalFormat, width, height, fixedSampleLocations, memory, offset);
}
static void GLLOADER_APIENTRY self_init_glTextureStorageMem3DEXT(GLuint texture, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLuint memory, GLuint64 offset)
{
	glloader_init();
	glTextureStorageMem3DEXT(texture, levels, internalFormat, width, height, depth, memory, offset);
}
static void GLLOADER_APIENTRY self_init_glTextureStorageMem3DMultisampleEXT(GLuint texture, GLsizei samples, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedSampleLocations, GLuint memory, GLuint64 offset)
{
	glloader_init();
	glTextureStorageMem3DMultisampleEXT(texture, samples, internalFormat, width, height, depth, fixedSampleLocations, memory, offset);
}
static void GLLOADER_APIENTRY self_init_glNamedBufferStorageMemEXT(GLuint buffer, GLsizeiptr size, GLuint memory, GLuint64 offset)
{
	glloader_init();
	glNamedBufferStorageMemEXT(buffer, size, memory, offset);
}
static void GLLOADER_APIENTRY self_init_glTexStorageMem1DEXT(GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLuint memory, GLuint64 offset)
{
	glloader_init();
	glTexStorageMem1DEXT(target, levels, internalFormat, width, memory, offset);
}
static void GLLOADER_APIENTRY self_init_glTextureStorageMem1DEXT(GLuint texture, GLsizei levels, GLenum internalFormat, GLsizei width, GLuint memory, GLuint64 offset)
{
	glloader_init();
	glTextureStorageMem1DEXT(texture, levels, internalFormat, width, memory, offset);
}

glGetUnsignedBytevEXTFUNC glGetUnsignedBytevEXT = self_init_glGetUnsignedBytevEXT;
glGetUnsignedBytei_vEXTFUNC glGetUnsignedBytei_vEXT = self_init_glGetUnsignedBytei_vEXT;
glDeleteMemoryObjectsEXTFUNC glDeleteMemoryObjectsEXT = self_init_glDeleteMemoryObjectsEXT;
IsMemoryObjectEXTFUNC IsMemoryObjectEXT = self_init_IsMemoryObjectEXT;
glCreateMemoryObjectsEXTFUNC glCreateMemoryObjectsEXT = self_init_glCreateMemoryObjectsEXT;
glMemoryObjectParameterivEXTFUNC glMemoryObjectParameterivEXT = self_init_glMemoryObjectParameterivEXT;
glGetMemoryObjectParameterivEXTFUNC glGetMemoryObjectParameterivEXT = self_init_glGetMemoryObjectParameterivEXT;
glTexStorageMem2DEXTFUNC glTexStorageMem2DEXT = self_init_glTexStorageMem2DEXT;
glTexStorageMem2DMultisampleEXTFUNC glTexStorageMem2DMultisampleEXT = self_init_glTexStorageMem2DMultisampleEXT;
glTexStorageMem3DEXTFUNC glTexStorageMem3DEXT = self_init_glTexStorageMem3DEXT;
glTexStorageMem3DMultisampleEXTFUNC glTexStorageMem3DMultisampleEXT = self_init_glTexStorageMem3DMultisampleEXT;
glBufferStorageMemEXTFUNC glBufferStorageMemEXT = self_init_glBufferStorageMemEXT;
glTextureStorageMem2DEXTFUNC glTextureStorageMem2DEXT = self_init_glTextureStorageMem2DEXT;
glTextureStorageMem2DMultisampleEXTFUNC glTextureStorageMem2DMultisampleEXT = self_init_glTextureStorageMem2DMultisampleEXT;
glTextureStorageMem3DEXTFUNC glTextureStorageMem3DEXT = self_init_glTextureStorageMem3DEXT;
glTextureStorageMem3DMultisampleEXTFUNC glTextureStorageMem3DMultisampleEXT = self_init_glTextureStorageMem3DMultisampleEXT;
glNamedBufferStorageMemEXTFUNC glNamedBufferStorageMemEXT = self_init_glNamedBufferStorageMemEXT;
glTexStorageMem1DEXTFUNC glTexStorageMem1DEXT = self_init_glTexStorageMem1DEXT;
glTextureStorageMem1DEXTFUNC glTextureStorageMem1DEXT = self_init_glTextureStorageMem1DEXT;

#endif

static char GLLOADER_APIENTRY _glloader_GLES_EXT_memory_object_fd()
{
	return _GLES_EXT_memory_object_fd;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_memory_object_fd()
{
	glloader_init();
	return glloader_GLES_EXT_memory_object_fd();
}
glloader_GLES_EXT_memory_object_fdFUNC glloader_GLES_EXT_memory_object_fd = self_init_glloader_GLES_EXT_memory_object_fd;

#ifdef GLES_EXT_memory_object_fd

static void GLLOADER_APIENTRY self_init_glImportMemoryFdEXT(GLuint memory, GLuint64 size, GLenum handleType, GLint fd)
{
	glloader_init();
	glImportMemoryFdEXT(memory, size, handleType, fd);
}

glImportMemoryFdEXTFUNC glImportMemoryFdEXT = self_init_glImportMemoryFdEXT;

#endif

static char GLLOADER_APIENTRY _glloader_GLES_EXT_memory_object_win32()
{
	return _GLES_EXT_memory_object_win32;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_memory_object_win32()
{
	glloader_init();
	return glloader_GLES_EXT_memory_object_win32();
}
glloader_GLES_EXT_memory_object_win32FUNC glloader_GLES_EXT_memory_object_win32 = self_init_glloader_GLES_EXT_memory_object_win32;

#ifdef GLES_EXT_memory_object_win32

static void GLLOADER_APIENTRY self_init_glImportMemoryWin32HandleEXT(GLuint memory, GLuint64 size, GLenum handleType, void* handle)
{
	glloader_init();
	glImportMemoryWin32HandleEXT(memory, size, handleType, handle);
}
static void GLLOADER_APIENTRY self_init_glImportMemoryWin32NameEXT(GLuint memory, GLuint64 size, GLenum handleType, const void* name)
{
	glloader_init();
	glImportMemoryWin32NameEXT(memory, size, handleType, name);
}

glImportMemoryWin32HandleEXTFUNC glImportMemoryWin32HandleEXT = self_init_glImportMemoryWin32HandleEXT;
glImportMemoryWin32NameEXTFUNC glImportMemoryWin32NameEXT = self_init_glImportMemoryWin32NameEXT;
...
static char GLLOADER_APIENTRY _glloader_GLES_EXT_multisampled_render_to_texture2()
{
	return _GLES_EXT_multisampled_render_to_texture2;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_multisampled_render_to_texture2()
{
	glloader_init();
	return glloader_GLES_EXT_multisampled_render_to_texture2();
}
glloader_GLES_EXT_multisampled_render_to_texture2FUNC glloader_GLES_EXT_multisampled_render_to_texture2 = self_init_glloader_GLES_EXT_multisampled_render_to_texture2;

static char GLLOADER_APIENTRY _glloader_GLES_EXT_multisample_compatibility()
{
	return _GLES_EXT_multisample_compatibility;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_multisample_compatibility()
{
	glloader_init();
	return glloader_GLES_EXT_multisample_compatibility();
}
glloader_GLES_EXT_multisample_compatibilityFUNC glloader_GLES_EXT_multisample_compatibility = self_init_glloader_GLES_EXT_multisample_compatibility;
...
static char GLLOADER_APIENTRY _glloader_GLES_EXT_polygon_offset_clamp()
{
	return _GLES_EXT_polygon_offset_clamp;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_polygon_offset_clamp()
{
	glloader_init();
	return glloader_GLES_EXT_polygon_offset_clamp();
}
glloader_GLES_EXT_polygon_offset_clampFUNC glloader_GLES_EXT_polygon_offset_clamp = self_init_glloader_GLES_EXT_polygon_offset_clamp;

#ifdef GLES_EXT_polygon_offset_clamp

static void GLLOADER_APIENTRY self_init_glPolygonOffsetClampEXT(GLfloat factor, GLfloat units, GLfloat clamp)
{
	glloader_init();
	glPolygonOffsetClampEXT(factor, units, clamp);
}

glPolygonOffsetClampEXTFUNC glPolygonOffsetClampEXT = self_init_glPolygonOffsetClampEXT;
...
static char GLLOADER_APIENTRY _glloader_GLES_EXT_protected_textures()
{
	return _GLES_EXT_protected_textures;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_protected_textures()
{
	glloader_init();
	return glloader_GLES_EXT_protected_textures();
}
glloader_GLES_EXT_protected_texturesFUNC glloader_GLES_EXT_protected_textures = self_init_glloader_GLES_EXT_protected_textures;
...
static char GLLOADER_APIENTRY _glloader_GLES_EXT_semaphore()
{
	return _GLES_EXT_semaphore;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_semaphore()
{
	glloader_init();
	return glloader_GLES_EXT_semaphore();
}
glloader_GLES_EXT_semaphoreFUNC glloader_GLES_EXT_semaphore = self_init_glloader_GLES_EXT_semaphore;

#ifdef GLES_EXT_semaphore

static void GLLOADER_APIENTRY self_init_glGenSemaphoresEXT(GLsizei n, GLuint* semaphores)
{
	glloader_init();
	glGenSemaphoresEXT(n, semaphores);
}
static void GLLOADER_APIENTRY self_init_glDeleteSemaphoresEXT(GLsizei n, const GLuint* semaphores)
{
	glloader_init();
	glDeleteSemaphoresEXT(n, semaphores);
}
static GLboolean GLLOADER_APIENTRY self_init_glIsSemaphoreEXT(GLuint semaphore)
{
	glloader_init();
	return glIsSemaphoreEXT(semaphore);
}
static void GLLOADER_APIENTRY self_init_glSemaphoreParameterui64vEXT(GLuint semaphore, GLenum pname, const GLuint64* params)
{
	glloader_init();
	glSemaphoreParameterui64vEXT(semaphore, pname, params);
}
static void GLLOADER_APIENTRY self_init_glGetSemaphoreParameterui64vEXT(GLuint semaphore, GLenum pname, GLuint64* params)
{
	glloader_init();
	glGetSemaphoreParameterui64vEXT(semaphore, pname, params);
}
static void GLLOADER_APIENTRY self_init_glWaitSemaphoreEXT(GLuint semaphore, GLuint numBufferBarriers, const GLuint* buffers, GLuint numTextureBarriers, const GLuint* textures, const GLenum* srcLayouts)
{
	glloader_init();
	glWaitSemaphoreEXT(semaphore, numBufferBarriers, buffers, numTextureBarriers, textures, srcLayouts);
}
static void GLLOADER_APIENTRY self_init_glSignalSemaphoreEXT(GLuint semaphore, GLuint numBufferBarriers, const GLuint* buffers, GLuint numTextureBarriers, const GLuint* textures, const GLenum* dstLayouts)
{
	glloader_init();
	glSignalSemaphoreEXT(semaphore, numBufferBarriers, buffers, numTextureBarriers, textures, dstLayouts);
}

glGenSemaphoresEXTFUNC glGenSemaphoresEXT = self_init_glGenSemaphoresEXT;
glDeleteSemaphoresEXTFUNC glDeleteSemaphoresEXT = self_init_glDeleteSemaphoresEXT;
glIsSemaphoreEXTFUNC glIsSemaphoreEXT = self_init_glIsSemaphoreEXT;
glSemaphoreParameterui64vEXTFUNC glSemaphoreParameterui64vEXT = self_init_glSemaphoreParameterui64vEXT;
glGetSemaphoreParameterui64vEXTFUNC glGetSemaphoreParameterui64vEXT = self_init_glGetSemaphoreParameterui64vEXT;
glWaitSemaphoreEXTFUNC glWaitSemaphoreEXT = self_init_glWaitSemaphoreEXT;
glSignalSemaphoreEXTFUNC glSignalSemaphoreEXT = self_init_glSignalSemaphoreEXT;

#endif

static char GLLOADER_APIENTRY _glloader_GLES_EXT_semaphore_fd()
{
	return _GLES_EXT_semaphore_fd;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_semaphore_fd()
{
	glloader_init();
	return glloader_GLES_EXT_semaphore_fd();
}
glloader_GLES_EXT_semaphore_fdFUNC glloader_GLES_EXT_semaphore_fd = self_init_glloader_GLES_EXT_semaphore_fd;

#ifdef GLES_EXT_semaphore_fd

static void GLLOADER_APIENTRY self_init_glImportSemaphoreFdEXT(GLuint semaphore, GLenum handleType, GLint fd)
{
	glloader_init();
	glImportSemaphoreFdEXT(semaphore, handleType, fd);
}

glImportSemaphoreFdEXTFUNC glImportSemaphoreFdEXT = self_init_glImportSemaphoreFdEXT;

#endif

static char GLLOADER_APIENTRY _glloader_GLES_EXT_semaphore_win32()
{
	return _GLES_EXT_semaphore_win32;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_semaphore_win32()
{
	glloader_init();
	return glloader_GLES_EXT_semaphore_win32();
}
glloader_GLES_EXT_semaphore_win32FUNC glloader_GLES_EXT_semaphore_win32 = self_init_glloader_GLES_EXT_semaphore_win32;

#ifdef GLES_EXT_semaphore_win32

static void GLLOADER_APIENTRY self_init_glImportSemaphoreWin32HandleEXT(GLuint semaphore, GLenum handleType, void* handle)
{
	glloader_init();
	glImportSemaphoreWin32HandleEXT(semaphore, handleType, handle);
}
static void GLLOADER_APIENTRY self_init_glImportSemaphoreWin32NameEXT(GLuint semaphore, GLenum handleType, const void* name)
{
	glloader_init();
	glImportSemaphoreWin32NameEXT(semaphore, handleType, name);
}

glImportSemaphoreWin32HandleEXTFUNC glImportSemaphoreWin32HandleEXT = self_init_glImportSemaphoreWin32HandleEXT;
glImportSemaphoreWin32NameEXTFUNC glImportSemaphoreWin32NameEXT = self_init_glImportSemaphoreWin32NameEXT;
...
static char GLLOADER_APIENTRY _glloader_GLES_EXT_shader_group_vote()
{
	return _GLES_EXT_shader_group_vote;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_shader_group_vote()
{
	glloader_init();
	return glloader_GLES_EXT_shader_group_vote();
}
glloader_GLES_EXT_shader_group_voteFUNC glloader_GLES_EXT_shader_group_vote = self_init_glloader_GLES_EXT_shader_group_vote;
...
static char GLLOADER_APIENTRY _glloader_GLES_EXT_shader_non_constant_global_initializers()
{
	return _GLES_EXT_shader_non_constant_global_initializers;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_shader_non_constant_global_initializers()
{
	glloader_init();
	return glloader_GLES_EXT_shader_non_constant_global_initializers();
}
glloader_GLES_EXT_shader_non_constant_global_initializersFUNC glloader_GLES_EXT_shader_non_constant_global_initializers = self_init_glloader_GLES_EXT_shader_non_constant_global_initializers;
...
static char GLLOADER_APIENTRY _glloader_GLES_EXT_shader_pixel_local_storage2()
{
	return _GLES_EXT_shader_pixel_local_storage2;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_shader_pixel_local_storage2()
{
	glloader_init();
	return glloader_GLES_EXT_shader_pixel_local_storage2();
}
glloader_GLES_EXT_shader_pixel_local_storage2FUNC glloader_GLES_EXT_shader_pixel_local_storage2 = self_init_glloader_GLES_EXT_shader_pixel_local_storage2;

#ifdef GLES_EXT_shader_pixel_local_storage2

static void GLLOADER_APIENTRY self_init_glFramebufferPixelLocalStorageSizeEXT(GLuint target, GLsizei size)
{
	glloader_init();
	glFramebufferPixelLocalStorageSizeEXT(target, size);
}
static GLsizei GLLOADER_APIENTRY self_init_glGetFramebufferPixelLocalStorageSizeEXT(GLuint target)
{
	glloader_init();
	return glGetFramebufferPixelLocalStorageSizeEXT(target);
}
static void GLLOADER_APIENTRY self_init_glClearPixelLocalStorageuiEXT(GLsizei offset, GLsizei n, const GLuint* values)
{
	glloader_init();
	glClearPixelLocalStorageuiEXT(offset, n, values);
}

glFramebufferPixelLocalStorageSizeEXTFUNC glFramebufferPixelLocalStorageSizeEXT = self_init_glFramebufferPixelLocalStorageSizeEXT;
glGetFramebufferPixelLocalStorageSizeEXTFUNC glGetFramebufferPixelLocalStorageSizeEXT = self_init_glGetFramebufferPixelLocalStorageSizeEXT;
glClearPixelLocalStorageuiEXTFUNC glClearPixelLocalStorageuiEXT = self_init_glClearPixelLocalStorageuiEXT;
...
static char GLLOADER_APIENTRY _glloader_GLES_EXT_sparse_texture2()
{
	return _GLES_EXT_sparse_texture2;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_sparse_texture2()
{
	glloader_init();
	return glloader_GLES_EXT_sparse_texture2();
}
glloader_GLES_EXT_sparse_texture2FUNC glloader_GLES_EXT_sparse_texture2 = self_init_glloader_GLES_EXT_sparse_texture2;
...
static char GLLOADER_APIENTRY _glloader_GLES_EXT_texture_compression_astc_decode_mode()
{
	return _GLES_EXT_texture_compression_astc_decode_mode;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_texture_compression_astc_decode_mode()
{
	glloader_init();
	return glloader_GLES_EXT_texture_compression_astc_decode_mode();
}
glloader_GLES_EXT_texture_compression_astc_decode_modeFUNC glloader_GLES_EXT_texture_compression_astc_decode_mode = self_init_glloader_GLES_EXT_texture_compression_astc_decode_mode;

static char GLLOADER_APIENTRY _glloader_GLES_EXT_texture_compression_bptc()
{
	return _GLES_EXT_texture_compression_bptc;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_texture_compression_bptc()
{
	glloader_init();
	return glloader_GLES_EXT_texture_compression_bptc();
}
glloader_GLES_EXT_texture_compression_bptcFUNC glloader_GLES_EXT_texture_compression_bptc = self_init_glloader_GLES_EXT_texture_compression_bptc;
...
static char GLLOADER_APIENTRY _glloader_GLES_EXT_texture_compression_rgtc()
{
	return _GLES_EXT_texture_compression_rgtc;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_texture_compression_rgtc()
{
	glloader_init();
	return glloader_GLES_EXT_texture_compression_rgtc();
}
glloader_GLES_EXT_texture_compression_rgtcFUNC glloader_GLES_EXT_texture_compression_rgtc = self_init_glloader_GLES_EXT_texture_compression_rgtc;
...
static char GLLOADER_APIENTRY _glloader_GLES_EXT_win32_keyed_mutex()
{
	return _GLES_EXT_win32_keyed_mutex;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_win32_keyed_mutex()
{
	glloader_init();
	return glloader_GLES_EXT_win32_keyed_mutex();
}
glloader_GLES_EXT_win32_keyed_mutexFUNC glloader_GLES_EXT_win32_keyed_mutex = self_init_glloader_GLES_EXT_win32_keyed_mutex;

#ifdef GLES_EXT_win32_keyed_mutex

static GLboolean GLLOADER_APIENTRY self_init_glAcquireKeyedMutexWin32EXT(GLuint memory, GLuint64 key, GLuint timeout)
{
	glloader_init();
	return glAcquireKeyedMutexWin32EXT(memory, key, timeout);
}
static GLboolean GLLOADER_APIENTRY self_init_glReleaseKeyedMutexWin32EXT(GLuint memory, GLuint64 key)
{
	glloader_init();
	return glReleaseKeyedMutexWin32EXT(memory, key);
}

glAcquireKeyedMutexWin32EXTFUNC glAcquireKeyedMutexWin32EXT = self_init_glAcquireKeyedMutexWin32EXT;
glReleaseKeyedMutexWin32EXTFUNC glReleaseKeyedMutexWin32EXT = self_init_glReleaseKeyedMutexWin32EXT;

#endif

static char GLLOADER_APIENTRY _glloader_GLES_EXT_window_rectangles()
{
	return _GLES_EXT_window_rectangles;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_EXT_window_rectangles()
{
	glloader_init();
	return glloader_GLES_EXT_window_rectangles();
}
glloader_GLES_EXT_window_rectanglesFUNC glloader_GLES_EXT_window_rectangles = self_init_glloader_GLES_EXT_window_rectangles;

#ifdef GLES_EXT_window_rectangles

static void GLLOADER_APIENTRY self_init_glWindowRectanglesEXT(GLenum mode, GLsizei count, const GLint* box)
{
	glloader_init();
	glWindowRectanglesEXT(mode, count, box);
}

glWindowRectanglesEXTFUNC glWindowRectanglesEXT = self_init_glWindowRectanglesEXT;
...
static char GLLOADER_APIENTRY _glloader_GLES_IMG_bindless_texture()
{
	return _GLES_IMG_bindless_texture;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_IMG_bindless_texture()
{
	glloader_init();
	return glloader_GLES_IMG_bindless_texture();
}
glloader_GLES_IMG_bindless_textureFUNC glloader_GLES_IMG_bindless_texture = self_init_glloader_GLES_IMG_bindless_texture;

#ifdef GLES_IMG_bindless_texture

static GLuint64 GLLOADER_APIENTRY self_init_glGetTextureHandleIMG(GLuint texture)
{
	glloader_init();
	return glGetTextureHandleIMG(texture);
}
static GLuint64 GLLOADER_APIENTRY self_init_glGetTextureSamplerHandleIMG(GLuint texture, GLuint sampler)
{
	glloader_init();
	return glGetTextureSamplerHandleIMG(texture, sampler);
}
static void GLLOADER_APIENTRY self_init_glUniformHandleui64IMG(GLint location, GLuint64 value)
{
	glloader_init();
	glUniformHandleui64IMG(location, value);
}
static void GLLOADER_APIENTRY self_init_glUniformHandleui64vIMG(GLint location, GLsizei count, const GLuint64* value)
{
	glloader_init();
	glUniformHandleui64vIMG(location, count, value);
}
static void GLLOADER_APIENTRY self_init_glProgramUniformHandleui64IMG(GLuint program, GLint location, GLuint64 value)
{
	glloader_init();
	glProgramUniformHandleui64IMG(program, location, value);
}
static void GLLOADER_APIENTRY self_init_glProgramUniformHandleui64vIMG(GLuint program, GLint location, GLsizei count, const GLuint64* values)
{
	glloader_init();
	glProgramUniformHandleui64vIMG(program, location, count, values);
}

glGetTextureHandleIMGFUNC glGetTextureHandleIMG = self_init_glGetTextureHandleIMG;
glGetTextureSamplerHandleIMGFUNC glGetTextureSamplerHandleIMG = self_init_glGetTextureSamplerHandleIMG;
glUniformHandleui64IMGFUNC glUniformHandleui64IMG = self_init_glUniformHandleui64IMG;
glUniformHandleui64vIMGFUNC glUniformHandleui64vIMG = self_init_glUniformHandleui64vIMG;
glProgramUniformHandleui64IMGFUNC glProgramUniformHandleui64IMG = self_init_glProgramUniformHandleui64IMG;
glProgramUniformHandleui64vIMGFUNC glProgramUniformHandleui64vIMG = self_init_glProgramUniformHandleui64vIMG;

#endif

static char GLLOADER_APIENTRY _glloader_GLES_IMG_framebuffer_downsample()
{
	return _GLES_IMG_framebuffer_downsample;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_IMG_framebuffer_downsample()
{
	glloader_init();
	return glloader_GLES_IMG_framebuffer_downsample();
}
glloader_GLES_IMG_framebuffer_downsampleFUNC glloader_GLES_IMG_framebuffer_downsample = self_init_glloader_GLES_IMG_framebuffer_downsample;

#ifdef GLES_IMG_framebuffer_downsample

static void GLLOADER_APIENTRY self_init_glFramebufferTexture2DDownsampleIMG(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLint xscale, GLint yscale)
{
	glloader_init();
	glFramebufferTexture2DDownsampleIMG(target, attachment, textarget, texture, level, xscale, yscale);
}
static GLsizei GLLOADER_APIENTRY self_init_glFramebufferTextureLayerDownsampleIMG(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer, GLint xscale, GLint yscale)
{
	glloader_init();
	return glFramebufferTextureLayerDownsampleIMG(target, attachment, texture, level, layer, xscale, yscale);
}

glFramebufferTexture2DDownsampleIMGFUNC glFramebufferTexture2DDownsampleIMG = self_init_glFramebufferTexture2DDownsampleIMG;
glFramebufferTextureLayerDownsampleIMGFUNC glFramebufferTextureLayerDownsampleIMG = self_init_glFramebufferTextureLayerDownsampleIMG;
...
static char GLLOADER_APIENTRY _glloader_GLES_IMG_texture_filter_cubic()
{
	return _GLES_IMG_texture_filter_cubic;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_IMG_texture_filter_cubic()
{
	glloader_init();
	return glloader_GLES_IMG_texture_filter_cubic();
}
glloader_GLES_IMG_texture_filter_cubicFUNC glloader_GLES_IMG_texture_filter_cubic = self_init_glloader_GLES_IMG_texture_filter_cubic;
...
static char GLLOADER_APIENTRY _glloader_GLES_INTEL_conservative_rasterization()
{
	return _GLES_INTEL_conservative_rasterization;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_INTEL_conservative_rasterization()
{
	glloader_init();
	return glloader_GLES_INTEL_conservative_rasterization();
}
glloader_GLES_INTEL_conservative_rasterizationFUNC glloader_GLES_INTEL_conservative_rasterization = self_init_glloader_GLES_INTEL_conservative_rasterization;

static char GLLOADER_APIENTRY _glloader_GLES_INTEL_framebuffer_CMAA()
{
	return _GLES_INTEL_framebuffer_CMAA;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_INTEL_framebuffer_CMAA()
{
	glloader_init();
	return glloader_GLES_INTEL_framebuffer_CMAA();
}
glloader_GLES_INTEL_framebuffer_CMAAFUNC glloader_GLES_INTEL_framebuffer_CMAA = self_init_glloader_GLES_INTEL_framebuffer_CMAA;

#ifdef GLES_INTEL_framebuffer_CMAA

static void GLLOADER_APIENTRY self_init_glApplyFramebufferAttachmentCMAAINTEL()
{
	glloader_init();
	glApplyFramebufferAttachmentCMAAINTEL();
}

glApplyFramebufferAttachmentCMAAINTELFUNC glApplyFramebufferAttachmentCMAAINTEL = self_init_glApplyFramebufferAttachmentCMAAINTEL;
...
static void GLLOADER_APIENTRY self_init_glDebugMessageControlKHR(GLenum source, GLenum type, GLenum severity, GLsizei count, const GLuint* ids, GLboolean enabled)
{
	glloader_init();
	glDebugMessageControlKHR(source, type, severity, count, ids, enabled);
}
static void GLLOADER_APIENTRY self_init_glDebugMessageInsertKHR(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar* buf)
{
	glloader_init();
	glDebugMessageInsertKHR(source, type, id, severity, length, buf);
}
static void GLLOADER_APIENTRY self_init_glDebugMessageCallbackKHR(GLDEBUGPROC callback, const GLvoid* userParam)
{
	glloader_init();
	glDebugMessageCallbackKHR(callback, userParam);
}
static GLuint GLLOADER_APIENTRY self_init_glGetDebugMessageLogKHR(GLuint count, GLsizei bufsize, GLenum* sources, GLenum* types, GLuint* ids, GLenum* severities, GLsizei* lengths, GLchar* messageLog)
{
	glloader_init();
	return glGetDebugMessageLogKHR(count, bufsize, sources, types, ids, severities, lengths, messageLog);
}
static void GLLOADER_APIENTRY self_init_glGetPointervKHR(GLenum pname, void** params)
{
	glloader_init();
	glGetPointervKHR(pname, params);
}
static void GLLOADER_APIENTRY self_init_glPushDebugGroupKHR(GLenum source, GLuint id, GLsizei length, const GLchar* message)
{
	glloader_init();
	glPushDebugGroupKHR(source, id, length, message);
}
static void GLLOADER_APIENTRY self_init_glPopDebugGroupKHR()
{
	glloader_init();
	glPopDebugGroupKHR();
}
static void GLLOADER_APIENTRY self_init_glObjectLabelKHR(GLenum identifier, GLuint name, GLsizei length, const GLchar* label)
{
	glloader_init();
	glObjectLabelKHR(identifier, name, length, label);
}
static void GLLOADER_APIENTRY self_init_glGetObjectLabelKHR(GLenum identifier, GLuint name, GLsizei bufSize, GLsizei* length, GLchar* label)
{
	glloader_init();
	glGetObjectLabelKHR(identifier, name, bufSize, length, label);
}
static void GLLOADER_APIENTRY self_init_glObjectPtrLabelKHR(const GLvoid* ptr, GLsizei length, const GLchar* label)
{
	glloader_init();
	glObjectPtrLabelKHR(ptr, length, label);
}
static void GLLOADER_APIENTRY self_init_glGetObjectPtrLabelKHR(const GLvoid* ptr, GLsizei bufSize, GLsizei* length, GLchar* label)
{
	glloader_init();
	glGetObjectPtrLabelKHR(ptr, bufSize, length, label);
}

glDebugMessageControlKHRFUNC glDebugMessageControlKHR = self_init_glDebugMessageControlKHR;
glDebugMessageInsertKHRFUNC glDebugMessageInsertKHR = self_init_glDebugMessageInsertKHR;
glDebugMessageCallbackKHRFUNC glDebugMessageCallbackKHR = self_init_glDebugMessageCallbackKHR;
glGetDebugMessageLogKHRFUNC glGetDebugMessageLogKHR = self_init_glGetDebugMessageLogKHR;
glGetPointervKHRFUNC glGetPointervKHR = self_init_glGetPointervKHR;
glPushDebugGroupKHRFUNC glPushDebugGroupKHR = self_init_glPushDebugGroupKHR;
glPopDebugGroupKHRFUNC glPopDebugGroupKHR = self_init_glPopDebugGroupKHR;
glObjectLabelKHRFUNC glObjectLabelKHR = self_init_glObjectLabelKHR;
glGetObjectLabelKHRFUNC glGetObjectLabelKHR = self_init_glGetObjectLabelKHR;
glObjectPtrLabelKHRFUNC glObjectPtrLabelKHR = self_init_glObjectPtrLabelKHR;
glGetObjectPtrLabelKHRFUNC glGetObjectPtrLabelKHR = self_init_glGetObjectPtrLabelKHR;
...
static char GLLOADER_APIENTRY _glloader_GLES_KHR_parallel_shader_compile()
{
	return _GLES_KHR_parallel_shader_compile;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_KHR_parallel_shader_compile()
{
	glloader_init();
	return glloader_GLES_KHR_parallel_shader_compile();
}
glloader_GLES_KHR_parallel_shader_compileFUNC glloader_GLES_KHR_parallel_shader_compile = self_init_glloader_GLES_KHR_parallel_shader_compile;

#ifdef GLES_KHR_parallel_shader_compile

static void GLLOADER_APIENTRY self_init_glMaxShaderCompilerThreadsKHR(GLuint count)
{
	glloader_init();
	glMaxShaderCompilerThreadsKHR(count);
}

glMaxShaderCompilerThreadsKHRFUNC glMaxShaderCompilerThreadsKHR = self_init_glMaxShaderCompilerThreadsKHR;
...
static GLenum GLLOADER_APIENTRY self_init_glGetGraphicsResetStatusKHR()
{
	glloader_init();
	return glGetGraphicsResetStatusKHR();
}
static void GLLOADER_APIENTRY self_init_glReadnPixelsKHR(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLsizei bufSize, GLvoid* data)
{
	glloader_init();
	glReadnPixelsKHR(x, y, width, height, format, type, bufSize, data);
}
static void GLLOADER_APIENTRY self_init_glGetnUniformfvKHR(GLuint program, GLint location, GLsizei bufSize, GLfloat* params)
{
	glloader_init();
	glGetnUniformfvKHR(program, location, bufSize, params);
}
static void GLLOADER_APIENTRY self_init_glGetnUniformivKHR(GLuint program, GLint location, GLsizei bufSize, GLint* params)
{
	glloader_init();
	glGetnUniformivKHR(program, location, bufSize, params);
}
static void GLLOADER_APIENTRY self_init_glGetnUniformuivKHR(GLuint program, GLint location, GLsizei bufSize, GLuint* params)
{
	glloader_init();
	glGetnUniformuivKHR(program, location, bufSize, params);
}

glGetGraphicsResetStatusKHRFUNC glGetGraphicsResetStatusKHR = self_init_glGetGraphicsResetStatusKHR;
glReadnPixelsKHRFUNC glReadnPixelsKHR = self_init_glReadnPixelsKHR;
glGetnUniformfvKHRFUNC glGetnUniformfvKHR = self_init_glGetnUniformfvKHR;
glGetnUniformivKHRFUNC glGetnUniformivKHR = self_init_glGetnUniformivKHR;
glGetnUniformuivKHRFUNC glGetnUniformuivKHR = self_init_glGetnUniformuivKHR;
...
static char GLLOADER_APIENTRY _glloader_GLES_KHR_texture_compression_astc_sliced_3d()
{
	return _GLES_KHR_texture_compression_astc_sliced_3d;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_KHR_texture_compression_astc_sliced_3d()
{
	glloader_init();
	return glloader_GLES_KHR_texture_compression_astc_sliced_3d();
}
glloader_GLES_KHR_texture_compression_astc_sliced_3dFUNC glloader_GLES_KHR_texture_compression_astc_sliced_3d = self_init_glloader_GLES_KHR_texture_compression_astc_sliced_3d;

static char GLLOADER_APIENTRY _glloader_GLES_NVX_blend_equation_advanced_multi_draw_buffers()
{
	return _GLES_NVX_blend_equation_advanced_multi_draw_buffers;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_NVX_blend_equation_advanced_multi_draw_buffers()
{
	glloader_init();
	return glloader_GLES_NVX_blend_equation_advanced_multi_draw_buffers();
}
glloader_GLES_NVX_blend_equation_advanced_multi_draw_buffersFUNC glloader_GLES_NVX_blend_equation_advanced_multi_draw_buffers = self_init_glloader_GLES_NVX_blend_equation_advanced_multi_draw_buffers;
...
static char GLLOADER_APIENTRY _glloader_GLES_NV_blend_minmax_factor()
{
	return _GLES_NV_blend_minmax_factor;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_NV_blend_minmax_factor()
{
	glloader_init();
	return glloader_GLES_NV_blend_minmax_factor();
}
glloader_GLES_NV_blend_minmax_factorFUNC glloader_GLES_NV_blend_minmax_factor = self_init_glloader_GLES_NV_blend_minmax_factor;
...
static char GLLOADER_APIENTRY _glloader_GLES_NV_conservative_raster_pre_snap_triangles()
{
	return _GLES_NV_conservative_raster_pre_snap_triangles;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_NV_conservative_raster_pre_snap_triangles()
{
	glloader_init();
	return glloader_GLES_NV_conservative_raster_pre_snap_triangles();
}
glloader_GLES_NV_conservative_raster_pre_snap_trianglesFUNC glloader_GLES_NV_conservative_raster_pre_snap_triangles = self_init_glloader_GLES_NV_conservative_raster_pre_snap_triangles;

#ifdef GLES_NV_conservative_raster_pre_snap_triangles

static void GLLOADER_APIENTRY self_init_glConservativeRasterParameteriNV(GLenum pname, GLint param)
{
	glloader_init();
	glConservativeRasterParameteriNV(pname, param);
}

glConservativeRasterParameteriNVFUNC glConservativeRasterParameteriNV = self_init_glConservativeRasterParameteriNV;
...
static char GLLOADER_APIENTRY _glloader_GLES_NV_draw_vulkan_image()
{
	return _GLES_NV_draw_vulkan_image;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_NV_draw_vulkan_image()
{
	glloader_init();
	return glloader_GLES_NV_draw_vulkan_image();
}
glloader_GLES_NV_draw_vulkan_imageFUNC glloader_GLES_NV_draw_vulkan_image = self_init_glloader_GLES_NV_draw_vulkan_image;

#ifdef GLES_NV_draw_vulkan_image

static void GLLOADER_APIENTRY self_init_glDrawVkImageNV(GLuint64 vkImage, GLuint sampler, GLfloat x0, GLfloat y0, GLfloat x1, GLfloat y1, GLfloat z, GLfloat s0, GLfloat t0, GLfloat s1, GLfloat t1)
{
	glloader_init();
	glDrawVkImageNV(vkImage, sampler, x0, y0, x1, y1, z, s0, t0, s1, t1);
}
static VULKANPROCNV GLLOADER_APIENTRY self_init_glGetVkProcAddrNV(const GLchar* name)
{
	glloader_init();
	return glGetVkProcAddrNV(name);
}
static void GLLOADER_APIENTRY self_init_glWaitVkSemaphoreNV(GLuint64 vkSemaphore)
{
	glloader_init();
	glWaitVkSemaphoreNV(vkSemaphore);
}
static void GLLOADER_APIENTRY self_init_glSignalVkSemaphoreNV(GLuint64 vkSemaphore)
{
	glloader_init();
	glSignalVkSemaphoreNV(vkSemaphore);
}
static void GLLOADER_APIENTRY self_init_glSignalVkFenceNV(GLuint64 vkFence)
{
	glloader_init();
	glSignalVkFenceNV(vkFence);
}

glDrawVkImageNVFUNC glDrawVkImageNV = self_init_glDrawVkImageNV;
glGetVkProcAddrNVFUNC glGetVkProcAddrNV = self_init_glGetVkProcAddrNV;
glWaitVkSemaphoreNVFUNC glWaitVkSemaphoreNV = self_init_glWaitVkSemaphoreNV;
glSignalVkSemaphoreNVFUNC glSignalVkSemaphoreNV = self_init_glSignalVkSemaphoreNV;
glSignalVkFenceNVFUNC glSignalVkFenceNV = self_init_glSignalVkFenceNV;
...
static char GLLOADER_APIENTRY _glloader_GLES_NV_gpu_shader5()
{
	return _GLES_NV_gpu_shader5;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_NV_gpu_shader5()
{
	glloader_init();
	return glloader_GLES_NV_gpu_shader5();
}
glloader_GLES_NV_gpu_shader5FUNC glloader_GLES_NV_gpu_shader5 = self_init_glloader_GLES_NV_gpu_shader5;

#ifdef GLES_NV_gpu_shader5

static void GLLOADER_APIENTRY self_init_glUniform1i64NV(GLint location, GLint64 x)
{
	glloader_init();
	glUniform1i64NV(location, x);
}
static void GLLOADER_APIENTRY self_init_glUniform2i64NV(GLint location, GLint64 x, GLint64 y)
{
	glloader_init();
	glUniform2i64NV(location, x, y);
}
static void GLLOADER_APIENTRY self_init_glUniform3i64NV(GLint location, GLint64 x, GLint64 y, GLint64 z)
{
	glloader_init();
	glUniform3i64NV(location, x, y, z);
}
static void GLLOADER_APIENTRY self_init_glUniform4i64NV(GLint location, GLint64 x, GLint64 y, GLint64 z, GLint64 w)
{
	glloader_init();
	glUniform4i64NV(location, x, y, z, w);
}
static void GLLOADER_APIENTRY self_init_glUniform1i64vNV(GLint location, GLsizei count, const GLint64* value)
{
	glloader_init();
	glUniform1i64vNV(location, count, value);
}
static void GLLOADER_APIENTRY self_init_glUniform2i64vNV(GLint location, GLsizei count, const GLint64* value)
{
	glloader_init();
	glUniform2i64vNV(location, count, value);
}
static void GLLOADER_APIENTRY self_init_glUniform3i64vNV(GLint location, GLsizei count, const GLint64* value)
{
	glloader_init();
	glUniform3i64vNV(location, count, value);
}
static void GLLOADER_APIENTRY self_init_glUniform4i64vNV(GLint location, GLsizei count, const GLint64* value)
{
	glloader_init();
	glUniform4i64vNV(location, count, value);
}
static void GLLOADER_APIENTRY self_init_glUniform1ui64NV(GLint location, GLuint64 x)
{
	glloader_init();
	glUniform1ui64NV(location, x);
}
static void GLLOADER_APIENTRY self_init_glUniform2ui64NV(GLint location, GLuint64 x, GLuint64 y)
{
	glloader_init();
	glUniform2ui64NV(location, x, y);
}
static void GLLOADER_APIENTRY self_init_glUniform3ui64NV(GLint location, GLuint64 x, GLuint64 y, GLuint64 z)
{
	glloader_init();
	glUniform3ui64NV(location, x, y, z);
}
static void GLLOADER_APIENTRY self_init_glUniform4ui64NV(GLint location, GLuint64 x, GLuint64 y, GLuint64 z, GLuint64 w)
{
	glloader_init();
	glUniform4ui64NV(location, x, y, z, w);
}
static void GLLOADER_APIENTRY self_init_glUniform1ui64vNV(GLint location, GLsizei count, const GLuint64* value)
{
	glloader_init();
	glUniform1ui64vNV(location, count, value);
}
static void GLLOADER_APIENTRY self_init_glUniform2ui64vNV(GLint location, GLsizei count, const GLuint64* value)
{
	glloader_init();
	glUniform2ui64vNV(location, count, value);
}
static void GLLOADER_APIENTRY self_init_glUniform3ui64vNV(GLint location, GLsizei count, const GLuint64* value)
{
	glloader_init();
	glUniform3ui64vNV(location, count, value);
}
static void GLLOADER_APIENTRY self_init_glUniform4ui64vNV(GLint location, GLsizei count, const GLuint64* value)
{
	glloader_init();
	glUniform4ui64vNV(location, count, value);
}
static void GLLOADER_APIENTRY self_init_glGetUniformi64vNV(GLuint program, GLint location, GLint64* params)
{
	glloader_init();
	glGetUniformi64vNV(program, location, params);
}
static void GLLOADER_APIENTRY self_init_glProgramUniform1i64NV(GLuint program, GLint location, GLint64 x)
{
	glloader_init();
	glProgramUniform1i64NV(program, location, x);
}
static void GLLOADER_APIENTRY self_init_glProgramUniform2i64NV(GLuint program, GLint location, GLint64 x, GLint64 y)
{
	glloader_init();
	glProgramUniform2i64NV(program, location, x, y);
}
static void GLLOADER_APIENTRY self_init_glProgramUniform3i64NV(GLuint program, GLint location, GLint64 x, GLint64 y, GLint64 z)
{
	glloader_init();
	glProgramUniform3i64NV(program, location, x, y, z);
}
static void GLLOADER_APIENTRY self_init_glProgramUniform4i64NV(GLuint program, GLint location, GLint64 x, GLint64 y, GLint64 z, GLint64 w)
{
	glloader_init();
	glProgramUniform4i64NV(program, location, x, y, z, w);
}
static void GLLOADER_APIENTRY self_init_glProgramUniform1i64vNV(GLuint program, GLint location, GLsizei count, const GLint64* value)
{
	glloader_init();
	glProgramUniform1i64vNV(program, location, count, value);
}
static void GLLOADER_APIENTRY self_init_glProgramUniform2i64vNV(GLuint program, GLint location, GLsizei count, const GLint64* value)
{
	glloader_init();
	glProgramUniform2i64vNV(program, location, count, value);
}
static void GLLOADER_APIENTRY self_init_glProgramUniform3i64vNV(GLuint program, GLint location, GLsizei count, const GLint64* value)
{
	glloader_init();
	glProgramUniform3i64vNV(program, location, count, value);
}
static void GLLOADER_APIENTRY self_init_glProgramUniform4i64vNV(GLuint program, GLint location, GLsizei count, const GLint64* value)
{
	glloader_init();
	glProgramUniform4i64vNV(program, location, count, value);
}
static void GLLOADER_APIENTRY self_init_glProgramUniform1ui64NV(GLuint program, GLint location, GLuint64 x)
{
	glloader_init();
	glProgramUniform1ui64NV(program, location, x);
}
static void GLLOADER_APIENTRY self_init_glProgramUniform2ui64NV(GLuint program, GLint location, GLuint64 x, GLuint64 y)
{
	glloader_init();
	glProgramUniform2ui64NV(program, location, x, y);
}
static void GLLOADER_APIENTRY self_init_glProgramUniform3ui64NV(GLuint program, GLint location, GLuint64 x, GLuint64 y, GLuint64 z)
{
	glloader_init();
	glProgramUniform3ui64NV(program, location, x, y, z);
}
static void GLLOADER_APIENTRY self_init_glProgramUniform4ui64NV(GLuint program, GLint location, GLuint64 x, GLuint64 y, GLuint64 z, GLuint64 w)
{
	glloader_init();
	glProgramUniform4ui64NV(program, location, x, y, z, w);
}
static void GLLOADER_APIENTRY self_init_glProgramUniform1ui64vNV(GLuint program, GLint location, GLsizei count, const GLuint64* value)
{
	glloader_init();
	glProgramUniform1ui64vNV(program, location, count, value);
}
static void GLLOADER_APIENTRY self_init_glProgramUniform2ui64vNV(GLuint program, GLint location, GLsizei count, const GLuint64* value)
{
	glloader_init();
	glProgramUniform2ui64vNV(program, location, count, value);
}
static void GLLOADER_APIENTRY self_init_glProgramUniform3ui64vNV(GLuint program, GLint location, GLsizei count, const GLuint64* value)
{
	glloader_init();
	glProgramUniform3ui64vNV(program, location, count, value);
}
static void GLLOADER_APIENTRY self_init_glProgramUniform4ui64vNV(GLuint program, GLint location, GLsizei count, const GLuint64* value)
{
	glloader_init();
	glProgramUniform4ui64vNV(program, location, count, value);
}

glUniform1i64NVFUNC glUniform1i64NV = self_init_glUniform1i64NV;
glUniform2i64NVFUNC glUniform2i64NV = self_init_glUniform2i64NV;
glUniform3i64NVFUNC glUniform3i64NV = self_init_glUniform3i64NV;
glUniform4i64NVFUNC glUniform4i64NV = self_init_glUniform4i64NV;
glUniform1i64vNVFUNC glUniform1i64vNV = self_init_glUniform1i64vNV;
glUniform2i64vNVFUNC glUniform2i64vNV = self_init_glUniform2i64vNV;
glUniform3i64vNVFUNC glUniform3i64vNV = self_init_glUniform3i64vNV;
glUniform4i64vNVFUNC glUniform4i64vNV = self_init_glUniform4i64vNV;
glUniform1ui64NVFUNC glUniform1ui64NV = self_init_glUniform1ui64NV;
glUniform2ui64NVFUNC glUniform2ui64NV = self_init_glUniform2ui64NV;
glUniform3ui64NVFUNC glUniform3ui64NV = self_init_glUniform3ui64NV;
glUniform4ui64NVFUNC glUniform4ui64NV = self_init_glUniform4ui64NV;
glUniform1ui64vNVFUNC glUniform1ui64vNV = self_init_glUniform1ui64vNV;
glUniform2ui64vNVFUNC glUniform2ui64vNV = self_init_glUniform2ui64vNV;
glUniform3ui64vNVFUNC glUniform3ui64vNV = self_init_glUniform3ui64vNV;
glUniform4ui64vNVFUNC glUniform4ui64vNV = self_init_glUniform4ui64vNV;
glGetUniformi64vNVFUNC glGetUniformi64vNV = self_init_glGetUniformi64vNV;
glProgramUniform1i64NVFUNC glProgramUniform1i64NV = self_init_glProgramUniform1i64NV;
glProgramUniform2i64NVFUNC glProgramUniform2i64NV = self_init_glProgramUniform2i64NV;
glProgramUniform3i64NVFUNC glProgramUniform3i64NV = self_init_glProgramUniform3i64NV;
glProgramUniform4i64NVFUNC glProgramUniform4i64NV = self_init_glProgramUniform4i64NV;
glProgramUniform1i64vNVFUNC glProgramUniform1i64vNV = self_init_glProgramUniform1i64vNV;
glProgramUniform2i64vNVFUNC glProgramUniform2i64vNV = self_init_glProgramUniform2i64vNV;
glProgramUniform3i64vNVFUNC glProgramUniform3i64vNV = self_init_glProgramUniform3i64vNV;
glProgramUniform4i64vNVFUNC glProgramUniform4i64vNV = self_init_glProgramUniform4i64vNV;
glProgramUniform1ui64NVFUNC glProgramUniform1ui64NV = self_init_glProgramUniform1ui64NV;
glProgramUniform2ui64NVFUNC glProgramUniform2ui64NV = self_init_glProgramUniform2ui64NV;
glProgramUniform3ui64NVFUNC glProgramUniform3ui64NV = self_init_glProgramUniform3ui64NV;
glProgramUniform4ui64NVFUNC glProgramUniform4ui64NV = self_init_glProgramUniform4ui64NV;
glProgramUniform1ui64vNVFUNC glProgramUniform1ui64vNV = self_init_glProgramUniform1ui64vNV;
glProgramUniform2ui64vNVFUNC glProgramUniform2ui64vNV = self_init_glProgramUniform2ui64vNV;
glProgramUniform3ui64vNVFUNC glProgramUniform3ui64vNV = self_init_glProgramUniform3ui64vNV;
glProgramUniform4ui64vNVFUNC glProgramUniform4ui64vNV = self_init_glProgramUniform4ui64vNV;
...
static char GLLOADER_APIENTRY _glloader_GLES_NV_shader_atomic_fp16_vector()
{
	return _GLES_NV_shader_atomic_fp16_vector;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_NV_shader_atomic_fp16_vector()
{
	glloader_init();
	return glloader_GLES_NV_shader_atomic_fp16_vector();
}
glloader_GLES_NV_shader_atomic_fp16_vectorFUNC glloader_GLES_NV_shader_atomic_fp16_vector = self_init_glloader_GLES_NV_shader_atomic_fp16_vector;
...
static char GLLOADER_APIENTRY _glloader_GLES_NV_texture_barrier()
{
	return _GLES_NV_texture_barrier;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_NV_texture_barrier()
{
	glloader_init();
	return glloader_GLES_NV_texture_barrier();
}
glloader_GLES_NV_texture_barrierFUNC glloader_GLES_NV_texture_barrier = self_init_glloader_GLES_NV_texture_barrier;

#ifdef GLES_NV_texture_barrier

static void GLLOADER_APIENTRY self_init_glTextureBarrierNV()
{
	glloader_init();
	glTextureBarrierNV();
}

glTextureBarrierNVFUNC glTextureBarrierNV = self_init_glTextureBarrierNV;
...
static char GLLOADER_APIENTRY _glloader_GLES_NV_viewport_swizzle()
{
	return _GLES_NV_viewport_swizzle;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_NV_viewport_swizzle()
{
	glloader_init();
	return glloader_GLES_NV_viewport_swizzle();
}
glloader_GLES_NV_viewport_swizzleFUNC glloader_GLES_NV_viewport_swizzle = self_init_glloader_GLES_NV_viewport_swizzle;

#ifdef GLES_NV_viewport_swizzle

static void GLLOADER_APIENTRY self_init_glViewportSwizzleNV(GLuint index, GLenum swizzlex, GLenum swizzley, GLenum swizzlez, GLenum swizzlew)
{
	glloader_init();
	glViewportSwizzleNV(index, swizzlex, swizzley, swizzlez, swizzlew);
}

glViewportSwizzleNVFUNC glViewportSwizzleNV = self_init_glViewportSwizzleNV;
...
static char GLLOADER_APIENTRY _glloader_GLES_OES_sample_shading()
{
	return _GLES_OES_sample_shading;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_OES_sample_shading()
{
	glloader_init();
	return glloader_GLES_OES_sample_shading();
}
glloader_GLES_OES_sample_shadingFUNC glloader_GLES_OES_sample_shading = self_init_glloader_GLES_OES_sample_shading;

#ifdef GLES_OES_sample_shading
...
static char GLLOADER_APIENTRY _glloader_GLES_OES_sample_variables()
{
	return _GLES_OES_sample_variables;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_OES_sample_variables()
{
	glloader_init();
	return glloader_GLES_OES_sample_variables();
}
glloader_GLES_OES_sample_variablesFUNC glloader_GLES_OES_sample_variables = self_init_glloader_GLES_OES_sample_variables;
...
static char GLLOADER_APIENTRY _glloader_GLES_OES_shader_image_atomic()
{
	return _GLES_OES_shader_image_atomic;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_OES_shader_image_atomic()
{
	glloader_init();
	return glloader_GLES_OES_shader_image_atomic();
}
glloader_GLES_OES_shader_image_atomicFUNC glloader_GLES_OES_shader_image_atomic = self_init_glloader_GLES_OES_shader_image_atomic;
...
static char GLLOADER_APIENTRY _glloader_GLES_OES_shader_multisample_interpolation()
{
	return _GLES_OES_shader_multisample_interpolation;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_OES_shader_multisample_interpolation()
{
	glloader_init();
	return glloader_GLES_OES_shader_multisample_interpolation();
}
glloader_GLES_OES_shader_multisample_interpolationFUNC glloader_GLES_OES_shader_multisample_interpolation = self_init_glloader_GLES_OES_shader_multisample_interpolation;
...
static char GLLOADER_APIENTRY _glloader_GLES_OES_texture_stencil8()
{
	return _GLES_OES_texture_stencil8;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_OES_texture_stencil8()
{
	glloader_init();
	return glloader_GLES_OES_texture_stencil8();
}
glloader_GLES_OES_texture_stencil8FUNC glloader_GLES_OES_texture_stencil8 = self_init_glloader_GLES_OES_texture_stencil8;

static char GLLOADER_APIENTRY _glloader_GLES_OES_texture_storage_multisample_2d_array()
{
	return _GLES_OES_texture_storage_multisample_2d_array;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_OES_texture_storage_multisample_2d_array()
{
	glloader_init();
	return glloader_GLES_OES_texture_storage_multisample_2d_array();
}
glloader_GLES_OES_texture_storage_multisample_2d_arrayFUNC glloader_GLES_OES_texture_storage_multisample_2d_array = self_init_glloader_GLES_OES_texture_storage_multisample_2d_array;

#ifdef GLES_OES_texture_storage_multisample_2d_array

static void GLLOADER_APIENTRY self_init_glTexStorage3DMultisampleOES(GLenum target, GLsizei samples, GLint sizedinternalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations)
{
	glloader_init();
	glTexStorage3DMultisampleOES(target, samples, sizedinternalformat, width, height, depth, fixedsamplelocations);
}

glTexStorage3DMultisampleOESFUNC glTexStorage3DMultisampleOES = self_init_glTexStorage3DMultisampleOES;
...
static char GLLOADER_APIENTRY _glloader_GLES_OES_viewport_array()
{
	return _GLES_OES_viewport_array;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_OES_viewport_array()
{
	glloader_init();
	return glloader_GLES_OES_viewport_array();
}
glloader_GLES_OES_viewport_arrayFUNC glloader_GLES_OES_viewport_array = self_init_glloader_GLES_OES_viewport_array;

#ifdef GLES_OES_viewport_array

static void GLLOADER_APIENTRY self_init_glViewportArrayvOES(GLuint first, GLsizei count, const GLfloat* v)
{
	glloader_init();
	glViewportArrayvOES(first, count, v);
}
static void GLLOADER_APIENTRY self_init_glViewportIndexedfOES(GLuint index, GLfloat x, GLfloat y, GLfloat w, GLfloat h)
{
	glloader_init();
	glViewportIndexedfOES(index, x, y, w, h);
}
static void GLLOADER_APIENTRY self_init_glViewportIndexedfvOES(GLuint index, const GLfloat* v)
{
	glloader_init();
	glViewportIndexedfvOES(index, v);
}
static void GLLOADER_APIENTRY self_init_glScissorArrayvOES(GLuint first, GLsizei count, const GLint* v)
{
	glloader_init();
	glScissorArrayvOES(first, count, v);
}
static void GLLOADER_APIENTRY self_init_glScissorIndexedOES(GLuint index, GLint left, GLint bottom, GLsizei width, GLsizei height)
{
	glloader_init();
	glScissorIndexedOES(index, left, bottom, width, height);
}
static void GLLOADER_APIENTRY self_init_glScissorIndexedvOES(GLuint index, const GLint* v)
{
	glloader_init();
	glScissorIndexedvOES(index, v);
}
static void GLLOADER_APIENTRY self_init_glDepthRangeArrayfvOES(GLuint first, GLsizei count, const GLfloat* v)
{
	glloader_init();
	glDepthRangeArrayfvOES(first, count, v);
}
static void GLLOADER_APIENTRY self_init_glDepthRangeIndexedfOES(GLuint index, GLfloat n, GLfloat f)
{
	glloader_init();
	glDepthRangeIndexedfOES(index, n, f);
}
static void GLLOADER_APIENTRY self_init_glGetFloati_vOES(GLenum target, GLuint index, GLfloat* data)
{
	glloader_init();
	glGetFloati_vOES(target, index, data);
}

glViewportArrayvOESFUNC glViewportArrayvOES = self_init_glViewportArrayvOES;
glViewportIndexedfOESFUNC glViewportIndexedfOES = self_init_glViewportIndexedfOES;
glViewportIndexedfvOESFUNC glViewportIndexedfvOES = self_init_glViewportIndexedfvOES;
glScissorArrayvOESFUNC glScissorArrayvOES = self_init_glScissorArrayvOES;
glScissorIndexedOESFUNC glScissorIndexedOES = self_init_glScissorIndexedOES;
glScissorIndexedvOESFUNC glScissorIndexedvOES = self_init_glScissorIndexedvOES;
glDepthRangeArrayfvOESFUNC glDepthRangeArrayfvOES = self_init_glDepthRangeArrayfvOES;
glDepthRangeIndexedfOESFUNC glDepthRangeIndexedfOES = self_init_glDepthRangeIndexedfOES;
glGetFloati_vOESFUNC glGetFloati_vOES = self_init_glGetFloati_vOES;
...
static char GLLOADER_APIENTRY _glloader_GLES_OVR_multiview_multisampled_render_to_texture()
{
	return _GLES_OVR_multiview_multisampled_render_to_texture;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_OVR_multiview_multisampled_render_to_texture()
{
	glloader_init();
	return glloader_GLES_OVR_multiview_multisampled_render_to_texture();
}
glloader_GLES_OVR_multiview_multisampled_render_to_textureFUNC glloader_GLES_OVR_multiview_multisampled_render_to_texture = self_init_glloader_GLES_OVR_multiview_multisampled_render_to_texture;

#ifdef GLES_OVR_multiview_multisampled_render_to_texture

static void GLLOADER_APIENTRY self_init_glFramebufferTextureMultisampleMultiviewOVR(GLenum target, GLenum attachment, GLuint texture, GLint level, GLsizei samples, GLint baseViewIndex, GLsizei numViews)
{
	glloader_init();
	glFramebufferTextureMultisampleMultiviewOVR(target, attachment, texture, level, samples, baseViewIndex, numViews);
}

glFramebufferTextureMultisampleMultiviewOVRFUNC glFramebufferTextureMultisampleMultiviewOVR = self_init_glFramebufferTextureMultisampleMultiviewOVR;
...
static char GLLOADER_APIENTRY _glloader_GLES_QCOM_framebuffer_foveated()
{
	return _GLES_QCOM_framebuffer_foveated;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_QCOM_framebuffer_foveated()
{
	glloader_init();
	return glloader_GLES_QCOM_framebuffer_foveated();
}
glloader_GLES_QCOM_framebuffer_foveatedFUNC glloader_GLES_QCOM_framebuffer_foveated = self_init_glloader_GLES_QCOM_framebuffer_foveated;

#ifdef GLES_QCOM_framebuffer_foveated

static void GLLOADER_APIENTRY self_init_glFramebufferFoveationConfigQCOM(GLuint fbo, GLuint numLayers, GLuint focalPointsPerLayer, GLuint requestedFeatures, GLuint* providedFeatures)
{
	glloader_init();
	glFramebufferFoveationConfigQCOM(fbo, numLayers, focalPointsPerLayer, requestedFeatures, providedFeatures);
}
static void GLLOADER_APIENTRY self_init_glFramebufferFoveationParametersQCOM(GLuint fbo, GLuint layer, GLuint focalPoint, GLfloat focalX, GLfloat focalY, GLfloat gainX, GLfloat gainY, GLfloat foveaArea)
{
	glloader_init();
	glFramebufferFoveationParametersQCOM(fbo, layer, focalPoint, focalX, focalY, gainX, gainY, foveaArea);
}

glFramebufferFoveationConfigQCOMFUNC glFramebufferFoveationConfigQCOM = self_init_glFramebufferFoveationConfigQCOM;
glFramebufferFoveationParametersQCOMFUNC glFramebufferFoveationParametersQCOM = self_init_glFramebufferFoveationParametersQCOM;
...
static char GLLOADER_APIENTRY _glloader_GLES_QCOM_shader_framebuffer_fetch_noncoherent()
{
	return _GLES_QCOM_shader_framebuffer_fetch_noncoherent;
}

static char GLLOADER_APIENTRY self_init_glloader_GLES_QCOM_shader_framebuffer_fetch_noncoherent()
{
	glloader_init();
	return glloader_GLES_QCOM_shader_framebuffer_fetch_noncoherent();
}
glloader_GLES_QCOM_shader_framebuffer_fetch_noncoherentFUNC glloader_GLES_QCOM_shader_framebuffer_fetch_noncoherent = self_init_glloader_GLES_QCOM_shader_framebuffer_fetch_noncoherent;

#ifdef GLES_QCOM_shader_framebuffer_fetch_noncoherent

static void GLLOADER_APIENTRY self_init_glFramebufferFetchBarrierQCOM()
{
	glloader_init();
	glFramebufferFetchBarrierQCOM();
}

glFramebufferFetchBarrierQCOMFUNC glFramebufferFetchBarrierQCOM = self_init_glFramebufferFetchBarrierQCOM;
...
void init_GLES_VERSION_3_2()
{
	glloader_GLES_VERSION_3_2 = _glloader_GLES_VERSION_3_2;

	_GLES_VERSION_3_2 = 0;
	if (glloader_is_supported("GLES_VERSION_3_2"))
	{
		_GLES_VERSION_3_2 = 1;
	...
	else
	{
		...
		{
			LOAD_FUNC2(glBlendBarrier, glBlendBarrierKHR);
		}
		else if (glloader_is_supported("GLES_NV_blend_equation_advanced"))
		{
			LOAD_FUNC2(glBlendBarrier, glBlendBarrierNV);
		}
		if (glloader_is_supported("GLES_OES_copy_image"))
		{
			LOAD_FUNC2(glCopyImageSubData, glCopyImageSubDataOES);
		}
		else if (glloader_is_supported("GLES_EXT_copy_image"))
		{
			LOAD_FUNC2(glCopyImageSubData, glCopyImageSubDataEXT);
		}
		if (glloader_is_supported("GLES_KHR_debug"))
		{
			LOAD_FUNC2(glDebugMessageControl, glDebugMessageControlKHR);
			LOAD_FUNC2(glDebugMessageInsert, glDebugMessageInsertKHR);
			LOAD_FUNC2(glDebugMessageCallback, glDebugMessageCallbackKHR);
			LOAD_FUNC2(glGetDebugMessageLog, glGetDebugMessageLogKHR);
			LOAD_FUNC2(glPushDebugGroup, glPushDebugGroupKHR);
			LOAD_FUNC2(glPopDebugGroup, glPopDebugGroupKHR);
			LOAD_FUNC2(glObjectLabel, glObjectLabelKHR);
			LOAD_FUNC2(glGetObjectLabel, glGetObjectLabelKHR);
			LOAD_FUNC2(glObjectPtrLabel, glObjectPtrLabelKHR);
			LOAD_FUNC2(glGetObjectPtrLabel, glGetObjectPtrLabelKHR);
			LOAD_FUNC2(glGetPointerv, glGetPointervKHR);
		}
		if (glloader_is_supported("GLES_OES_draw_buffers_indexed"))
		{
			LOAD_FUNC2(glEnablei, glEnableiOES);
			LOAD_FUNC2(glDisablei, glDisableiOES);
			LOAD_FUNC2(glBlendEquationi, glBlendEquationiOES);
			LOAD_FUNC2(glBlendEquationSeparatei, glBlendEquationSeparateiOES);
			LOAD_FUNC2(glBlendFunci, glBlendFunciOES);
			LOAD_FUNC2(glBlendFuncSeparatei, glBlendFuncSeparateiOES);
			LOAD_FUNC2(glColorMaski, glColorMaskiOES);
			LOAD_FUNC2(glIsEnabledi, glIsEnablediOES);
		}
		else if (glloader_is_supported("GLES_EXT_draw_buffers_indexed"))
		{
			LOAD_FUNC2(glEnablei, glEnableiEXT);
			LOAD_FUNC2(glDisablei, glDisableiEXT);
			LOAD_FUNC2(glBlendEquationi, glBlendEquationiEXT);
			LOAD_FUNC2(glBlendEquationSeparatei, glBlendEquationSeparateiEXT);
			LOAD_FUNC2(glBlendFunci, glBlendFunciEXT);
			LOAD_FUNC2(glBlendFuncSeparatei, glBlendFuncSeparateiEXT);
			LOAD_FUNC2(glColorMaski, glColorMaskiEXT);
			LOAD_FUNC2(glIsEnabledi, glIsEnablediEXT);
		}
		if (glloader_is_supported("GLES_OES_draw_elements_base_vertex"))
		{
			LOAD_FUNC2(glDrawElementsBaseVertex, glDrawElementsBaseVertexOES);
			LOAD_FUNC2(glDrawRangeElementsBaseVertex, glDrawRangeElementsBaseVertexOES);
			LOAD_FUNC2(glDrawElementsInstancedBaseVertex, glDrawElementsInstancedBaseVertexOES);
		}
		else if (glloader_is_supported("GLES_EXT_draw_elements_base_vertex"))
		{
			LOAD_FUNC2(glDrawElementsBaseVertex, glDrawElementsBaseVertexEXT);
			LOAD_FUNC2(glDrawRangeElementsBaseVertex, glDrawRangeElementsBaseVertexEXT);
			LOAD_FUNC2(glDrawElementsInstancedBaseVertex, glDrawElementsInstancedBaseVertexEXT);
		}
		if (glloader_is_supported("GLES_OES_geometry_shader"))
		{
			LOAD_FUNC2(glFramebufferTexture, glFramebufferTextureOES);
			LOAD_FUNC2(glPrimitiveBoundingBox, glPrimitiveBoundingBoxOES);
		}
		else if (glloader_is_supported("GLES_EXT_geometry_shader"))
		{
			LOAD_FUNC2(glFramebufferTexture, glFramebufferTextureEXT);
			LOAD_FUNC2(glPrimitiveBoundingBox, glPrimitiveBoundingBoxEXT);
		}
		else if (glloader_is_supported("GLES_ANDROID_extension_pack_es31a"))
		{
			LOAD_FUNC2(glFramebufferTexture, glFramebufferTextureEXT);
			LOAD_FUNC2(glPrimitiveBoundingBox, glPrimitiveBoundingBoxEXT);
		}
		...
		{
			LOAD_FUNC2(glGetGraphicsResetStatus, glGetGraphicsResetStatusKHR);
			LOAD_FUNC2(glReadnPixels, glReadnPixelsKHR);
			LOAD_FUNC2(glGetnUniformfv, glGetnUniformfvKHR);
			LOAD_FUNC2(glGetnUniformiv, glGetnUniformivKHR);
			LOAD_FUNC2(glGetnUniformuiv, glGetnUniformuivKHR);
		}
		if (glloader_is_supported("GLES_OES_sample_shading"))
		{
			LOAD_FUNC2(glMinSampleShading, glMinSampleShadingOES);
		}
		if (glloader_is_supported("GLES_OES_tessellation_shader"))
		{
			LOAD_FUNC2(glPatchParameteri, glPatchParameteriOES);
		}
		else if (glloader_is_supported("GLES_EXT_tessellation_shader"))
		{
			LOAD_FUNC2(glPatchParameteri, glPatchParameteriEXT);
		}
		else if (glloader_is_supported("GLES_ANDROID_extension_pack_es31a"))
		{
			LOAD_FUNC2(glPatchParameteri, glPatchParameteriEXT);
		...
		{
			LOAD_FUNC2(glTexParameterIiv, glTexParameterIivOES);
			LOAD_FUNC2(glTexParameterIuiv, glTexParameterIuivOES);
			LOAD_FUNC2(glGetTexParameterIiv, glGetTexParameterIivOES);
			LOAD_FUNC2(glGetTexParameterIuiv, glGetTexParameterIuivOES);
			LOAD_FUNC2(glSamplerParameterIiv, glSamplerParameterIivOES);
			LOAD_FUNC2(glSamplerParameterIuiv, glSamplerParameterIuivOES);
			LOAD_FUNC2(glGetSamplerParameterIiv, glGetSamplerParameterIivOES);
			LOAD_FUNC2(glGetSamplerParameterIuiv, glGetSamplerParameterIuivOES);
		}
		else if (glloader_is_supported("GLES_EXT_texture_border_clamp"))
		{
			LOAD_FUNC2(glTexParameterIiv, glTexParameterIivEXT);
			LOAD_FUNC2(glTexParameterIuiv, glTexParameterIuivEXT);
			LOAD_FUNC2(glGetTexParameterIiv, glGetTexParameterIivEXT);
			LOAD_FUNC2(glGetTexParameterIuiv, glGetTexParameterIuivEXT);
			LOAD_FUNC2(glSamplerParameterIiv, glSamplerParameterIivEXT);
			LOAD_FUNC2(glSamplerParameterIuiv, glSamplerParameterIuivEXT);
			LOAD_FUNC2(glGetSamplerParameterIiv, glGetSamplerParameterIivEXT);
			LOAD_FUNC2(glGetSamplerParameterIuiv, glGetSamplerParameterIuivEXT);
		}
		if (glloader_is_supported("GLES_OES_texture_buffer"))
		{
			LOAD_FUNC2(glTexBuffer, glTexBufferOES);
			LOAD_FUNC2(glTexBufferRange, glTexBufferRangeOES);
		}
		else if (glloader_is_supported("GLES_EXT_texture_buffer"))
		{
			LOAD_FUNC2(glTexBuffer, glTexBufferEXT);
			LOAD_FUNC2(glTexBufferRange, glTexBufferRangeEXT);
		}
		else if (glloader_is_supported("GLES_ANDROID_extension_pack_es31a"))
		{
			LOAD_FUNC2(glTexBuffer, glTexBufferEXT);
		...
		if (glloader_is_supported("GLES_OES_texture_storage_multisample_2d_array"))
		{
			LOAD_FUNC2(glTexStorage3DMultisample, glTexStorage3DMultisampleOES);
		}

		if ((glloader_is_supported("GLES_KHR_blend_equation_advanced") || glloader_is_supported("GLES_NV_blend_equation_advanced"))
			&& (glloader_is_supported("GLES_OES_copy_image") || glloader_is_supported("GLES_EXT_copy_image"))
			&& glloader_is_supported("GLES_KHR_debug")
			&& (glloader_is_supported("GLES_OES_draw_buffers_indexed") || glloader_is_supported("GLES_EXT_draw_buffers_indexed"))
			&& (glloader_is_supported("GLES_OES_draw_elements_base_vertex") || glloader_is_supported("GLES_EXT_draw_elements_base_vertex"))
			&& (glloader_is_supported("GLES_OES_geometry_shader") || glloader_is_supported("GLES_EXT_geometry_shader") || glloader_is_supported("GLES_ANDROID_extension_pack_es31a"))
			&& glloader_is_supported("GLES_KHR_robustness")
			&& glloader_is_supported("GLES_OES_sample_shading")
			&& (glloader_is_supported("GLES_OES_tessellation_shader") || glloader_is_supported("GLES_EXT_tessellation_shader") || glloader_is_supported("GLES_ANDROID_extension_pack_es31a"))
			&& (glloader_is_supported("GLES_OES_texture_border_clamp") || glloader_is_supported("GLES_EXT_texture_border_clamp"))
			&& (glloader_is_supported("GLES_OES_texture_buffer") || glloader_is_supported("GLES_EXT_texture_buffer") || glloader_is_supported("GLES_ANDROID_extension_pack_es31a"))
			...
			&& glloader_is_supported("GLES_OES_texture_compression_astc")
			&& glloader_is_supported("GLES_EXT_texture_cube_map_array"))
		{
			_GLES_VERSION_3_2 = 1;
			promote_high("GLES_VERSION_3_2");
		}
	}
}
...
void init_GLES_ANDROID_extension_pack_es31a()
{
	...
	if (glloader_is_supported("GLES_ANDROID_extension_pack_es31a"))
	{
		...
		LOAD_FUNC1(glVertexAttribBinding);
		LOAD_FUNC1(glVertexBindingDivisor);
		LOAD_FUNC1(glDebugMessageControlKHR);
		LOAD_FUNC1(glDebugMessageInsertKHR);
		LOAD_FUNC1(glDebugMessageCallbackKHR);
		LOAD_FUNC1(glGetDebugMessageLogKHR);
		LOAD_FUNC1(glGetPointervKHR);
		LOAD_FUNC1(glPushDebugGroupKHR);
		LOAD_FUNC1(glPopDebugGroupKHR);
		LOAD_FUNC1(glObjectLabelKHR);
		LOAD_FUNC1(glGetObjectLabelKHR);
		LOAD_FUNC1(glObjectPtrLabelKHR);
		LOAD_FUNC1(glGetObjectPtrLabelKHR);
		LOAD_FUNC1(glBlendBarrierKHR);
		LOAD_FUNC1(glMinSampleShadingOES);
		LOAD_FUNC1(glTexStorage3DMultisampleOES);
...
void init_GLES_ANGLE_timer_query()
{
	glloader_GLES_ANGLE_timer_query = _glloader_GLES_ANGLE_timer_query;

	_GLES_ANGLE_timer_query = 0;
	if (glloader_is_supported("GLES_ANGLE_timer_query"))
	{
		_GLES_ANGLE_timer_query = 1;
...
void init_GLES_EXT_blend_func_extended()
{
	glloader_GLES_EXT_blend_func_extended = _glloader_GLES_EXT_blend_func_extended;

	_GLES_EXT_blend_func_extended = 0;
	if (glloader_is_supported("GLES_EXT_blend_func_extended"))
	{
		_GLES_EXT_blend_func_extended = 1;

		LOAD_FUNC1(glBindFragDataLocationIndexedEXT);
		LOAD_FUNC1(glGetFragDataIndexEXT);
		LOAD_FUNC1(glBindFragDataLocationEXT);
		LOAD_FUNC1(glGetProgramResourceLocationIndexEXT);
	}
}
...
void init_GLES_EXT_clear_texture()
{
	glloader_GLES_EXT_clear_texture = _glloader_GLES_EXT_clear_texture;

	_GLES_EXT_clear_texture = 0;
	if (glloader_is_supported("GLES_EXT_clear_texture"))
	{
		_GLES_EXT_clear_texture = 1;

		LOAD_FUNC1(glClearTexImageEXT);
		LOAD_FUNC1(glClearTexSubImageEXT);
	}
}

void init_GLES_EXT_clip_cull_distance()
{
	glloader_GLES_EXT_clip_cull_distance = _glloader_GLES_EXT_clip_cull_distance;

	_GLES_EXT_clip_cull_distance = 0;
	if (glloader_is_supported("GLES_EXT_clip_cull_distance"))
	{
		_GLES_EXT_clip_cull_distance = 1;
	}
}
...
void init_GLES_EXT_conservative_depth()
{
	glloader_GLES_EXT_conservative_depth = _glloader_GLES_EXT_conservative_depth;

	_GLES_EXT_conservative_depth = 0;
	if (glloader_is_supported("GLES_EXT_conservative_depth"))
	{
		_GLES_EXT_conservative_depth = 1;
	}
}
...
void init_GLES_EXT_draw_transform_feedback()
{
	glloader_GLES_EXT_draw_transform_feedback = _glloader_GLES_EXT_draw_transform_feedback;

	_GLES_EXT_draw_transform_feedback = 0;
	if (glloader_is_supported("GLES_EXT_draw_transform_feedback"))
	{
		_GLES_EXT_draw_transform_feedback = 1;

		LOAD_FUNC1(glDrawTransformFeedbackEXT);
		LOAD_FUNC1(glDrawTransformFeedbackInstancedEXT);
	}
}

void init_GLES_EXT_EGL_image_array()
{
	glloader_GLES_EXT_EGL_image_array = _glloader_GLES_EXT_EGL_image_array;

	_GLES_EXT_EGL_image_array = 0;
	if (glloader_is_supported("GLES_EXT_EGL_image_array"))
	{
		_GLES_EXT_EGL_image_array = 1;
	}
}

void init_GLES_EXT_external_buffer()
{
	glloader_GLES_EXT_external_buffer = _glloader_GLES_EXT_external_buffer;

	_GLES_EXT_external_buffer = 0;
	if (glloader_is_supported("GLES_EXT_external_buffer"))
	{
		_GLES_EXT_external_buffer = 1;

		LOAD_FUNC1(glBufferStorageExternalEXT);
	}
}
...
void init_GLES_EXT_memory_object()
{
	glloader_GLES_EXT_memory_object = _glloader_GLES_EXT_memory_object;

	_GLES_EXT_memory_object = 0;
	if (glloader_is_supported("GLES_EXT_memory_object"))
	{
		_GLES_EXT_memory_object = 1;

		LOAD_FUNC1(glGetUnsignedBytevEXT);
		LOAD_FUNC1(glGetUnsignedBytei_vEXT);
		LOAD_FUNC1(glDeleteMemoryObjectsEXT);
		LOAD_FUNC1(IsMemoryObjectEXT);
		LOAD_FUNC1(glCreateMemoryObjectsEXT);
		LOAD_FUNC1(glMemoryObjectParameterivEXT);
		LOAD_FUNC1(glGetMemoryObjectParameterivEXT);
		LOAD_FUNC1(glTexStorageMem2DEXT);
		LOAD_FUNC1(glTexStorageMem2DMultisampleEXT);
		LOAD_FUNC1(glTexStorageMem3DEXT);
		LOAD_FUNC1(glTexStorageMem3DMultisampleEXT);
		LOAD_FUNC1(glBufferStorageMemEXT);
		LOAD_FUNC1(glTextureStorageMem2DEXT);
		LOAD_FUNC1(glTextureStorageMem2DMultisampleEXT);
		LOAD_FUNC1(glTextureStorageMem3DEXT);
		LOAD_FUNC1(glTextureStorageMem3DMultisampleEXT);
		LOAD_FUNC1(glNamedBufferStorageMemEXT);
		LOAD_FUNC1(glTexStorageMem1DEXT);
		LOAD_FUNC1(glTextureStorageMem1DEXT);
	}
}

void init_GLES_EXT_memory_object_fd()
{
	glloader_GLES_EXT_memory_object_fd = _glloader_GLES_EXT_memory_object_fd;

	_GLES_EXT_memory_object_fd = 0;
	if (glloader_is_supported("GLES_EXT_memory_object_fd"))
	{
		_GLES_EXT_memory_object_fd = 1;

		LOAD_FUNC1(glImportMemoryFdEXT);
	}
}

void init_GLES_EXT_memory_object_win32()
{
	glloader_GLES_EXT_memory_object_win32 = _glloader_GLES_EXT_memory_object_win32;

	_GLES_EXT_memory_object_win32 = 0;
	if (glloader_is_supported("GLES_EXT_memory_object_win32"))
	{
		_GLES_EXT_memory_object_win32 = 1;

		LOAD_FUNC1(glImportMemoryWin32HandleEXT);
		LOAD_FUNC1(glImportMemoryWin32NameEXT);
	}
}
...
void init_GLES_EXT_multisampled_render_to_texture2()
{
	glloader_GLES_EXT_multisampled_render_to_texture2 = _glloader_GLES_EXT_multisampled_render_to_texture2;

	_GLES_EXT_multisampled_render_to_texture2 = 0;
	if (glloader_is_supported("GLES_EXT_multisampled_render_to_texture2"))
	{
		_GLES_EXT_multisampled_render_to_texture2 = 1;
	}
}

void init_GLES_EXT_multisample_compatibility()
{
	glloader_GLES_EXT_multisample_compatibility = _glloader_GLES_EXT_multisample_compatibility;

	_GLES_EXT_multisample_compatibility = 0;
	if (glloader_is_supported("GLES_EXT_multisample_compatibility"))
	{
		_GLES_EXT_multisample_compatibility = 1;
	}
}
...
void init_GLES_EXT_polygon_offset_clamp()
{
	glloader_GLES_EXT_polygon_offset_clamp = _glloader_GLES_EXT_polygon_offset_clamp;

	_GLES_EXT_polygon_offset_clamp = 0;
	if (glloader_is_supported("GLES_EXT_polygon_offset_clamp"))
	{
		_GLES_EXT_polygon_offset_clamp = 1;

		LOAD_FUNC1(glPolygonOffsetClampEXT);
	}
}
...
void init_GLES_EXT_protected_textures()
{
	glloader_GLES_EXT_protected_textures = _glloader_GLES_EXT_protected_textures;

	_GLES_EXT_protected_textures = 0;
	if (glloader_is_supported("GLES_EXT_protected_textures"))
	{
		_GLES_EXT_protected_textures = 1;
	}
}
...
void init_GLES_EXT_semaphore()
{
	glloader_GLES_EXT_semaphore = _glloader_GLES_EXT_semaphore;

	_GLES_EXT_semaphore = 0;
	if (glloader_is_supported("GLES_EXT_semaphore"))
	{
		_GLES_EXT_semaphore = 1;

		LOAD_FUNC1(glGetUnsignedBytevEXT);
		LOAD_FUNC1(glGetUnsignedBytei_vEXT);
		LOAD_FUNC1(glGenSemaphoresEXT);
		LOAD_FUNC1(glDeleteSemaphoresEXT);
		LOAD_FUNC1(glIsSemaphoreEXT);
		LOAD_FUNC1(glSemaphoreParameterui64vEXT);
		LOAD_FUNC1(glGetSemaphoreParameterui64vEXT);
		LOAD_FUNC1(glWaitSemaphoreEXT);
		LOAD_FUNC1(glSignalSemaphoreEXT);
	}
}

void init_GLES_EXT_semaphore_fd()
{
	glloader_GLES_EXT_semaphore_fd = _glloader_GLES_EXT_semaphore_fd;

	_GLES_EXT_semaphore_fd = 0;
	if (glloader_is_supported("GLES_EXT_semaphore_fd"))
	{
		_GLES_EXT_semaphore_fd = 1;

		LOAD_FUNC1(glImportSemaphoreFdEXT);
	}
}

void init_GLES_EXT_semaphore_win32()
{
	glloader_GLES_EXT_semaphore_win32 = _glloader_GLES_EXT_semaphore_win32;

	_GLES_EXT_semaphore_win32 = 0;
	if (glloader_is_supported("GLES_EXT_semaphore_win32"))
	{
		_GLES_EXT_semaphore_win32 = 1;

		LOAD_FUNC1(glImportSemaphoreWin32HandleEXT);
		LOAD_FUNC1(glImportSemaphoreWin32NameEXT);
	}
}
...
void init_GLES_EXT_shader_group_vote()
{
	glloader_GLES_EXT_shader_group_vote = _glloader_GLES_EXT_shader_group_vote;

	_GLES_EXT_shader_group_vote = 0;
	if (glloader_is_supported("GLES_EXT_shader_group_vote"))
	{
		_GLES_EXT_shader_group_vote = 1;
	}
}
...
void init_GLES_EXT_shader_non_constant_global_initializers()
{
	glloader_GLES_EXT_shader_non_constant_global_initializers = _glloader_GLES_EXT_shader_non_constant_global_initializers;

	_GLES_EXT_shader_non_constant_global_initializers = 0;
	if (glloader_is_supported("GLES_EXT_shader_non_constant_global_initializers"))
	{
		_GLES_EXT_shader_non_constant_global_initializers = 1;
	}
}
...
void init_GLES_EXT_shader_pixel_local_storage2()
{
	glloader_GLES_EXT_shader_pixel_local_storage2 = _glloader_GLES_EXT_shader_pixel_local_storage2;

	_GLES_EXT_shader_pixel_local_storage2 = 0;
	if (glloader_is_supported("GLES_EXT_shader_pixel_local_storage2"))
	{
		_GLES_EXT_shader_pixel_local_storage2 = 1;

		LOAD_FUNC1(glFramebufferPixelLocalStorageSizeEXT);
		LOAD_FUNC1(glGetFramebufferPixelLocalStorageSizeEXT);
		LOAD_FUNC1(glClearPixelLocalStorageuiEXT);
	}
}
...
void init_GLES_EXT_sparse_texture2()
{
	glloader_GLES_EXT_sparse_texture2 = _glloader_GLES_EXT_sparse_texture2;

	_GLES_EXT_sparse_texture2 = 0;
	if (glloader_is_supported("GLES_EXT_sparse_texture2"))
	{
		_GLES_EXT_sparse_texture2 = 1;
	}
}
...
void init_GLES_EXT_texture_compression_astc_decode_mode()
{
	glloader_GLES_EXT_texture_compression_astc_decode_mode = _glloader_GLES_EXT_texture_compression_astc_decode_mode;

	_GLES_EXT_texture_compression_astc_decode_mode = 0;
	if (glloader_is_supported("GLES_EXT_texture_compression_astc_decode_mode"))
	{
		_GLES_EXT_texture_compression_astc_decode_mode = 1;
	}
}

void init_GLES_EXT_texture_compression_bptc()
{
	glloader_GLES_EXT_texture_compression_bptc = _glloader_GLES_EXT_texture_compression_bptc;

	_GLES_EXT_texture_compression_bptc = 0;
	if (glloader_is_supported("GLES_EXT_texture_compression_bptc"))
	{
		_GLES_EXT_texture_compression_bptc = 1;
	}
}
...
void init_GLES_EXT_texture_compression_rgtc()
{
	glloader_GLES_EXT_texture_compression_rgtc = _glloader_GLES_EXT_texture_compression_rgtc;

	_GLES_EXT_texture_compression_rgtc = 0;
	if (glloader_is_supported("GLES_EXT_texture_compression_rgtc"))
	{
		_GLES_EXT_texture_compression_rgtc = 1;
	}
}
...
void init_GLES_EXT_win32_keyed_mutex()
{
	glloader_GLES_EXT_win32_keyed_mutex = _glloader_GLES_EXT_win32_keyed_mutex;

	_GLES_EXT_win32_keyed_mutex = 0;
	if (glloader_is_supported("GLES_EXT_win32_keyed_mutex"))
	{
		_GLES_EXT_win32_keyed_mutex = 1;

		LOAD_FUNC1(glAcquireKeyedMutexWin32EXT);
		LOAD_FUNC1(glReleaseKeyedMutexWin32EXT);
	}
}

void init_GLES_EXT_window_rectangles()
{
	glloader_GLES_EXT_window_rectangles = _glloader_GLES_EXT_window_rectangles;

	_GLES_EXT_window_rectangles = 0;
	if (glloader_is_supported("GLES_EXT_window_rectangles"))
	{
		_GLES_EXT_window_rectangles = 1;

		LOAD_FUNC1(glWindowRectanglesEXT);
	}
}
...
void init_GLES_IMG_bindless_texture()
{
	glloader_GLES_IMG_bindless_texture = _glloader_GLES_IMG_bindless_texture;

	_GLES_IMG_bindless_texture = 0;
	if (glloader_is_supported("GLES_IMG_bindless_texture"))
	{
		_GLES_IMG_bindless_texture = 1;

		LOAD_FUNC1(glGetTextureHandleIMG);
		LOAD_FUNC1(glGetTextureSamplerHandleIMG);
		LOAD_FUNC1(glUniformHandleui64IMG);
		LOAD_FUNC1(glUniformHandleui64vIMG);
		LOAD_FUNC1(glProgramUniformHandleui64IMG);
		LOAD_FUNC1(glProgramUniformHandleui64vIMG);
	}
}

void init_GLES_IMG_framebuffer_downsample()
{
	glloader_GLES_IMG_framebuffer_downsample = _glloader_GLES_IMG_framebuffer_downsample;

	_GLES_IMG_framebuffer_downsample = 0;
	if (glloader_is_supported("GLES_IMG_framebuffer_downsample"))
	{
		_GLES_IMG_framebuffer_downsample = 1;

		LOAD_FUNC1(glFramebufferTexture2DDownsampleIMG);
		LOAD_FUNC1(glFramebufferTextureLayerDownsampleIMG);
	}
}
...
void init_GLES_IMG_texture_filter_cubic()
{
	glloader_GLES_IMG_texture_filter_cubic = _glloader_GLES_IMG_texture_filter_cubic;

	_GLES_IMG_texture_filter_cubic = 0;
	if (glloader_is_supported("GLES_IMG_texture_filter_cubic"))
	{
		_GLES_IMG_texture_filter_cubic = 1;
	}
}
...
void init_GLES_INTEL_conservative_rasterization()
{
	glloader_GLES_INTEL_conservative_rasterization = _glloader_GLES_INTEL_conservative_rasterization;

	_GLES_INTEL_conservative_rasterization = 0;
	if (glloader_is_supported("GLES_INTEL_conservative_rasterization"))
	{
		_GLES_INTEL_conservative_rasterization = 1;
	}
}

void init_GLES_INTEL_framebuffer_CMAA()
{
	glloader_GLES_INTEL_framebuffer_CMAA = _glloader_GLES_INTEL_framebuffer_CMAA;

	_GLES_INTEL_framebuffer_CMAA = 0;
	if (glloader_is_supported("GLES_INTEL_framebuffer_CMAA"))
	{
		_GLES_INTEL_framebuffer_CMAA = 1;

		LOAD_FUNC1(glApplyFramebufferAttachmentCMAAINTEL);
	}
}
...
void init_GLES_KHR_parallel_shader_compile()
{
	glloader_GLES_KHR_parallel_shader_compile = _glloader_GLES_KHR_parallel_shader_compile;

	_GLES_KHR_parallel_shader_compile = 0;
	if (glloader_is_supported("GLES_KHR_parallel_shader_compile"))
	{
		_GLES_KHR_parallel_shader_compile = 1;

		LOAD_FUNC1(glMaxShaderCompilerThreadsKHR);
	}
	else
	{
		if (glloader_is_supported("GL_ARB_parallel_shader_compile"))
		{
			LOAD_FUNC2(glMaxShaderCompilerThreadsKHR, glMaxShaderCompilerThreadsARB);

			_GLES_KHR_parallel_shader_compile = 1;
			promote_high("GLES_KHR_parallel_shader_compile");
		}
	}
}
...
void init_GLES_KHR_robustness()
{
	...
	if (glloader_is_supported("GLES_KHR_robustness"))
	{
		...
		LOAD_FUNC1(glGetGraphicsResetStatusKHR);
		LOAD_FUNC1(glReadnPixelsKHR);
		LOAD_FUNC1(glGetnUniformfvKHR);
		LOAD_FUNC1(glGetnUniformivKHR);
		LOAD_FUNC1(glGetnUniformuivKHR);
	}
}
...
void init_GLES_KHR_texture_compression_astc_sliced_3d()
{
	glloader_GLES_KHR_texture_compression_astc_sliced_3d = _glloader_GLES_KHR_texture_compression_astc_sliced_3d;

	_GLES_KHR_texture_compression_astc_sliced_3d = 0;
	if (glloader_is_supported("GLES_KHR_texture_compression_astc_sliced_3d"))
	{
		_GLES_KHR_texture_compression_astc_sliced_3d = 1;
	}
}

void init_GLES_NVX_blend_equation_advanced_multi_draw_buffers()
{
	glloader_GLES_NVX_blend_equation_advanced_multi_draw_buffers = _glloader_GLES_NVX_blend_equation_advanced_multi_draw_buffers;

	_GLES_NVX_blend_equation_advanced_multi_draw_buffers = 0;
	if (glloader_is_supported("GLES_NVX_blend_equation_advanced_multi_draw_buffers"))
	{
		_GLES_NVX_blend_equation_advanced_multi_draw_buffers = 1;
	}
}
...
void init_GLES_NV_blend_minmax_factor()
{
	glloader_GLES_NV_blend_minmax_factor = _glloader_GLES_NV_blend_minmax_factor;

	_GLES_NV_blend_minmax_factor = 0;
	if (glloader_is_supported("GLES_NV_blend_minmax_factor"))
	{
		_GLES_NV_blend_minmax_factor = 1;
	}
}
...
void init_GLES_NV_conservative_raster_pre_snap_triangles()
{
	glloader_GLES_NV_conservative_raster_pre_snap_triangles = _glloader_GLES_NV_conservative_raster_pre_snap_triangles;

	_GLES_NV_conservative_raster_pre_snap_triangles = 0;
	if (glloader_is_supported("GLES_NV_conservative_raster_pre_snap_triangles"))
	{
		_GLES_NV_conservative_raster_pre_snap_triangles = 1;

		LOAD_FUNC1(glConservativeRasterParameteriNV);
	}
}
...
void init_GLES_NV_draw_vulkan_image()
{
	glloader_GLES_NV_draw_vulkan_image = _glloader_GLES_NV_draw_vulkan_image;

	_GLES_NV_draw_vulkan_image = 0;
	if (glloader_is_supported("GLES_NV_draw_vulkan_image"))
	{
		_GLES_NV_draw_vulkan_image = 1;

		LOAD_FUNC1(glDrawVkImageNV);
		LOAD_FUNC1(glGetVkProcAddrNV);
		LOAD_FUNC1(glWaitVkSemaphoreNV);
		LOAD_FUNC1(glSignalVkSemaphoreNV);
		LOAD_FUNC1(glSignalVkFenceNV);
	}
}
...
void init_GLES_NV_gpu_shader5()
{
	glloader_GLES_NV_gpu_shader5 = _glloader_GLES_NV_gpu_shader5;

	_GLES_NV_gpu_shader5 = 0;
	if (glloader_is_supported("GLES_NV_gpu_shader5"))
	{
		_GLES_NV_gpu_shader5 = 1;

		LOAD_FUNC1(glUniform1i64NV);
		LOAD_FUNC1(glUniform2i64NV);
		LOAD_FUNC1(glUniform3i64NV);
		LOAD_FUNC1(glUniform4i64NV);
		LOAD_FUNC1(glUniform1i64vNV);
		LOAD_FUNC1(glUniform2i64vNV);
		LOAD_FUNC1(glUniform3i64vNV);
		LOAD_FUNC1(glUniform4i64vNV);
		LOAD_FUNC1(glUniform1ui64NV);
		LOAD_FUNC1(glUniform2ui64NV);
		LOAD_FUNC1(glUniform3ui64NV);
		LOAD_FUNC1(glUniform4ui64NV);
		LOAD_FUNC1(glUniform1ui64vNV);
		LOAD_FUNC1(glUniform2ui64vNV);
		LOAD_FUNC1(glUniform3ui64vNV);
		LOAD_FUNC1(glUniform4ui64vNV);
		LOAD_FUNC1(glGetUniformi64vNV);
		LOAD_FUNC1(glProgramUniform1i64NV);
		LOAD_FUNC1(glProgramUniform2i64NV);
		LOAD_FUNC1(glProgramUniform3i64NV);
		LOAD_FUNC1(glProgramUniform4i64NV);
		LOAD_FUNC1(glProgramUniform1i64vNV);
		LOAD_FUNC1(glProgramUniform2i64vNV);
		LOAD_FUNC1(glProgramUniform3i64vNV);
		LOAD_FUNC1(glProgramUniform4i64vNV);
		LOAD_FUNC1(glProgramUniform1ui64NV);
		LOAD_FUNC1(glProgramUniform2ui64NV);
		LOAD_FUNC1(glProgramUniform3ui64NV);
		LOAD_FUNC1(glProgramUniform4ui64NV);
		LOAD_FUNC1(glProgramUniform1ui64vNV);
		LOAD_FUNC1(glProgramUniform2ui64vNV);
		LOAD_FUNC1(glProgramUniform3ui64vNV);
		LOAD_FUNC1(glProgramUniform4ui64vNV);
	}
}
...
void init_GLES_NV_shader_atomic_fp16_vector()
{
	glloader_GLES_NV_shader_atomic_fp16_vector = _glloader_GLES_NV_shader_atomic_fp16_vector;

	_GLES_NV_shader_atomic_fp16_vector = 0;
	if (glloader_is_supported("GLES_NV_shader_atomic_fp16_vector"))
	{
		_GLES_NV_shader_atomic_fp16_vector = 1;
	}
}
...
void init_GLES_NV_texture_barrier()
{
	glloader_GLES_NV_texture_barrier = _glloader_GLES_NV_texture_barrier;

	_GLES_NV_texture_barrier = 0;
	if (glloader_is_supported("GLES_NV_texture_barrier"))
	{
		_GLES_NV_texture_barrier = 1;

		LOAD_FUNC1(glTextureBarrierNV);
	}
}
...
void init_GLES_NV_viewport_swizzle()
{
	glloader_GLES_NV_viewport_swizzle = _glloader_GLES_NV_viewport_swizzle;

	_GLES_NV_viewport_swizzle = 0;
	if (glloader_is_supported("GLES_NV_viewport_swizzle"))
	{
		_GLES_NV_viewport_swizzle = 1;

		LOAD_FUNC1(glViewportSwizzleNV);
	}
}
...
void init_GLES_OES_sample_shading()
{
	glloader_GLES_OES_sample_shading = _glloader_GLES_OES_sample_shading;

	_GLES_OES_sample_shading = 0;
	if (glloader_is_supported("GLES_OES_sample_shading"))
	{
		_GLES_OES_sample_shading = 1;

		LOAD_FUNC1(glMinSampleShadingOES);
	}
}

void init_GLES_OES_sample_variables()
{
	glloader_GLES_OES_sample_variables = _glloader_GLES_OES_sample_variables;

	_GLES_OES_sample_variables = 0;
	if (glloader_is_supported("GLES_OES_sample_variables"))
	{
		_GLES_OES_sample_variables = 1;
	}
}
...
void init_GLES_OES_shader_image_atomic()
{
	glloader_GLES_OES_shader_image_atomic = _glloader_GLES_OES_shader_image_atomic;

	_GLES_OES_shader_image_atomic = 0;
	if (glloader_is_supported("GLES_OES_shader_image_atomic"))
	{
		_GLES_OES_shader_image_atomic = 1;
	}
}
...
void init_GLES_OES_shader_multisample_interpolation()
{
	glloader_GLES_OES_shader_multisample_interpolation = _glloader_GLES_OES_shader_multisample_interpolation;

	_GLES_OES_shader_multisample_interpolation = 0;
	if (glloader_is_supported("GLES_OES_shader_multisample_interpolation"))
	{
		_GLES_OES_shader_multisample_interpolation = 1;
	}
}
...
void init_GLES_OES_texture_stencil8()
{
	glloader_GLES_OES_texture_stencil8 = _glloader_GLES_OES_texture_stencil8;

	_GLES_OES_texture_stencil8 = 0;
	if (glloader_is_supported("GLES_OES_texture_stencil8"))
	{
		_GLES_OES_texture_stencil8 = 1;
	}
}

void init_GLES_OES_texture_storage_multisample_2d_array()
{
	glloader_GLES_OES_texture_storage_multisample_2d_array = _glloader_GLES_OES_texture_storage_multisample_2d_array;

	_GLES_OES_texture_storage_multisample_2d_array = 0;
	if (glloader_is_supported("GLES_OES_texture_storage_multisample_2d_array"))
	{
		_GLES_OES_texture_storage_multisample_2d_array = 1;
...
void init_GLES_OES_viewport_array()
{
	glloader_GLES_OES_viewport_array = _glloader_GLES_OES_viewport_array;

	_GLES_OES_viewport_array = 0;
	if (glloader_is_supported("GLES_OES_viewport_array"))
	{
		_GLES_OES_viewport_array = 1;

		LOAD_FUNC1(glViewportArrayvOES);
		LOAD_FUNC1(glViewportIndexedfOES);
		LOAD_FUNC1(glViewportIndexedfvOES);
		LOAD_FUNC1(glScissorArrayvOES);
		LOAD_FUNC1(glScissorIndexedOES);
		LOAD_FUNC1(glScissorIndexedvOES);
		LOAD_FUNC1(glDepthRangeArrayfvOES);
		LOAD_FUNC1(glDepthRangeIndexedfOES);
		LOAD_FUNC1(glGetFloati_vOES);
		LOAD_FUNC1(glEnableiOES);
		LOAD_FUNC1(glDisableiOES);
		LOAD_FUNC1(glIsEnablediOES);
	}
...
void init_GLES_OVR_multiview_multisampled_render_to_texture()
{
	glloader_GLES_OVR_multiview_multisampled_render_to_texture = _glloader_GLES_OVR_multiview_multisampled_render_to_texture;

	_GLES_OVR_multiview_multisampled_render_to_texture = 0;
	if (glloader_is_supported("GLES_OVR_multiview_multisampled_render_to_texture"))
	{
		_GLES_OVR_multiview_multisampled_render_to_texture = 1;

		LOAD_FUNC1(glFramebufferTextureMultisampleMultiviewOVR);
	}
}
...
void init_GLES_QCOM_framebuffer_foveated()
{
	glloader_GLES_QCOM_framebuffer_foveated = _glloader_GLES_QCOM_framebuffer_foveated;

	_GLES_QCOM_framebuffer_foveated = 0;
	if (glloader_is_supported("GLES_QCOM_framebuffer_foveated"))
	{
		_GLES_QCOM_framebuffer_foveated = 1;

		LOAD_FUNC1(glFramebufferFoveationConfigQCOM);
		LOAD_FUNC1(glFramebufferFoveationParametersQCOM);
	}
}
...
void init_GLES_QCOM_shader_framebuffer_fetch_noncoherent()
{
	glloader_GLES_QCOM_shader_framebuffer_fetch_noncoherent = _glloader_GLES_QCOM_shader_framebuffer_fetch_noncoherent;

	_GLES_QCOM_shader_framebuffer_fetch_noncoherent = 0;
	if (glloader_is_supported("GLES_QCOM_shader_framebuffer_fetch_noncoherent"))
	{
		_GLES_QCOM_shader_framebuffer_fetch_noncoherent = 1;

		LOAD_FUNC1(glFramebufferFetchBarrierQCOM);
	}
}
...
void gles_init()
{
	...
	init_GLES_EXT_draw_transform_feedback();
	init_GLES_EXT_EGL_image_array();
	init_GLES_EXT_external_buffer();
	...
	init_GLES_EXT_memory_object();
	init_GLES_EXT_memory_object_fd();
	init_GLES_EXT_memory_object_win32();
	init_GLES_EXT_multisampled_render_to_texture();
	init_GLES_EXT_multisampled_render_to_texture2();
	init_GLES_EXT_multisample_compatibility();
	...
	init_GLES_EXT_texture_compression_astc_decode_mode();
	init_GLES_EXT_texture_compression_bptc();
	init_GLES_EXT_texture_compression_dxt1();
	init_GLES_EXT_texture_compression_latc();
	init_GLES_EXT_texture_compression_rgtc();
	...
	init_GLES_EXT_win32_keyed_mutex();
	init_GLES_EXT_window_rectangles();
	init_GLES_EXT_YUV_target();
	init_GLES_FJ_shader_binary_GCCSO();
	init_GLES_IMG_bindless_texture();
	init_GLES_IMG_framebuffer_downsample();
	...
	init_GLES_IMG_texture_filter_cubic();
	init_GLES_IMG_user_clip_plane();
	init_GLES_INTEL_conservative_rasterization();
	init_GLES_INTEL_framebuffer_CMAA();
	...
	init_GLES_NV_draw_vulkan_image();
	...
	init_GLES_NV_shader_atomic_fp16_vector();
	...
	init_GLES_OES_sample_shading();
	init_GLES_OES_sample_variables();
	init_GLES_OES_shader_binary();
	init_GLES_OES_shader_image_atomic();
	init_GLES_OES_shader_io_blocks();
	init_GLES_OES_shader_multisample_interpolation();
	...
	init_GLES_OES_texture_stencil8();
	init_GLES_OES_texture_storage_multisample_2d_array();
