...
typedef void (GLLOADER_APIENTRY *GLDEBUGPROCARB)(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar* message, const void* userParam);
...
typedef void (GLLOADER_APIENTRY *glSpecializeShaderFUNC)(GLuint shader, const GLchar* pEntryPoint, GLuint numSpecializationConstants, const GLuint* pConstantIndex, const GLuint* pConstantValue);
typedef void (GLLOADER_APIENTRY *glMultiDrawArraysIndirectCountFUNC)(GLenum mode, const void* indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride);
typedef void (GLLOADER_APIENTRY *glMultiDrawElementsIndirectCountFUNC)(GLenum mode, GLenum type, const void* indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride);
typedef void (GLLOADER_APIENTRY *glPolygonOffsetClampFUNC)(GLfloat factor, GLfloat units, GLfloat clamp);

extern GLLOADER_API glSpecializeShaderFUNC glSpecializeShader;
extern GLLOADER_API glMultiDrawArraysIndirectCountFUNC glMultiDrawArraysIndirectCount;
extern GLLOADER_API glMultiDrawElementsIndirectCountFUNC glMultiDrawElementsIndirectCount;
extern GLLOADER_API glPolygonOffsetClampFUNC glPolygonOffsetClamp;
...
typedef void (GLLOADER_APIENTRY *glTextureSubImage1DFUNC)(GLuint texture, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid* pixels);
typedef void (GLLOADER_APIENTRY *glTextureSubImage2DFUNC)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid* pixels);
...
typedef void (GLLOADER_APIENTRY *glTextureParameterIivFUNC)(GLuint texture, GLenum pname, const GLint* params);
typedef void (GLLOADER_APIENTRY *glTextureParameterIuivFUNC)(GLuint texture, GLenum pname, const GLuint* params);
...
typedef void (GLLOADER_APIENTRY *glGetTextureParameterivFUNC)(GLuint texture, GLenum pname, GLint* params);
...
extern GLLOADER_API glTextureSubImage1DFUNC glTextureSubImage1D;
extern GLLOADER_API glTextureSubImage2DFUNC glTextureSubImage2D;
...
extern GLLOADER_API glTextureParameterIivFUNC glTextureParameterIiv;
extern GLLOADER_API glTextureParameterIuivFUNC glTextureParameterIuiv;
...
extern GLLOADER_API glGetTextureParameterivFUNC glGetTextureParameteriv;
...
typedef void (GLLOADER_APIENTRY *glPrimitiveBoundingBoxARBFUNC)(GLfloat minX, GLfloat minY, GLfloat minZ, GLfloat minW, GLfloat maxX, GLfloat maxY, GLfloat maxZ, GLfloat maxW);

extern GLLOADER_API glPrimitiveBoundingBoxARBFUNC glPrimitiveBoundingBoxARB;
...
typedef void (GLLOADER_APIENTRY *glSpecializeShaderARBFUNC)(GLuint shader, const GLchar* pEntryPoint, GLuint numSpecializationConstants, const GLuint* pConstantIndex, const GLuint* pConstantValue);

extern GLLOADER_API glSpecializeShaderARBFUNC glSpecializeShaderARB;
...
typedef void (GLLOADER_APIENTRY *glUniform1i64ARBFUNC)(GLint location, GLint64 x);
typedef void (GLLOADER_APIENTRY *glUniform2i64ARBFUNC)(GLint location, GLint64 x, GLint64 y);
typedef void (GLLOADER_APIENTRY *glUniform3i64ARBFUNC)(GLint location, GLint64 x, GLint64 y, GLint64 z);
typedef void (GLLOADER_APIENTRY *glUniform4i64ARBFUNC)(GLint location, GLint64 x, GLint64 y, GLint64 z, GLint64 w);
typedef void (GLLOADER_APIENTRY *glUniform1i64vARBFUNC)(GLint location, GLsizei count, const GLint64* value);
typedef void (GLLOADER_APIENTRY *glUniform2i64vARBFUNC)(GLint location, GLsizei count, const GLint64* value);
typedef void (GLLOADER_APIENTRY *glUniform3i64vARBFUNC)(GLint location, GLsizei count, const GLint64* value);
typedef void (GLLOADER_APIENTRY *glUniform4i64vARBFUNC)(GLint location, GLsizei count, const GLint64* value);
typedef void (GLLOADER_APIENTRY *glUniform1ui64ARBFUNC)(GLint location, GLuint64 x);
typedef void (GLLOADER_APIENTRY *glUniform2ui64ARBFUNC)(GLint location, GLuint64 x, GLuint64 y);
typedef void (GLLOADER_APIENTRY *glUniform3ui64ARBFUNC)(GLint location, GLuint64 x, GLuint64 y, GLuint64 z);
typedef void (GLLOADER_APIENTRY *glUniform4ui64ARBFUNC)(GLint location, GLuint64 x, GLuint64 y, GLuint64 z, GLuint64 w);
typedef void (GLLOADER_APIENTRY *glUniform1ui64vARBFUNC)(GLint location, GLsizei count, const GLuint64* value);
typedef void (GLLOADER_APIENTRY *glUniform2ui64vARBFUNC)(GLint location, GLsizei count, const GLuint64* value);
typedef void (GLLOADER_APIENTRY *glUniform3ui64vARBFUNC)(GLint location, GLsizei count, const GLuint64* value);
typedef void (GLLOADER_APIENTRY *glUniform4ui64vARBFUNC)(GLint location, GLsizei count, const GLuint64* value);
typedef void (GLLOADER_APIENTRY *glGetUniformi64vARBFUNC)(GLuint program, GLint location, GLint64* params);
typedef void (GLLOADER_APIENTRY *glGetUniformui64vARBFUNC)(GLuint program, GLint location, GLuint64* params);
typedef void (GLLOADER_APIENTRY *glGetnUniformui64vARBFUNC)(GLuint program, GLint location, GLsizei bufSize, GLuint64* params);
typedef void (GLLOADER_APIENTRY *glProgramUniform1i64ARBFUNC)(GLuint program, GLint location, GLint64 x);
typedef void (GLLOADER_APIENTRY *glProgramUniform2i64ARBFUNC)(GLuint program, GLint location, GLint64 x, GLint64 y);
typedef void (GLLOADER_APIENTRY *glProgramUniform3i64ARBFUNC)(GLuint program, GLint location, GLint64 x, GLint64 y, GLint64 z);
typedef void (GLLOADER_APIENTRY *glProgramUniform4i64ARBFUNC)(GLuint program, GLint location, GLint64 x, GLint64 y, GLint64 z, GLint64 w);
typedef void (GLLOADER_APIENTRY *glProgramUniform1i64vARBFUNC)(GLuint program, GLint location, GLsizei count, const GLint64* value);
typedef void (GLLOADER_APIENTRY *glProgramUniform2i64vARBFUNC)(GLuint program, GLint location, GLsizei count, const GLint64* value);
typedef void (GLLOADER_APIENTRY *glProgramUniform3i64vARBFUNC)(GLuint program, GLint location, GLsizei count, const GLint64* value);
typedef void (GLLOADER_APIENTRY *glProgramUniform4i64vARBFUNC)(GLuint program, GLint location, GLsizei count, const GLint64* value);
typedef void (GLLOADER_APIENTRY *glProgramUniform1ui64ARBFUNC)(GLuint program, GLint location, GLuint64 x);
typedef void (GLLOADER_APIENTRY *glProgramUniform2ui64ARBFUNC)(GLuint program, GLint location, GLuint64 x, GLuint64 y);
typedef void (GLLOADER_APIENTRY *glProgramUniform3ui64ARBFUNC)(GLuint program, GLint location, GLuint64 x, GLuint64 y, GLuint64 z);
typedef void (GLLOADER_APIENTRY *glProgramUniform4ui64ARBFUNC)(GLuint program, GLint location, GLuint64 x, GLuint64 y, GLuint64 z, GLuint64 w);
typedef void (GLLOADER_APIENTRY *glProgramUniform1ui64vARBFUNC)(GLuint program, GLint location, GLsizei count, const GLuint64* value);
typedef void (GLLOADER_APIENTRY *glProgramUniform2ui64vARBFUNC)(GLuint program, GLint location, GLsizei count, const GLuint64* value);
typedef void (GLLOADER_APIENTRY *glProgramUniform3ui64vARBFUNC)(GLuint program, GLint location, GLsizei count, const GLuint64* value);
typedef void (GLLOADER_APIENTRY *glProgramUniform4ui64vARBFUNC)(GLuint program, GLint location, GLsizei count, const GLuint64* value);

extern GLLOADER_API glUniform1i64ARBFUNC glUniform1i64ARB;
extern GLLOADER_API glUniform2i64ARBFUNC glUniform2i64ARB;
extern GLLOADER_API glUniform3i64ARBFUNC glUniform3i64ARB;
extern GLLOADER_API glUniform4i64ARBFUNC glUniform4i64ARB;
extern GLLOADER_API glUniform1i64vARBFUNC glUniform1i64vARB;
extern GLLOADER_API glUniform2i64vARBFUNC glUniform2i64vARB;
extern GLLOADER_API glUniform3i64vARBFUNC glUniform3i64vARB;
extern GLLOADER_API glUniform4i64vARBFUNC glUniform4i64vARB;
extern GLLOADER_API glUniform1ui64ARBFUNC glUniform1ui64ARB;
extern GLLOADER_API glUniform2ui64ARBFUNC glUniform2ui64ARB;
extern GLLOADER_API glUniform3ui64ARBFUNC glUniform3ui64ARB;
extern GLLOADER_API glUniform4ui64ARBFUNC glUniform4ui64ARB;
extern GLLOADER_API glUniform1ui64vARBFUNC glUniform1ui64vARB;
extern GLLOADER_API glUniform2ui64vARBFUNC glUniform2ui64vARB;
extern GLLOADER_API glUniform3ui64vARBFUNC glUniform3ui64vARB;
extern GLLOADER_API glUniform4ui64vARBFUNC glUniform4ui64vARB;
extern GLLOADER_API glGetUniformi64vARBFUNC glGetUniformi64vARB;
extern GLLOADER_API glGetUniformui64vARBFUNC glGetUniformui64vARB;
extern GLLOADER_API glGetnUniformui64vARBFUNC glGetnUniformui64vARB;
extern GLLOADER_API glProgramUniform1i64ARBFUNC glProgramUniform1i64ARB;
extern GLLOADER_API glProgramUniform2i64ARBFUNC glProgramUniform2i64ARB;
extern GLLOADER_API glProgramUniform3i64ARBFUNC glProgramUniform3i64ARB;
extern GLLOADER_API glProgramUniform4i64ARBFUNC glProgramUniform4i64ARB;
extern GLLOADER_API glProgramUniform1i64vARBFUNC glProgramUniform1i64vARB;
extern GLLOADER_API glProgramUniform2i64vARBFUNC glProgramUniform2i64vARB;
extern GLLOADER_API glProgramUniform3i64vARBFUNC glProgramUniform3i64vARB;
extern GLLOADER_API glProgramUniform4i64vARBFUNC glProgramUniform4i64vARB;
extern GLLOADER_API glProgramUniform1ui64ARBFUNC glProgramUniform1ui64ARB;
extern GLLOADER_API glProgramUniform2ui64ARBFUNC glProgramUniform2ui64ARB;
extern GLLOADER_API glProgramUniform3ui64ARBFUNC glProgramUniform3ui64ARB;
extern GLLOADER_API glProgramUniform4ui64ARBFUNC glProgramUniform4ui64ARB;
extern GLLOADER_API glProgramUniform1ui64vARBFUNC glProgramUniform1ui64vARB;
extern GLLOADER_API glProgramUniform2ui64vARBFUNC glProgramUniform2ui64vARB;
extern GLLOADER_API glProgramUniform3ui64vARBFUNC glProgramUniform3ui64vARB;
extern GLLOADER_API glProgramUniform4ui64vARBFUNC glProgramUniform4ui64vARB;
...
typedef void (GLLOADER_APIENTRY *glMaxShaderCompilerThreadsARBFUNC)(GLuint count);

extern GLLOADER_API glMaxShaderCompilerThreadsARBFUNC glMaxShaderCompilerThreadsARB;
...
typedef void (GLLOADER_APIENTRY *glFramebufferSampleLocationsfvARBFUNC)(GLenum target, GLuint start, GLsizei count, const GLfloat* v);
typedef void (GLLOADER_APIENTRY *glNamedFramebufferSampleLocationsfvARBFUNC)(GLuint framebuffer, GLuint start, GLsizei count, const GLfloat* v);
typedef void (GLLOADER_APIENTRY *glEvaluateDepthValuesARBFUNC)();

extern GLLOADER_API glFramebufferSampleLocationsfvARBFUNC glFramebufferSampleLocationsfvARB;
extern GLLOADER_API glNamedFramebufferSampleLocationsfvARBFUNC glNamedFramebufferSampleLocationsfvARB;
extern GLLOADER_API glEvaluateDepthValuesARBFUNC glEvaluateDepthValuesARB;
...
typedef void (GLLOADER_APIENTRY *glTextureSubImage1DEXTFUNC)(GLuint texture, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid* pixels);
typedef void (GLLOADER_APIENTRY *glTextureSubImage2DEXTFUNC)(GLuint texture, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid* pixels);
...
typedef void (GLLOADER_APIENTRY *glGetTextureParameterivEXTFUNC)(GLuint texture, GLenum target, GLenum pname, GLint* params);
...
typedef void (GLLOADER_APIENTRY *glTextureParameterIivEXTFUNC)(GLuint texture, GLenum target, GLenum pname, const GLint* params);
typedef void (GLLOADER_APIENTRY *glTextureParameterIuivEXTFUNC)(GLuint texture, GLenum target, GLenum pname, const GLuint* params);
...
typedef void (GLLOADER_APIENTRY *glNamedBufferStorageExternalEXTFUNC)(GLuint buffer, GLintptr offset, GLsizeiptr size, GLeglClientBufferEXT clientBuffer, GLbitfield flags);

extern GLLOADER_API glBufferStorageExternalEXTFUNC glBufferStorageExternalEXT;
extern GLLOADER_API glNamedBufferStorageExternalEXTFUNC glNamedBufferStorageExternalEXT;
...
typedef GLboolean (GLLOADER_APIENTRY *glIsMemoryObjectEXTFUNC)(GLuint memoryObject);
...
extern GLLOADER_API glIsMemoryObjectEXTFUNC glIsMemoryObjectEXT;
...
typedef void (GLLOADER_APIENTRY *glLGPUNamedBufferSubDataNVXFUNC)(GLuint index, GLbitfield gpuMask, GLuint buffer, GLintptr offset, GLsizeiptr size, const void* data);
typedef void (GLLOADER_APIENTRY *glLGPUCopyImageSubDataNVXFUNC)(GLuint sourceGpu, GLbitfield destinationGpuMask, GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srxY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei width, GLsizei height, GLsizei depth);
typedef void (GLLOADER_APIENTRY *glLGPUInterlockNVXFUNC)();

extern GLLOADER_API glLGPUNamedBufferSubDataNVXFUNC glLGPUNamedBufferSubDataNVX;
extern GLLOADER_API glLGPUCopyImageSubDataNVXFUNC glLGPUCopyImageSubDataNVX;
extern GLLOADER_API glLGPUInterlockNVXFUNC glLGPUInterlockNVX;

#endif

#ifdef GL_NV_alpha_to_coverage_dither_control

typedef void (GLLOADER_APIENTRY *glAlphaToCoverageDitherControlNVFUNC)(GLenum mode);

extern GLLOADER_API glAlphaToCoverageDitherControlNVFUNC glAlphaToCoverageDitherControlNV;
...
typedef void (GLLOADER_APIENTRY *glViewportPositionWScaleNVFUNC)(GLuint index, GLfloat xcoeff, GLfloat ycoeff);

extern GLLOADER_API glViewportPositionWScaleNVFUNC glViewportPositionWScaleNV;
...
typedef void (GLLOADER_APIENTRY *glRenderGpuMaskNVFUNC)(GLbitfield mask);
typedef void (GLLOADER_APIENTRY *glMulticastBufferSubDataNVFUNC)(GLbitfield gpuMask, GLuint buffer, GLintptr offset, GLsizeiptr size, const void* data);
typedef void (GLLOADER_APIENTRY *glMulticastCopyBufferSubDataNVFUNC)(GLuint readGpu, GLbitfield writeGpuMask, GLuint readBuffer, GLuint writeBuffer, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size);
typedef void (GLLOADER_APIENTRY *glMulticastCopyImageSubDataNVFUNC)(GLuint srcGpu, GLbitfield dstGpuMask, GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srxY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei srcWidth, GLsizei srcHeight, GLsizei srcDepth);
typedef void (GLLOADER_APIENTRY *glMulticastBlitFramebufferNVFUNC)(GLuint srcGpu, GLuint dstGpu, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
typedef void (GLLOADER_APIENTRY *glMulticastFramebufferSampleLocationsfvNVFUNC)(GLuint gpu, GLuint framebuffer, GLuint start, GLsizei count, const GLfloat* v);
typedef void (GLLOADER_APIENTRY *glMulticastBarrierNVFUNC)();
typedef void (GLLOADER_APIENTRY *glMulticastWaitSyncNVFUNC)(GLuint signalGpu, GLbitfield waitGpuMask);
typedef void (GLLOADER_APIENTRY *glMulticastGetQueryObjectivNVFUNC)(GLuint gpu, GLuint id, GLenum pname, GLint* params);
typedef void (GLLOADER_APIENTRY *glMulticastGetQueryObjectuivNVFUNC)(GLuint gpu, GLuint id, GLenum pname, GLuint* params);
typedef void (GLLOADER_APIENTRY *glMulticastGetQueryObjecti64vNVFUNC)(GLuint gpu, GLuint id, GLenum pname, GLint64* params);
typedef void (GLLOADER_APIENTRY *glMulticastGetQueryObjectui64vNVFUNC)(GLuint gpu, GLuint id, GLenum pname, GLuint64* params);

extern GLLOADER_API glRenderGpuMaskNVFUNC glRenderGpuMaskNV;
extern GLLOADER_API glMulticastBufferSubDataNVFUNC glMulticastBufferSubDataNV;
extern GLLOADER_API glMulticastCopyBufferSubDataNVFUNC glMulticastCopyBufferSubDataNV;
extern GLLOADER_API glMulticastCopyImageSubDataNVFUNC glMulticastCopyImageSubDataNV;
extern GLLOADER_API glMulticastBlitFramebufferNVFUNC glMulticastBlitFramebufferNV;
extern GLLOADER_API glMulticastFramebufferSampleLocationsfvNVFUNC glMulticastFramebufferSampleLocationsfvNV;
extern GLLOADER_API glMulticastBarrierNVFUNC glMulticastBarrierNV;
extern GLLOADER_API glMulticastWaitSyncNVFUNC glMulticastWaitSyncNV;
extern GLLOADER_API glMulticastGetQueryObjectivNVFUNC glMulticastGetQueryObjectivNV;
extern GLLOADER_API glMulticastGetQueryObjectuivNVFUNC glMulticastGetQueryObjectuivNV;
extern GLLOADER_API glMulticastGetQueryObjecti64vNVFUNC glMulticastGetQueryObjecti64vNV;
extern GLLOADER_API glMulticastGetQueryObjectui64vNVFUNC glMulticastGetQueryObjectui64vNV;
...
typedef char (GLLOADER_APIENTRY *glloader_GL_VERSION_4_6FUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_AMD_gpu_shader_half_floatFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_AMD_gpu_shader_int16FUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_AMD_shader_ballotFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_AMD_shader_explicit_vertex_parameterFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_AMD_texture_gather_bias_lodFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_ES3_2_compatibilityFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_fragment_shader_interlockFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_gl_spirvFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_gpu_shader_int64FUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_parallel_shader_compileFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_polygon_offset_clampFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_post_depth_coverageFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_sample_locationsFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_shader_atomic_counter_opsFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_shader_ballotFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_shader_bit_encodingFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_shader_clockFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_shader_viewport_layer_arrayFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_sparse_texture2FUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_sparse_texture_clampFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_spirv_extensionsFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_texture_filter_anisotropicFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_ARB_texture_filter_minmaxFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_EXT_external_bufferFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_EXT_memory_objectFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_EXT_memory_object_fdFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_EXT_memory_object_win32FUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_EXT_semaphoreFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_EXT_semaphore_fdFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_EXT_semaphore_win32FUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_EXT_win32_keyed_mutexFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_EXT_window_rectanglesFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_INTEL_conservative_rasterizationFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_INTEL_fragment_shader_orderingFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_INTEL_framebuffer_CMAAFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_KHR_parallel_shader_compileFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_KHR_texture_compression_astc_sliced_3dFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_MESA_shader_integer_functionsFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_NVX_blend_equation_advanced_multi_draw_buffersFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_NVX_linked_gpu_multicastFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_NV_alpha_to_coverage_dither_controlFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_NV_blend_minmax_factorFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_NV_blend_squareFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_GL_NV_clip_space_w_scalingFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_NV_conservative_raster_pre_snap_trianglesFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_NV_draw_vulkan_imageFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_NV_gpu_multicastFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_NV_robustness_video_memory_purgeFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_NV_shader_atomic_float64FUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_NV_stereo_view_renderingFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_NV_texture_rectangle_compressedFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_GL_NV_viewport_swizzleFUNC)();
...
extern GLLOADER_API glloader_GL_VERSION_4_6FUNC glloader_GL_VERSION_4_6;
...
extern GLLOADER_API glloader_GL_AMD_gpu_shader_half_floatFUNC glloader_GL_AMD_gpu_shader_half_float;
extern GLLOADER_API glloader_GL_AMD_gpu_shader_int16FUNC glloader_GL_AMD_gpu_shader_int16;
...
extern GLLOADER_API glloader_GL_AMD_shader_ballotFUNC glloader_GL_AMD_shader_ballot;
extern GLLOADER_API glloader_GL_AMD_shader_explicit_vertex_parameterFUNC glloader_GL_AMD_shader_explicit_vertex_parameter;
...
extern GLLOADER_API glloader_GL_AMD_texture_gather_bias_lodFUNC glloader_GL_AMD_texture_gather_bias_lod;
...
extern GLLOADER_API glloader_GL_ARB_ES3_2_compatibilityFUNC glloader_GL_ARB_ES3_2_compatibility;
...
extern GLLOADER_API glloader_GL_ARB_fragment_shader_interlockFUNC glloader_GL_ARB_fragment_shader_interlock;
...
extern GLLOADER_API glloader_GL_ARB_gl_spirvFUNC glloader_GL_ARB_gl_spirv;
...
extern GLLOADER_API glloader_GL_ARB_gpu_shader_int64FUNC glloader_GL_ARB_gpu_shader_int64;
...
extern GLLOADER_API glloader_GL_ARB_parallel_shader_compileFUNC glloader_GL_ARB_parallel_shader_compile;
...
extern GLLOADER_API glloader_GL_ARB_polygon_offset_clampFUNC glloader_GL_ARB_polygon_offset_clamp;
extern GLLOADER_API glloader_GL_ARB_post_depth_coverageFUNC glloader_GL_ARB_post_depth_coverage;
...
extern GLLOADER_API glloader_GL_ARB_sample_locationsFUNC glloader_GL_ARB_sample_locations;
...
extern GLLOADER_API glloader_GL_ARB_shader_atomic_counter_opsFUNC glloader_GL_ARB_shader_atomic_counter_ops;
extern GLLOADER_API glloader_GL_ARB_shader_ballotFUNC glloader_GL_ARB_shader_ballot;
extern GLLOADER_API glloader_GL_ARB_shader_bit_encodingFUNC glloader_GL_ARB_shader_bit_encoding;
extern GLLOADER_API glloader_GL_ARB_shader_clockFUNC glloader_GL_ARB_shader_clock;
...
extern GLLOADER_API glloader_GL_ARB_shader_viewport_layer_arrayFUNC glloader_GL_ARB_shader_viewport_layer_array;
...
extern GLLOADER_API glloader_GL_ARB_sparse_texture2FUNC glloader_GL_ARB_sparse_texture2;
extern GLLOADER_API glloader_GL_ARB_sparse_texture_clampFUNC glloader_GL_ARB_sparse_texture_clamp;
extern GLLOADER_API glloader_GL_ARB_spirv_extensionsFUNC glloader_GL_ARB_spirv_extensions;
...
extern GLLOADER_API glloader_GL_ARB_texture_filter_anisotropicFUNC glloader_GL_ARB_texture_filter_anisotropic;
extern GLLOADER_API glloader_GL_ARB_texture_filter_minmaxFUNC glloader_GL_ARB_texture_filter_minmax;
...
extern GLLOADER_API glloader_GL_EXT_external_bufferFUNC glloader_GL_EXT_external_buffer;
...
extern GLLOADER_API glloader_GL_EXT_memory_objectFUNC glloader_GL_EXT_memory_object;
extern GLLOADER_API glloader_GL_EXT_memory_object_fdFUNC glloader_GL_EXT_memory_object_fd;
extern GLLOADER_API glloader_GL_EXT_memory_object_win32FUNC glloader_GL_EXT_memory_object_win32;
...
extern GLLOADER_API glloader_GL_EXT_semaphoreFUNC glloader_GL_EXT_semaphore;
extern GLLOADER_API glloader_GL_EXT_semaphore_fdFUNC glloader_GL_EXT_semaphore_fd;
extern GLLOADER_API glloader_GL_EXT_semaphore_win32FUNC glloader_GL_EXT_semaphore_win32;
...
extern GLLOADER_API glloader_GL_EXT_win32_keyed_mutexFUNC glloader_GL_EXT_win32_keyed_mutex;
extern GLLOADER_API glloader_GL_EXT_window_rectanglesFUNC glloader_GL_EXT_window_rectangles;
...
extern GLLOADER_API glloader_GL_INTEL_conservative_rasterizationFUNC glloader_GL_INTEL_conservative_rasterization;
extern GLLOADER_API glloader_GL_INTEL_fragment_shader_orderingFUNC glloader_GL_INTEL_fragment_shader_ordering;
extern GLLOADER_API glloader_GL_INTEL_framebuffer_CMAAFUNC glloader_GL_INTEL_framebuffer_CMAA;
...
extern GLLOADER_API glloader_GL_KHR_parallel_shader_compileFUNC glloader_GL_KHR_parallel_shader_compile;
...
extern GLLOADER_API glloader_GL_KHR_texture_compression_astc_sliced_3dFUNC glloader_GL_KHR_texture_compression_astc_sliced_3d;
...
extern GLLOADER_API glloader_GL_MESA_shader_integer_functionsFUNC glloader_GL_MESA_shader_integer_functions;
...
extern GLLOADER_API glloader_GL_NVX_blend_equation_advanced_multi_draw_buffersFUNC glloader_GL_NVX_blend_equation_advanced_multi_draw_buffers;
...
extern GLLOADER_API glloader_GL_NVX_linked_gpu_multicastFUNC glloader_GL_NVX_linked_gpu_multicast;
extern GLLOADER_API glloader_GL_NV_alpha_to_coverage_dither_controlFUNC glloader_GL_NV_alpha_to_coverage_dither_control;
...
extern GLLOADER_API glloader_GL_NV_blend_minmax_factorFUNC glloader_GL_NV_blend_minmax_factor;
extern GLLOADER_API glloader_GL_NV_blend_squareFUNC glloader_GL_NV_blend_square;
extern GLLOADER_API glloader_GL_NV_clip_space_w_scalingFUNC glloader_GL_NV_clip_space_w_scaling;
...
extern GLLOADER_API glloader_GL_NV_conservative_raster_pre_snap_trianglesFUNC glloader_GL_NV_conservative_raster_pre_snap_triangles;
...
extern GLLOADER_API glloader_GL_NV_draw_vulkan_imageFUNC glloader_GL_NV_draw_vulkan_image;
...
extern GLLOADER_API glloader_GL_NV_gpu_multicastFUNC glloader_GL_NV_gpu_multicast;
...
extern GLLOADER_API glloader_GL_NV_robustness_video_memory_purgeFUNC glloader_GL_NV_robustness_video_memory_purge;
...
extern GLLOADER_API glloader_GL_NV_shader_atomic_float64FUNC glloader_GL_NV_shader_atomic_float64;
...
extern GLLOADER_API glloader_GL_NV_stereo_view_renderingFUNC glloader_GL_NV_stereo_view_rendering;
...
extern GLLOADER_API glloader_GL_NV_texture_rectangle_compressedFUNC glloader_GL_NV_texture_rectangle_compressed;
...
extern GLLOADER_API glloader_GL_NV_viewport_swizzleFUNC glloader_GL_NV_viewport_swizzle;
