...
#define EGL_CONTEXT_RELEASE_BEHAVIOR_NONE_KHR 0x0000
...
typedef void (GLLOADER_APIENTRY *EGLDEBUGPROC)(EGLenum error, const char *command, EGLint messageType, EGLLabelKHR threadLabel, EGLLabelKHR objectLabel, const char* message);
...
typedef EGLClientBuffer (GLLOADER_APIENTRY *eglCreateNativeClientBufferANDROIDFUNC)(const EGLint* attrib_list);

extern GLLOADER_API eglCreateNativeClientBufferANDROIDFUNC eglCreateNativeClientBufferANDROID;
...
typedef EGLBoolean (GLLOADER_APIENTRY *eglPresentationTimeANDROIDFUNC)(EGLDisplay dpy, EGLSurface surface, EGLnsecsANDROID time);

extern GLLOADER_API eglPresentationTimeANDROIDFUNC eglPresentationTimeANDROID;
...
typedef EGLBoolean (GLLOADER_APIENTRY *eglCompositorSetContextListEXTFUNC)(const EGLint* external_ref_ids, EGLint num_entries);
typedef EGLBoolean (GLLOADER_APIENTRY *eglCompositorSetContextAttributesEXTFUNC)(EGLint external_ref_id, const EGLint* context_attributes, EGLint num_entries);
typedef EGLBoolean (GLLOADER_APIENTRY *eglCompositorSetWindowListEXTFUNC)(EGLint external_ref_id, const EGLint* external_ref_ids, EGLint num_entries);
typedef EGLBoolean (GLLOADER_APIENTRY *eglCompositorSetWindowAttributesEXTFUNC)(EGLint external_win_id, const EGLint* window_attributes, EGLint num_entries);
typedef EGLBoolean (GLLOADER_APIENTRY *eglCompositorBindTexWindowEXTFUNC)(EGLint external_win_id);
typedef EGLBoolean (GLLOADER_APIENTRY *eglCompositorSetSizeEXTFUNC)(EGLint external_win_id, EGLint width, EGLint height);
typedef EGLBoolean (GLLOADER_APIENTRY *eglCompositorSwapPolicyEXTFUNC)(EGLint external_win_id, EGLint policy);

extern GLLOADER_API eglCompositorSetContextListEXTFUNC eglCompositorSetContextListEXT;
extern GLLOADER_API eglCompositorSetContextAttributesEXTFUNC eglCompositorSetContextAttributesEXT;
extern GLLOADER_API eglCompositorSetWindowListEXTFUNC eglCompositorSetWindowListEXT;
extern GLLOADER_API eglCompositorSetWindowAttributesEXTFUNC eglCompositorSetWindowAttributesEXT;
extern GLLOADER_API eglCompositorBindTexWindowEXTFUNC eglCompositorBindTexWindowEXT;
extern GLLOADER_API eglCompositorSetSizeEXTFUNC eglCompositorSetSizeEXT;
extern GLLOADER_API eglCompositorSwapPolicyEXTFUNC eglCompositorSwapPolicyEXT;
...
typedef EGLBoolean (GLLOADER_APIENTRY *eglQueryDmaBufFormatsEXTFUNC)(EGLDisplay dpy, EGLint max_formats, EGLint* formats, EGLint* num_formats);
typedef EGLBoolean (GLLOADER_APIENTRY *eglQueryDmaBufModifiersEXTFUNC)(EGLDisplay dpy, EGLint format, EGLint max_modifiers, EGLuint64KHR* modifiers, EGLBoolean* external_only, EGLint* num_modifiers);

extern GLLOADER_API eglQueryDmaBufFormatsEXTFUNC eglQueryDmaBufFormatsEXT;
extern GLLOADER_API eglQueryDmaBufModifiersEXTFUNC eglQueryDmaBufModifiersEXT;
...
typedef EGLint (GLLOADER_APIENTRY *eglDebugMessageControlKHRFUNC)(EGLDEBUGPROC callback, const EGLAttrib* attrib_list);
typedef EGLBoolean (GLLOADER_APIENTRY *eglQueryDebugKHRFUNC)(EGLint attribute, EGLAttrib* value);
typedef EGLint (GLLOADER_APIENTRY *eglLabelObjectKHRFUNC)(EGLDisplay display, EGLenum objectType, EGLObjectKHR object, EGLLabelKHR label);

extern GLLOADER_API eglDebugMessageControlKHRFUNC eglDebugMessageControlKHR;
extern GLLOADER_API eglQueryDebugKHRFUNC eglQueryDebugKHR;
extern GLLOADER_API eglLabelObjectKHRFUNC eglLabelObjectKHR;
...
typedef EGLBoolean (GLLOADER_APIENTRY *eglStreamConsumerGLTextureExternalAttribsNVFUNC)(EGLDisplay dpy, EGLStreamKHR stream, EGLAttrib* attrib_list);

extern GLLOADER_API eglStreamConsumerGLTextureExternalAttribsNVFUNC eglStreamConsumerGLTextureExternalAttribsNV;

#endif

#ifdef EGL_NV_stream_metadata

typedef EGLBoolean (GLLOADER_APIENTRY *eglQueryDisplayAttribNVFUNC)(EGLDisplay dpy, EGLint attribute, EGLAttrib* value);
typedef EGLBoolean (GLLOADER_APIENTRY *eglSetStreamMetadataNVFUNC)(EGLDisplay dpy, EGLStreamKHR stream, EGLint n, EGLint offset, EGLint size, const void* data);
typedef EGLBoolean (GLLOADER_APIENTRY *eglQueryStreamMetadataNVFUNC)(EGLDisplay dpy, EGLStreamKHR stream, EGLenum name, EGLint n, EGLint offset, EGLint size, void* data);

extern GLLOADER_API eglQueryDisplayAttribNVFUNC eglQueryDisplayAttribNV;
extern GLLOADER_API eglSetStreamMetadataNVFUNC eglSetStreamMetadataNV;
extern GLLOADER_API eglQueryStreamMetadataNVFUNC eglQueryStreamMetadataNV;

#endif

#ifdef EGL_NV_stream_reset

typedef EGLBoolean (GLLOADER_APIENTRY *eglResetStreamNVFUNC)(EGLDisplay dpy, EGLStreamKHR stream);

extern GLLOADER_API eglResetStreamNVFUNC eglResetStreamNV;
...
typedef char (GLLOADER_APIENTRY *glloader_EGL_ANDROID_create_native_client_bufferFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_ANDROID_framebuffer_targetFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_ANDROID_front_buffer_auto_refreshFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_EGL_ANDROID_presentation_timeFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_EGL_ARM_implicit_external_syncFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_ARM_pixmap_multisample_discardFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_EXT_bind_to_frontFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_EGL_EXT_compositorFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_EGL_EXT_gl_colorspace_bt2020_linearFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_EXT_gl_colorspace_bt2020_pqFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_EXT_gl_colorspace_display_p3FUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_EXT_gl_colorspace_display_p3_linearFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_EXT_gl_colorspace_scrgbFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_EXT_gl_colorspace_scrgb_linearFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_EXT_image_dma_buf_importFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_EXT_image_dma_buf_import_modifiersFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_EXT_image_implicit_sync_controlFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_EGL_EXT_pixel_format_floatFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_EGL_EXT_protected_contentFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_EGL_EXT_surface_CTA861_3_metadataFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_EXT_surface_SMPTE2086_metadataFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_EGL_IMG_image_plane_attribsFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_EGL_KHR_context_flush_controlFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_EGL_KHR_debugFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_EGL_KHR_mutable_render_bufferFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_KHR_no_config_contextFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_EGL_MESA_platform_surfacelessFUNC)();
...
typedef char (GLLOADER_APIENTRY *glloader_EGL_NV_stream_consumer_gltexture_yuvFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_NV_stream_cross_displayFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_NV_stream_cross_objectFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_NV_stream_cross_partitionFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_NV_stream_cross_processFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_NV_stream_cross_systemFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_NV_stream_fifo_nextFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_NV_stream_fifo_synchronousFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_NV_stream_frame_limitsFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_NV_stream_metadataFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_NV_stream_remoteFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_NV_stream_resetFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_NV_stream_socketFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_NV_stream_socket_inetFUNC)();
typedef char (GLLOADER_APIENTRY *glloader_EGL_NV_stream_socket_unixFUNC)();
...
extern GLLOADER_API glloader_EGL_ANDROID_create_native_client_bufferFUNC glloader_EGL_ANDROID_create_native_client_buffer;
extern GLLOADER_API glloader_EGL_ANDROID_framebuffer_targetFUNC glloader_EGL_ANDROID_framebuffer_target;
extern GLLOADER_API glloader_EGL_ANDROID_front_buffer_auto_refreshFUNC glloader_EGL_ANDROID_front_buffer_auto_refresh;
...
extern GLLOADER_API glloader_EGL_ANDROID_presentation_timeFUNC glloader_EGL_ANDROID_presentation_time;
...
extern GLLOADER_API glloader_EGL_ARM_implicit_external_syncFUNC glloader_EGL_ARM_implicit_external_sync;
extern GLLOADER_API glloader_EGL_ARM_pixmap_multisample_discardFUNC glloader_EGL_ARM_pixmap_multisample_discard;
extern GLLOADER_API glloader_EGL_EXT_bind_to_frontFUNC glloader_EGL_EXT_bind_to_front;
...
extern GLLOADER_API glloader_EGL_EXT_compositorFUNC glloader_EGL_EXT_compositor;
...
extern GLLOADER_API glloader_EGL_EXT_gl_colorspace_bt2020_linearFUNC glloader_EGL_EXT_gl_colorspace_bt2020_linear;
extern GLLOADER_API glloader_EGL_EXT_gl_colorspace_bt2020_pqFUNC glloader_EGL_EXT_gl_colorspace_bt2020_pq;
extern GLLOADER_API glloader_EGL_EXT_gl_colorspace_display_p3FUNC glloader_EGL_EXT_gl_colorspace_display_p3;
extern GLLOADER_API glloader_EGL_EXT_gl_colorspace_display_p3_linearFUNC glloader_EGL_EXT_gl_colorspace_display_p3_linear;
extern GLLOADER_API glloader_EGL_EXT_gl_colorspace_scrgbFUNC glloader_EGL_EXT_gl_colorspace_scrgb;
extern GLLOADER_API glloader_EGL_EXT_gl_colorspace_scrgb_linearFUNC glloader_EGL_EXT_gl_colorspace_scrgb_linear;
extern GLLOADER_API glloader_EGL_EXT_image_dma_buf_importFUNC glloader_EGL_EXT_image_dma_buf_import;
extern GLLOADER_API glloader_EGL_EXT_image_dma_buf_import_modifiersFUNC glloader_EGL_EXT_image_dma_buf_import_modifiers;
extern GLLOADER_API glloader_EGL_EXT_image_implicit_sync_controlFUNC glloader_EGL_EXT_image_implicit_sync_control;
...
extern GLLOADER_API glloader_EGL_EXT_pixel_format_floatFUNC glloader_EGL_EXT_pixel_format_float;
...
extern GLLOADER_API glloader_EGL_EXT_protected_contentFUNC glloader_EGL_EXT_protected_content;
...
extern GLLOADER_API glloader_EGL_EXT_surface_CTA861_3_metadataFUNC glloader_EGL_EXT_surface_CTA861_3_metadata;
extern GLLOADER_API glloader_EGL_EXT_surface_SMPTE2086_metadataFUNC glloader_EGL_EXT_surface_SMPTE2086_metadata;
...
extern GLLOADER_API glloader_EGL_IMG_image_plane_attribsFUNC glloader_EGL_IMG_image_plane_attribs;
...
extern GLLOADER_API glloader_EGL_KHR_context_flush_controlFUNC glloader_EGL_KHR_context_flush_control;
...
extern GLLOADER_API glloader_EGL_KHR_debugFUNC glloader_EGL_KHR_debug;
...
extern GLLOADER_API glloader_EGL_KHR_mutable_render_bufferFUNC glloader_EGL_KHR_mutable_render_buffer;
extern GLLOADER_API glloader_EGL_KHR_no_config_contextFUNC glloader_EGL_KHR_no_config_context;
...
extern GLLOADER_API glloader_EGL_MESA_platform_surfacelessFUNC glloader_EGL_MESA_platform_surfaceless;
...
extern GLLOADER_API glloader_EGL_NV_stream_consumer_gltexture_yuvFUNC glloader_EGL_NV_stream_consumer_gltexture_yuv;
extern GLLOADER_API glloader_EGL_NV_stream_cross_displayFUNC glloader_EGL_NV_stream_cross_display;
extern GLLOADER_API glloader_EGL_NV_stream_cross_objectFUNC glloader_EGL_NV_stream_cross_object;
extern GLLOADER_API glloader_EGL_NV_stream_cross_partitionFUNC glloader_EGL_NV_stream_cross_partition;
extern GLLOADER_API glloader_EGL_NV_stream_cross_processFUNC glloader_EGL_NV_stream_cross_process;
extern GLLOADER_API glloader_EGL_NV_stream_cross_systemFUNC glloader_EGL_NV_stream_cross_system;
extern GLLOADER_API glloader_EGL_NV_stream_fifo_nextFUNC glloader_EGL_NV_stream_fifo_next;
extern GLLOADER_API glloader_EGL_NV_stream_fifo_synchronousFUNC glloader_EGL_NV_stream_fifo_synchronous;
extern GLLOADER_API glloader_EGL_NV_stream_frame_limitsFUNC glloader_EGL_NV_stream_frame_limits;
extern GLLOADER_API glloader_EGL_NV_stream_metadataFUNC glloader_EGL_NV_stream_metadata;
extern GLLOADER_API glloader_EGL_NV_stream_remoteFUNC glloader_EGL_NV_stream_remote;
extern GLLOADER_API glloader_EGL_NV_stream_resetFUNC glloader_EGL_NV_stream_reset;
extern GLLOADER_API glloader_EGL_NV_stream_socketFUNC glloader_EGL_NV_stream_socket;
extern GLLOADER_API glloader_EGL_NV_stream_socket_inetFUNC glloader_EGL_NV_stream_socket_inet;
extern GLLOADER_API glloader_EGL_NV_stream_socket_unixFUNC glloader_EGL_NV_stream_socket_unix;
