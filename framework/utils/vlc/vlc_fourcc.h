 ...
 */
vlc_fourcc_t vlc_fourcc_GetCodec( vlc_fourcc_t i_fourcc );
 ...
 */
vlc_fourcc_t vlc_fourcc_GetCodecFromString( const char * );
 ...
 * You may use UNKNOWN_ES for the ES category if you don't have the information.
 */
const char * vlc_fourcc_GetDescription( vlc_fourcc_t i_fourcc );
