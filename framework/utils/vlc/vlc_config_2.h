...
#define CONFIGURE_LINE                                                                                                                     \
    "../extras/package/win32/../../../configure  '--enable-update-check' '--enable-lua' '--enable-faad' '--enable-flac' "                  \
    "'--enable-theora' '--enable-avcodec' '--enable-merge-ffmpeg' '--enable-dca' '--enable-mpc' '--enable-libass' "                        \
    "'--enable-schroedinger' '--enable-realrtsp' '--enable-live555' '--enable-dvdread' '--enable-shout' '--enable-goom' '--enable-caca' "  \
    "'--enable-qt' '--enable-skins2' '--enable-sse' '--enable-mmx' '--enable-libcddb' '--enable-zvbi' '--disable-telx' '--enable-nls' "    \
    "'--host=x86_64-w64-mingw32' '--build=x86_64-pc-linux-gnu' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=x86_64-w64-mingw32' "         \
    "'PKG_CONFIG_LIBDIR=/home/nio/Code/vlc-3.0.11_x64/contrib/x86_64-w64-mingw32/lib/pkgconfig'"
